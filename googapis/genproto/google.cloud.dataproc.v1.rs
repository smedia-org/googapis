...
pub mod cluster_controller_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [Operation.metadata][google.longrunning.Operation.metadata] will be"]
        #[doc = " [ClusterOperationMetadata](https://cloud.google.com/dataproc/docs/reference/rpc/google.cloud.dataproc.v1#clusteroperationmetadata)."]
        #[doc = " The cluster must be in a"]
        #[doc = " [`RUNNING`][google.cloud.dataproc.v1.ClusterStatus.State] state or an error"]
        #[doc = " is returned."]
...
pub mod node_group_controller_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " The `NodeGroupControllerService` provides methods to manage node groups"]
    #[doc = " of Compute Engine managed instances."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a node group in a cluster. The returned"]
        #[doc = " [Operation.metadata][google.longrunning.Operation.metadata] is"]
        #[doc = " [NodeGroupOperationMetadata](https://cloud.google.com/dataproc/docs/reference/rpc/google.cloud.dataproc.v1#nodegroupoperationmetadata)."]
        ...
        #[doc = " Resizes a node group in a cluster. The returned"]
        #[doc = " [Operation.metadata][google.longrunning.Operation.metadata] is"]
        #[doc = " [NodeGroupOperationMetadata](https://cloud.google.com/dataproc/docs/reference/rpc/google.cloud.dataproc.v1#nodegroupoperationmetadata)."]
        ...
        #[doc = " Gets the resource representation for a node group in a"]
        #[doc = " cluster."]
