...
pub mod privileged_access_manager_client {
    ...
    use tonic::codegen::*;
    #[doc = " This API allows customers to manage temporary, request based privileged"]
    #[doc = " access to their resources."]
    #[doc = ""]
    #[doc = " It defines the following resource model:"]
    #[doc = ""]
    #[doc = " * A collection of `Entitlement` resources. An entitlement allows configuring"]
    #[doc = "   (among other things):"]
    #[doc = ""]
    #[doc = "   * Some kind of privileged access that users can request."]
    #[doc = "   * A set of users called _requesters_ who can request this access."]
    #[doc = "   * A maximum duration for which the access can be requested."]
    #[doc = "   * An optional approval workflow which must be satisfied before access is"]
    #[doc = "     granted."]
    #[doc = ""]
    #[doc = " * A collection of `Grant` resources. A grant is a request by a requester to"]
    #[doc = "   get the privileged access specified in an entitlement for some duration."]
    #[doc = ""]
    #[doc = "   After the approval workflow as specified in the entitlement is satisfied,"]
    #[doc = "   the specified access is given to the requester. The access is automatically"]
    #[doc = "   taken back after the requested duration is over."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " CheckOnboardingStatus reports the onboarding status for a"]
        #[doc = " project/folder/organization. Any findings reported by this API need to be"]
        #[doc = " fixed before PAM can be used on the resource."]
        pub async fn check_onboarding_status(
            &mut self,
            request: impl tonic::IntoRequest<super::CheckOnboardingStatusRequest>,
        ) -> Result<tonic::Response<super::CheckOnboardingStatusResponse>, tonic::Status> {
        ...
        #[doc = " Lists entitlements in a given project/folder/organization and location."]
        ...
        #[doc = " `SearchEntitlements` returns entitlements on which the caller has the"]
        #[doc = " specified access."]
        pub async fn search_entitlements(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchEntitlementsRequest>,
        ) -> Result<tonic::Response<super::SearchEntitlementsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single entitlement."]
        ...
        #[doc = " Creates a new entitlement in a given project/folder/organization and"]
        #[doc = " location."]
        ...
        #[doc = " Deletes a single entitlement. This method can only be called when there"]
        #[doc = " are no in-progress (ACTIVE/ACTIVATING/REVOKING) grants under the"]
        #[doc = " entitlement."]
        ...
        #[doc = " Updates the entitlement specified in the request. Updated fields in the"]
        #[doc = " entitlement need to be specified in an update mask. The changes made to an"]
        #[doc = " entitlement are applicable only on future grants of the entitlement."]
        #[doc = " However, if new approvers are added or existing approvers are removed from"]
        #[doc = " the approval workflow, the changes are effective on existing grants."]
        #[doc = ""]
        #[doc = " The following fields are not supported for updates:"]
        #[doc = ""]
        #[doc = "  * All immutable fields"]
        #[doc = "  * Entitlement name"]
        #[doc = "  * Resource name"]
        #[doc = "  * Resource type"]
        #[doc = "  * Adding an approval workflow in an entitlement which previously had no"]
        #[doc = "    approval workflow."]
        #[doc = "  * Deleting the approval workflow from an entitlement."]
        #[doc = "  * Adding or deleting a step in the approval workflow (only one step is"]
        #[doc = "    supported)"]
        #[doc = ""]
        #[doc = " Note that updates are allowed on the list of approvers in an approval"]
        #[doc = " workflow step."]
        ...
        #[doc = " Lists grants for a given entitlement."]
        pub async fn list_grants(
            &mut self,
            request: impl tonic::IntoRequest<super::ListGrantsRequest>,
        ) -> Result<tonic::Response<super::ListGrantsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " `SearchGrants` returns grants that are related to the calling user in the"]
        #[doc = " specified way."]
        pub async fn search_grants(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchGrantsRequest>,
        ) -> Result<tonic::Response<super::SearchGrantsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Get details of a single grant."]
        pub async fn get_grant(
            &mut self,
            request: impl tonic::IntoRequest<super::GetGrantRequest>,
        ) -> Result<tonic::Response<super::Grant>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new grant in a given project and location."]
        ...
        #[doc = " `ApproveGrant` is used to approve a grant. This method can only be called"]
        #[doc = " on a grant when it's in the `APPROVAL_AWAITED` state. This operation can't"]
        #[doc = " be undone."]
        ...
        #[doc = " `DenyGrant` is used to deny a grant. This method can only be called on a"]
        #[doc = " grant when it's in the `APPROVAL_AWAITED` state. This operation can't be"]
        #[doc = " undone."]
        ...
        #[doc = " `RevokeGrant` is used to immediately revoke access for a grant. This method"]
        #[doc = " can be called when the grant is in a non-terminal state."]
