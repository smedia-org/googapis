...
pub mod dataform_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Applies a Git commit to a Repository. The Repository must not have a value"]
        #[doc = " for `git_remote_settings.url`."]
        ...
        #[doc = " Returns the contents of a file (inside a Repository). The Repository"]
        #[doc = " must not have a value for `git_remote_settings.url`."]
        pub async fn read_repository_file(
            &mut self,
            request: impl tonic::IntoRequest<super::ReadRepositoryFileRequest>,
        ) -> Result<tonic::Response<super::ReadRepositoryFileResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the contents of a given Repository directory. The Repository must"]
        #[doc = " not have a value for `git_remote_settings.url`."]
        ...
        ) -> Result<tonic::Response<super::QueryRepositoryDirectoryContentsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Fetches a Repository's history of commits.  The Repository must not have a"]
        #[doc = " value for `git_remote_settings.url`."]
        pub async fn fetch_repository_history(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchRepositoryHistoryRequest>,
        ) -> Result<tonic::Response<super::FetchRepositoryHistoryResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Computes a Repository's Git access token status."]
        ...
        ) -> Result<tonic::Response<super::ComputeRepositoryAccessTokenStatusResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> Result<tonic::Response<super::ListReleaseConfigsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> Result<tonic::Response<super::ReleaseConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> Result<tonic::Response<super::ListWorkflowConfigsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> Result<tonic::Response<super::WorkflowConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
