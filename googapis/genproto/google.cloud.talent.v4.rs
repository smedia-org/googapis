...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [SearchJobsRequest][google.cloud.talent.v4.SearchJobsRequest]."]
        #[doc = ""]
        #[doc = " This call constrains the"]
        #[doc = " [visibility][google.cloud.talent.v4.Job.visibility] of jobs present in the"]
        #[doc = " database, and only returns jobs that the caller has permission to search"]
        #[doc = " against."]
        ...
        #[doc = " This call constrains the"]
        #[doc = " [visibility][google.cloud.talent.v4.Job.visibility] of jobs present in the"]
        #[doc = " database, and only returns jobs the caller has permission to search"]
        #[doc = " against."]
