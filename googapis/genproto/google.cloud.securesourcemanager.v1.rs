...
pub mod secure_source_manager_client {
    ...
    use tonic::codegen::*;
    #[doc = " Secure Source Manager API"]
    #[doc = ""]
    #[doc = " Access Secure Source Manager instances, resources, and repositories."]
    #[doc = ""]
    #[doc = " This API is split across two servers: the Control Plane and the Data Plane."]
    #[doc = ""]
    #[doc = " Data Plane endpoints are hosted directly by your Secure Source Manager"]
    #[doc = " instance, so you must connect to your instance's API hostname to access"]
    #[doc = " them. The API hostname looks like the following:"]
    #[doc = ""]
    #[doc = "    https://[instance-id]-[project-number]-api.[location].sourcemanager.dev"]
    #[doc = ""]
    #[doc = " For example,"]
    #[doc = ""]
    #[doc = "    https://my-instance-702770452863-api.us-central1.sourcemanager.dev"]
    #[doc = ""]
    #[doc = " Data Plane endpoints are denoted with **Host: Data Plane**."]
    #[doc = ""]
    #[doc = " All other endpoints are found in the normal Cloud API location, namely,"]
    #[doc = " `securcesourcemanager.googleapis.com`."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets metadata of a repository."]
        #[doc = ""]
        #[doc = " **Host: Data Plane**"]
        ...
        #[doc = " Get IAM policy for a repository."]
        ...
        #[doc = " Set IAM policy on a repository."]
        ...
        #[doc = " Test IAM permissions on a repository."]
        #[doc = " IAM permission checks are not required on this method."]
