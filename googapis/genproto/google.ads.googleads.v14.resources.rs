...
pub struct Customer {
    ...
    pub offline_conversion_client_summaries:
        ::prost::alloc::vec::Vec<OfflineConversionClientSummary>,
}
...
pub struct OfflineConversionUploadSummary {
    ...
    #[prost(
        oneof = "offline_conversion_upload_summary::DimensionKey",
        tags = "1, 2"
    )]
    pub dimension_key: ::core::option::Option<offline_conversion_upload_summary::DimensionKey>,
}
