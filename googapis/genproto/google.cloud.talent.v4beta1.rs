...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Searches for jobs using the provided"]
        #[doc = " [SearchJobsRequest][google.cloud.talent.v4beta1.SearchJobsRequest]."]
        #[doc = ""]
        #[doc = " This call constrains the"]
        #[doc = " [visibility][google.cloud.talent.v4beta1.Job.visibility] of jobs present in"]
        #[doc = " the database, and only returns jobs that the caller has permission to"]
        #[doc = " search against."]
        ...
        #[doc = " This call constrains the"]
        #[doc = " [visibility][google.cloud.talent.v4beta1.Job.visibility] of jobs present in"]
        #[doc = " the database, and only returns jobs the caller has permission to search"]
        #[doc = " against."]
