...
pub mod timeseries_insights_controller_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists [DataSets][google.cloud.timeseriesinsights.v1.DataSet] under the project."]
        #[doc = ""]
        #[doc = " The order of the results is unspecified but deterministic. Newly created"]
        #[doc = " [DataSets][google.cloud.timeseriesinsights.v1.DataSet] will not necessarily be added to the end"]
        #[doc = " of this list."]
        ...
        #[doc = " Create a [DataSet][google.cloud.timeseriesinsights.v1.DataSet] from data stored on Cloud"]
        #[doc = " Storage."]
        #[doc = ""]
        #[doc = " The data must stay immutable while we process the"]
        #[doc = " [DataSet][google.cloud.timeseriesinsights.v1.DataSet] creation; otherwise, undefined outcomes"]
        #[doc = " might result.  For more information, see [DataSet][google.cloud.timeseriesinsights.v1.DataSet]."]
        ...
        #[doc = " Delete a [DataSet][google.cloud.timeseriesinsights.v1.DataSet] from the system."]
        #[doc = ""]
        #[doc = " **NOTE**: If the [DataSet][google.cloud.timeseriesinsights.v1.DataSet] is still being"]
        #[doc = " processed, it will be aborted and deleted."]
        ...
        #[doc = " Append events to a `LOADED` [DataSet][google.cloud.timeseriesinsights.v1.DataSet]."]
        ...
        #[doc = " Execute a Timeseries Insights query over a loaded"]
        #[doc = " [DataSet][google.cloud.timeseriesinsights.v1.DataSet]."]
        ...
        #[doc = " Evaluate an explicit slice from a loaded [DataSet][google.cloud.timeseriesinsights.v1.DataSet]."]
        ...
        #[doc = " Evaluate an explicit timeseries."]
