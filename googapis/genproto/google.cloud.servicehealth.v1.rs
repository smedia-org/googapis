...
pub mod service_health_client {
    ...
    use tonic::codegen::*;
    #[doc = " Request service health events relevant to your Google Cloud project."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists events under a given project and location."]
        ...
        #[doc = " Retrieves a resource containing information about an event."]
        ...
        #[doc = " Lists organization events under a given organization and location."]
        pub async fn list_organization_events(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOrganizationEventsRequest>,
        ) -> Result<tonic::Response<super::ListOrganizationEventsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Retrieves a resource containing information about an event affecting an"]
        #[doc = " organization ."]
        pub async fn get_organization_event(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOrganizationEventRequest>,
        ) -> Result<tonic::Response<super::OrganizationEvent>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists assets impacted by organization events under a given organization and"]
        #[doc = " location."]
        pub async fn list_organization_impacts(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOrganizationImpactsRequest>,
        ) -> Result<tonic::Response<super::ListOrganizationImpactsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Retrieves a resource containing information about impact to an asset under"]
        #[doc = " an organization affected by a service health event."]
        pub async fn get_organization_impact(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOrganizationImpactRequest>,
        ) -> Result<tonic::Response<super::OrganizationImpact>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
