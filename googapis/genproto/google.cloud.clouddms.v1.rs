...
pub mod data_migration_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Generate a TCP Proxy configuration script to configure a cloud-hosted VM"]
        #[doc = " running a TCP Proxy."]
        pub async fn generate_tcp_proxy_script(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateTcpProxyScriptRequest>,
        ) -> Result<tonic::Response<super::TcpProxyScript>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Retrieves a list of all connection profiles in a given project and"]
        #[doc = " location."]
        ...
        #[doc = " Creates a new private connection in a given project and location."]
        ...
        #[doc = " Gets details of a single private connection."]
        ...
        #[doc = " Retrieves a list of private connections in a given project and location."]
        ...
        #[doc = " Deletes a single Database Migration Service private connection."]
        ...
        #[doc = " Gets details of a single conversion workspace."]
        pub async fn get_conversion_workspace(
            &mut self,
            request: impl tonic::IntoRequest<super::GetConversionWorkspaceRequest>,
        ) -> Result<tonic::Response<super::ConversionWorkspace>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists conversion workspaces in a given project and location."]
        pub async fn list_conversion_workspaces(
            &mut self,
            request: impl tonic::IntoRequest<super::ListConversionWorkspacesRequest>,
        ) -> Result<tonic::Response<super::ListConversionWorkspacesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Creates a new conversion workspace in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single conversion workspace."]
        ...
        #[doc = " Deletes a single conversion workspace."]
        ...
        #[doc = " Creates a new mapping rule for a given conversion workspace."]
        pub async fn create_mapping_rule(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateMappingRuleRequest>,
        ) -> Result<tonic::Response<super::MappingRule>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes a single mapping rule."]
        ...
        #[doc = " Lists the mapping rules for a specific conversion workspace."]
        pub async fn list_mapping_rules(
            &mut self,
            request: impl tonic::IntoRequest<super::ListMappingRulesRequest>,
        ) -> Result<tonic::Response<super::ListMappingRulesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets the details of a mapping rule."]
        ...
        #[doc = " Imports a snapshot of the source database into the"]
        #[doc = " conversion workspace."]
        ...
        #[doc = " Imports the mapping rules for a given conversion workspace."]
        #[doc = " Supports various formats of external rules files."]
        ...
        #[doc = " Creates a draft tree schema for the destination database."]
        ...
        #[doc = " Marks all the data in the conversion workspace as committed."]
        ...
        #[doc = " Rolls back a conversion workspace to the last committed snapshot."]
        ...
        #[doc = " Applies draft tree onto a specific destination database."]
        ...
        #[doc = " Describes the database entities tree for a specific conversion workspace"]
        #[doc = " and a specific tree type."]
        #[doc = ""]
        #[doc = " Database entities are not resources like conversion workspaces or mapping"]
        #[doc = " rules, and they can't be created, updated or deleted. Instead, they are"]
        #[doc = " simple data objects describing the structure of the client database."]
        pub async fn describe_database_entities(
            &mut self,
            request: impl tonic::IntoRequest<super::DescribeDatabaseEntitiesRequest>,
        ) -> Result<tonic::Response<super::DescribeDatabaseEntitiesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Searches/lists the background jobs for a specific"]
        #[doc = " conversion workspace."]
        #[doc = ""]
        #[doc = " The background jobs are not resources like conversion workspaces or"]
        #[doc = " mapping rules, and they can't be created, updated or deleted."]
        #[doc = " Instead, they are a way to expose the data plane jobs log."]
        pub async fn search_background_jobs(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchBackgroundJobsRequest>,
        ) -> Result<tonic::Response<super::SearchBackgroundJobsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Retrieves a list of committed revisions of a specific conversion"]
        #[doc = " workspace."]
        ...
        #[doc = " Fetches a set of static IP addresses that need to be allowlisted by the"]
        #[doc = " customer when using the static-IP connectivity method."]
