...
pub mod solar_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service definition for the Solar API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Locates the closest building to a query point. Returns an error with"]
        #[doc = " code `NOT_FOUND` if there are no buildings within approximately 50m of the"]
        #[doc = " query point."]
        pub async fn find_closest_building_insights(
            &mut self,
            request: impl tonic::IntoRequest<super::FindClosestBuildingInsightsRequest>,
        ) -> Result<tonic::Response<super::BuildingInsights>, tonic::Status> {
        ...
        #[doc = " Gets solar information for a region surrounding a location."]
        #[doc = " Returns an error with code `NOT_FOUND` if the location is outside"]
        #[doc = " the coverage area."]
        pub async fn get_data_layers(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDataLayersRequest>,
        ) -> Result<tonic::Response<super::DataLayers>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns an image by its ID."]
