...
pub mod security_posture_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " (-- This option restricts the visibility of the API to only projects that"]
        #[doc = " will"]
        #[doc = " (-- be labeled as `PREVIEW` or `GOOGLE_INTERNAL` by the service."]
        #[doc = " (-- option (google.api.api_visibility).restriction ="]
        #[doc = " \"PREVIEW,GOOGLE_INTERNAL\"; Postures Lists Postures in a given organization"]
        #[doc = " and location. In case a posture has multiple revisions, the latest revision"]
        #[doc = " as per UpdateTime will be returned."]
        pub async fn list_postures(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPosturesRequest>,
        ) -> Result<tonic::Response<super::ListPosturesResponse>, tonic::Status> {
        ...
        #[doc = " Lists revisions of a Posture in a given organization and location."]
        pub async fn list_posture_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPostureRevisionsRequest>,
        ) -> Result<tonic::Response<super::ListPostureRevisionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a posture in a given organization and location."]
        #[doc = " User must provide revision_id to retrieve a specific revision of the"]
        #[doc = " resource."]
        #[doc = " NOT_FOUND error is returned if the revision_id or the Posture name does not"]
        #[doc = " exist. In case revision_id is not provided then the latest Posture revision"]
        #[doc = " by UpdateTime is returned."]
        pub async fn get_posture(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPostureRequest>,
        ) -> Result<tonic::Response<super::Posture>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new Posture resource."]
        #[doc = " If a Posture with the specified name already exists in the specified"]
        #[doc = " organization and location, the long running operation returns a"]
        #[doc = " [ALREADY_EXISTS][google.rpc.Code.ALREADY_EXISTS] error."]
        ...
        #[doc = " Updates an existing Posture."]
        #[doc = " A new revision of the posture will be created if the revision to be"]
        #[doc = " updated is currently deployed on a workload."]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the"]
        #[doc = " Posture does not exist."]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.ABORTED` if the etag"]
        #[doc = " supplied in the request does not match the persisted etag of the Posture."]
        #[doc = " Updatable fields are state, description and policy_sets."]
        #[doc = " State update operation cannot be clubbed with update of description and"]
        #[doc = " policy_sets."]
        #[doc = " An ACTIVE posture can be updated to both DRAFT or DEPRECATED states."]
        #[doc = " Postures in DRAFT or DEPRECATED states can only be updated to ACTIVE state."]
        ...
        #[doc = " Deletes all the revisions of a resource."]
        #[doc = " A posture can only be deleted when none of the revisions are deployed to"]
        #[doc = " any workload."]
        ...
        #[doc = " Extracts existing policies on a workload as a posture."]
        #[doc = " If a Posture on the given workload already exists, the long running"]
        #[doc = " operation returns a [ALREADY_EXISTS][google.rpc.Code.ALREADY_EXISTS] error."]
        ...
        #[doc = " PostureDeployments"]
        #[doc = " Lists PostureDeployments in a given project and location."]
        pub async fn list_posture_deployments(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPostureDeploymentsRequest>,
        ) -> Result<tonic::Response<super::ListPostureDeploymentsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single PostureDeployment."]
        pub async fn get_posture_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPostureDeploymentRequest>,
        ) -> Result<tonic::Response<super::PostureDeployment>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new PostureDeployment in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single PostureDeployment."]
        ...
        #[doc = " Deletes a single PostureDeployment."]
        ...
        #[doc = " PostureTemplates"]
        #[doc = " Lists all the PostureTemplates available to the user."]
        pub async fn list_posture_templates(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPostureTemplatesRequest>,
        ) -> Result<tonic::Response<super::ListPostureTemplatesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a PostureTemplate."]
        #[doc = " User must provide revision_id to retrieve a specific revision of the"]
        #[doc = " resource."]
        #[doc = " NOT_FOUND error is returned if the revision_id or the PostureTemplate name"]
        #[doc = " does not exist. In case revision_id is not provided then the"]
        #[doc = " PostureTemplate with latest revision_id is returned."]
        pub async fn get_posture_template(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPostureTemplateRequest>,
        ) -> Result<tonic::Response<super::PostureTemplate>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
