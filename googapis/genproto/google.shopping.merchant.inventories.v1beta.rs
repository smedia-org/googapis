...
pub mod local_inventory_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service to manage local inventory for products"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists the `LocalInventory` resources for the given product in your merchant"]
        #[doc = " account. The response might contain fewer items than specified by"]
        #[doc = " `pageSize`. If `pageToken` was returned in previous request, it can be used"]
        #[doc = " to obtain additional results."]
        #[doc = ""]
        #[doc = " `LocalInventory` resources are listed per product for a given account."]
        pub async fn list_local_inventories(
            &mut self,
            request: impl tonic::IntoRequest<super::ListLocalInventoriesRequest>,
        ) -> Result<tonic::Response<super::ListLocalInventoriesResponse>, tonic::Status> {
        ...
        #[doc = " Inserts a `LocalInventory` resource to a product in your merchant"]
        #[doc = " account."]
        #[doc = ""]
        #[doc = " Replaces the full `LocalInventory` resource if an entry with the same"]
        #[doc = " [`storeCode`][google.shopping.merchant.inventories.v1beta.LocalInventory.store_code]"]
        #[doc = " already exists for the product."]
        #[doc = ""]
        #[doc = " It might take up to 30 minutes for the new or updated `LocalInventory`"]
        #[doc = " resource to appear in products."]
        pub async fn insert_local_inventory(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertLocalInventoryRequest>,
        ) -> Result<tonic::Response<super::LocalInventory>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes the specified `LocalInventory` from the given product in your"]
        #[doc = " merchant account. It might take a up to an hour for the"]
        #[doc = " `LocalInventory` to be deleted from the specific product."]
        #[doc = " Once you have received a successful delete response, wait for that"]
        #[doc = " period before attempting a delete again."]
...
pub mod regional_inventory_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to manage regional inventory for products. There is also separate"]
    #[doc = " `regions` resource and API to manage regions definitions."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists the `RegionalInventory` resources for the given product in your"]
        #[doc = " merchant account. The response might contain fewer items than specified by"]
        #[doc = " `pageSize`.  If `pageToken` was returned in previous request, it can be"]
        #[doc = " used to obtain additional results."]
        #[doc = ""]
        #[doc = " `RegionalInventory` resources are listed per product for a given account."]
        pub async fn list_regional_inventories(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRegionalInventoriesRequest>,
        ) -> Result<tonic::Response<super::ListRegionalInventoriesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Inserts a `RegionalInventory` to a given product in your"]
        #[doc = " merchant account."]
        #[doc = ""]
        #[doc = " Replaces the full `RegionalInventory` resource if an entry with the same"]
        #[doc = " [`region`][google.shopping.merchant.inventories.v1beta.RegionalInventory.region]"]
        #[doc = " already exists for the product."]
        #[doc = ""]
        #[doc = " It might take up to 30 minutes for the new or updated `RegionalInventory`"]
        #[doc = " resource to appear in products."]
        pub async fn insert_regional_inventory(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertRegionalInventoryRequest>,
        ) -> Result<tonic::Response<super::RegionalInventory>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes the specified `RegionalInventory` resource from the given product"]
        #[doc = " in your merchant account.  It might take up to an hour for the"]
        #[doc = " `RegionalInventory` to be deleted from the specific product."]
        #[doc = " Once you have received a successful delete response, wait for that"]
        #[doc = " period before attempting a delete again."]
