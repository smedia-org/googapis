...
pub mod analytics_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for managing & accessing retail search business metric."]
    #[doc = " Retail recommendation business metric is currently not available."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Exports analytics metrics."]
        #[doc = ""]
        #[doc = " `Operation.response` is of type `ExportAnalyticsMetricsResponse`."]
...
pub mod branch_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for [Branch][google.cloud.retail.v2alpha.Branch] Management"]
    #[doc = ""]
    #[doc = " [Branch][google.cloud.retail.v2alpha.Branch]es are automatically created when"]
    #[doc = " a [Catalog][google.cloud.retail.v2alpha.Catalog] is created. There are fixed"]
    #[doc = " three branches in each catalog, and may use"]
    #[doc = " [ListBranches][google.cloud.retail.v2alpha.BranchService.ListBranches] method"]
    #[doc = " to get the details of all branches."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all [Branch][google.cloud.retail.v2alpha.Branch]s under the specified"]
        #[doc = " parent [Catalog][google.cloud.retail.v2alpha.Catalog]."]
        ...
        #[doc = " Retrieves a [Branch][google.cloud.retail.v2alpha.Branch]."]
...
pub mod catalog_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Removes all specified"]
        #[doc = " [CatalogAttribute][google.cloud.retail.v2alpha.CatalogAttribute]s from the"]
        #[doc = " [AttributesConfig][google.cloud.retail.v2alpha.AttributesConfig]."]
        pub async fn batch_remove_catalog_attributes(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchRemoveCatalogAttributesRequest>,
        ) -> Result<tonic::Response<super::BatchRemoveCatalogAttributesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod search_service_client {
    ...
    #[doc = " Enable Retail Search on Cloud Console before using this feature."]
    #[derive(Debug, Clone)]
...
pub mod completion_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Autocomplete service for retail."]
    #[doc = ""]
    #[doc = " This feature is only available for users who have Retail Search enabled."]
    #[doc = " Enable Retail Search on Cloud Console before using this feature."]
    #[derive(Debug, Clone)]
...
pub mod control_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [Control][google.cloud.retail.v2alpha.Control] to update does not exist, a"]
        ...
        #[doc = " [Catalog][google.cloud.retail.v2alpha.Catalog]."]
...
pub mod merchant_center_account_link_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Merchant Center Link service to link a Branch to a Merchant Center Account."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all"]
        #[doc = " [MerchantCenterAccountLink][google.cloud.retail.v2alpha.MerchantCenterAccountLink]s"]
        #[doc = " under the specified parent [Catalog][google.cloud.retail.v2alpha.Catalog]."]
        ...
        ) -> Result<tonic::Response<super::ListMerchantCenterAccountLinksResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Creates a"]
        #[doc = " [MerchantCenterAccountLink][google.cloud.retail.v2alpha.MerchantCenterAccountLink]."]
        ...
        #[doc = " If the"]
        #[doc = " [MerchantCenterAccountLink][google.cloud.retail.v2alpha.MerchantCenterAccountLink]"]
        #[doc = " to delete does not exist, a NOT_FOUND error is returned."]
...
pub mod model_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for performing CRUD operations on models."]
    #[doc = " Recommendation models contain all the metadata necessary to generate a set of"]
    #[doc = " models for the `Predict()` API. A model is queried"]
    #[doc = " indirectly via a ServingConfig, which associates a model with a"]
    #[doc = " given Placement (e.g. Frequently Bought Together on Home Page)."]
    #[doc = ""]
    #[doc = " This service allows you to do the following:"]
    #[doc = ""]
    #[doc = " * Initiate training of a model."]
    #[doc = " * Pause training of an existing model."]
    #[doc = " * List all the available models along with their metadata."]
    #[doc = " * Control their tuning schedule."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Update of model metadata. Only fields that"]
        #[doc = " currently can be updated are: `filtering_option` and"]
        #[doc = " `periodic_tuning_state`."]
        #[doc = " If other values are provided, this API method ignores them."]
...
pub mod product_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " Request processing may be synchronous."]
        ...
        #[doc = " fulfillment information. If the request is valid, the update is enqueued"]
        ...
        #[doc = " [ProductService.CreateProduct][google.cloud.retail.v2alpha.ProductService.CreateProduct]"]
        #[doc = " and"]
        #[doc = " [ProductService.UpdateProduct][google.cloud.retail.v2alpha.ProductService.UpdateProduct],"]
        #[doc = " the specified inventory field value(s) overwrite any existing value(s)"]
        #[doc = " while ignoring the last update time for this field. Furthermore, the last"]
        #[doc = " update times for the specified inventory fields are overwritten by the"]
        #[doc = " times of the"]
        #[doc = " [ProductService.CreateProduct][google.cloud.retail.v2alpha.ProductService.CreateProduct]"]
        #[doc = " or"]
        #[doc = " [ProductService.UpdateProduct][google.cloud.retail.v2alpha.ProductService.UpdateProduct]"]
        ...
        #[doc = " then any pre-existing inventory information for this product is used."]
        #[doc = ""]
        #[doc = " If no inventory fields are set in"]
        #[doc = " [SetInventoryRequest.set_mask][google.cloud.retail.v2alpha.SetInventoryRequest.set_mask],"]
        #[doc = " then any existing inventory information is preserved."]
        #[doc = ""]
        #[doc = " Pre-existing inventory information can only be updated with"]
        #[doc = " [ProductService.SetInventory][google.cloud.retail.v2alpha.ProductService.SetInventory],"]
        #[doc = " [ProductService.AddFulfillmentPlaces][google.cloud.retail.v2alpha.ProductService.AddFulfillmentPlaces],"]
        #[doc = " and"]
        #[doc = " [ProductService.RemoveFulfillmentPlaces][google.cloud.retail.v2alpha.ProductService.RemoveFulfillmentPlaces]."]
        #[doc = ""]
        #[doc = " The returned [Operation][google.longrunning.Operation]s is obsolete after"]
        #[doc = " one day, and the [GetOperation][google.longrunning.Operations.GetOperation]"]
        #[doc = " API returns `NOT_FOUND` afterwards."]
        #[doc = ""]
        #[doc = " If conflicting updates are issued, the"]
        #[doc = " [Operation][google.longrunning.Operation]s associated with the stale"]
        #[doc = " updates are not marked as [done][google.longrunning.Operation.done] until"]
        #[doc = " they are obsolete."]
        ...
        #[doc = " We recommend that you use the"]
        #[doc = " [ProductService.AddLocalInventories][google.cloud.retail.v2alpha.ProductService.AddLocalInventories]"]
        #[doc = " method instead of the"]
        #[doc = " [ProductService.AddFulfillmentPlaces][google.cloud.retail.v2alpha.ProductService.AddFulfillmentPlaces]"]
        #[doc = " method."]
        #[doc = " [ProductService.AddLocalInventories][google.cloud.retail.v2alpha.ProductService.AddLocalInventories]"]
        #[doc = " achieves the same results but provides more fine-grained control over"]
        #[doc = " ingesting local inventory data."]
        #[doc = ""]
        ...
        #[doc = " [ProductService.ListProducts][google.cloud.retail.v2alpha.ProductService.ListProducts]."]
        #[doc = ""]
        #[doc = " The returned [Operation][google.longrunning.Operation]s will be obsolete"]
        #[doc = " after 1 day, and [GetOperation][google.longrunning.Operations.GetOperation]"]
        #[doc = " API will return NOT_FOUND afterwards."]
        #[doc = ""]
        #[doc = " If conflicting updates are issued, the"]
        #[doc = " [Operation][google.longrunning.Operation]s associated with the stale"]
        #[doc = " updates will not be marked as [done][google.longrunning.Operation.done]"]
        #[doc = " until being obsolete."]
        ...
        #[doc = " We recommend that you use the"]
        #[doc = " [ProductService.RemoveLocalInventories][google.cloud.retail.v2alpha.ProductService.RemoveLocalInventories]"]
        #[doc = " method instead of the"]
        #[doc = " [ProductService.RemoveFulfillmentPlaces][google.cloud.retail.v2alpha.ProductService.RemoveFulfillmentPlaces]"]
        #[doc = " method."]
        #[doc = " [ProductService.RemoveLocalInventories][google.cloud.retail.v2alpha.ProductService.RemoveLocalInventories]"]
...
pub mod project_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for settings at Project level."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets the project."]
        #[doc = ""]
        #[doc = " Throws `NOT_FOUND` if the project wasn't initialized for the Retail API"]
        #[doc = " service."]
        ...
        #[doc = " Accepts service terms for this project."]
        #[doc = " By making requests to this API, you agree to the terms of service linked"]
        #[doc = " below."]
        #[doc = " https://cloud.google.com/retail/data-use-terms"]
        ...
        #[doc = " The method enrolls a solution of type [Retail"]
        #[doc = " Search][google.cloud.retail.v2alpha.SolutionType.SOLUTION_TYPE_SEARCH]"]
        #[doc = " into a project."]
        #[doc = ""]
        #[doc = " The [Recommendations AI solution"]
        #[doc = " type][google.cloud.retail.v2alpha.SolutionType.SOLUTION_TYPE_RECOMMENDATION]"]
        #[doc = " is enrolled by default when your project enables Retail API, so you don't"]
        #[doc = " need to call the enrollSolution method for recommendations."]
        ...
        #[doc = " Lists all the retail API solutions the project has enrolled."]
        pub async fn list_enrolled_solutions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListEnrolledSolutionsRequest>,
        ) -> Result<tonic::Response<super::ListEnrolledSolutionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets the [LoggingConfig][google.cloud.retail.v2alpha.LoggingConfig] of the"]
        #[doc = " requested project."]
        pub async fn get_logging_config(
            &mut self,
            request: impl tonic::IntoRequest<super::GetLoggingConfigRequest>,
        ) -> Result<tonic::Response<super::LoggingConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the [LoggingConfig][google.cloud.retail.v2alpha.LoggingConfig] of"]
        #[doc = " the requested project."]
        ...
        #[doc = " Get the [AlertConfig][google.cloud.retail.v2alpha.AlertConfig] of the"]
        #[doc = " requested project."]
        pub async fn get_alert_config(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAlertConfigRequest>,
        ) -> Result<tonic::Response<super::AlertConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Update the alert config of the requested project."]
...
pub mod user_event_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " are not annotated with detailed product information for products that are"]
        #[doc = " missing from the catalog when the user event is ingested. These"]
        #[doc = " events are stored as unjoined events with limited usage on training and"]
        #[doc = " serving. You can use this method to start a join operation on specified"]
        #[doc = " events with the latest version of product catalog. You can also use this"]
        #[doc = " method to correct events joined with the wrong product catalog. A rejoin"]
        #[doc = " operation can take hours or days to complete."]
