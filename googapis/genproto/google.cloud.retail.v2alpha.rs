...
pub mod model_service_client {
    ...
    #[doc = ""]
    #[doc = " This service allows customers to e.g.:"]
    #[doc = ""]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " currently can be updated are: filtering_option, periodic_tuning_state."]
        #[doc = " If other values are provided, this API method will ignore them."]
