...
pub mod document_link_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " This service lets you manage document-links."]
    #[doc = " Document-Links are treated as sub-resources under source documents."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Return all target document-links from the document."]
        ...
        #[doc = " Return all source document-links from the document."]
        ...
        #[doc = " Create a link between a source document and a target document."]
        ...
        #[doc = " Remove the link between the source and target documents."]
...
pub mod document_schema_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " This service lets you manage document schema."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates a Document Schema. Returns INVALID_ARGUMENT if the name of the"]
        #[doc = " Document Schema is non-empty and does not equal the existing name."]
        #[doc = " Supports only appending new properties, adding new ENUM possible values,"]
        #[doc = " and updating the"]
        #[doc = " [EnumTypeOptions.validation_check_disabled][google.cloud.contentwarehouse.v1.EnumTypeOptions.validation_check_disabled]"]
        #[doc = " flag for ENUM possible values. Updating existing properties will result"]
        #[doc = " into INVALID_ARGUMENT."]
        ...
        #[doc = " Gets a document schema. Returns NOT_FOUND if the document schema does not"]
        #[doc = " exist."]
        ...
        #[doc = " Deletes a document schema. Returns NOT_FOUND if the document schema does"]
        #[doc = " not exist. Returns BAD_REQUEST if the document schema has documents"]
        #[doc = " depending on it."]
...
pub mod document_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " This service lets you manage document."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a document. Returns NOT_FOUND if the document does not exist."]
        ...
        #[doc = " Updates a document. Returns INVALID_ARGUMENT if the name of the document"]
        ...
        #[doc = " Deletes a document. Returns NOT_FOUND if the document does not exist."]
        ...
        #[doc = " Searches for documents using provided"]
        #[doc = " [SearchDocumentsRequest][google.cloud.contentwarehouse.v1.SearchDocumentsRequest]."]
        #[doc = " This call only returns documents that the caller has permission to search"]
        #[doc = " against."]
        ...
        #[doc = " Lock the document so the document cannot be updated by other users."]
        ...
        #[doc = " Gets the access control policy for a resource. Returns NOT_FOUND error if"]
        #[doc = " the resource does not exist. Returns an empty policy if the resource exists"]
        #[doc = " but does not have a policy set."]
...
pub mod rule_set_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to manage customer specific RuleSets."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a ruleset. Returns NOT_FOUND if the ruleset does not exist."]
        ...
        #[doc = " Updates a ruleset. Returns INVALID_ARGUMENT if the name of the ruleset"]
        #[doc = " is non-empty and does not equal the existing name."]
        ...
        #[doc = " Deletes a ruleset. Returns NOT_FOUND if the document does not exist."]
...
pub mod synonym_set_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " A Service that manage/custom customer specified SynonymSets."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a SynonymSet for a single context."]
        #[doc = " Throws an ALREADY_EXISTS exception if a synonymset already exists"]
        #[doc = " for the context."]
        ...
        #[doc = " Gets a SynonymSet for a particular context."]
        #[doc = " Throws a NOT_FOUND exception if the Synonymset"]
        #[doc = " does not exist"]
        ...
        #[doc = " Remove the existing SynonymSet for the context and replaces it"]
        #[doc = " with a new one."]
        #[doc = " Throws a NOT_FOUND exception if the SynonymSet is not found."]
        ...
        #[doc = " Deletes a SynonymSet for a given context."]
        #[doc = " Throws a NOT_FOUND exception if the SynonymSet is not found."]
        ...
        #[doc = " Returns all SynonymSets (for all contexts) for the specified location."]
