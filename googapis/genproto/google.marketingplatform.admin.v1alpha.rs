...
pub mod marketingplatform_admin_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service Interface for the Google Marketing Platform Admin API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lookup for a single organization."]
        ...
        #[doc = " Lists the Google Analytics accounts link to the specified Google Marketing"]
        #[doc = " Platform organization."]
        pub async fn list_analytics_account_links(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAnalyticsAccountLinksRequest>,
        ) -> Result<tonic::Response<super::ListAnalyticsAccountLinksResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Creates the link between the Analytics account and the Google Marketing"]
        #[doc = " Platform organization."]
        #[doc = ""]
        #[doc = " User needs to be an org user, and admin on the Analytics account to create"]
        #[doc = " the link. If the account is already linked to an organization, user needs"]
        #[doc = " to unlink the account from the current organization, then try link again."]
        pub async fn create_analytics_account_link(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateAnalyticsAccountLinkRequest>,
        ) -> Result<tonic::Response<super::AnalyticsAccountLink>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes the AnalyticsAccountLink, which detaches the Analytics account from"]
        #[doc = " the Google Marketing Platform organization."]
        #[doc = ""]
        #[doc = " User needs to be an org user, and admin on the Analytics account in order"]
        #[doc = " to delete the link."]
        ...
        #[doc = " Updates the service level for an Analytics property."]
        pub async fn set_property_service_level(
            &mut self,
            request: impl tonic::IntoRequest<super::SetPropertyServiceLevelRequest>,
        ) -> Result<tonic::Response<super::SetPropertyServiceLevelResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
