...
pub mod enterprise_knowledge_graph_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " APIs for enterprise knowledge graph product."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a EntityReconciliationJob. A EntityReconciliationJob once created"]
        #[doc = " will right away be attempted to start."]
        ...
        #[doc = " Gets a EntityReconciliationJob."]
        ...
        #[doc = " Cancels a EntityReconciliationJob. Success of cancellation is not"]
        #[doc = " guaranteed."]
        ...
        #[doc = " Deletes a EntityReconciliationJob."]
        #[doc = " It only deletes the job when the job state is in FAILED, SUCCEEDED, and"]
        #[doc = " CANCELLED."]
        ...
        #[doc = " Finds the Cloud KG entities with CKG ID(s)."]
        pub async fn lookup(
            &mut self,
        ...
        #[doc = " Searches the Cloud KG entities with entity name."]
        pub async fn search(
            &mut self,
        ...
        #[doc = " Finds the public KG entities with public KG ID(s)."]
        ...
        #[doc = " Searches the public KG entities with entity name."]
