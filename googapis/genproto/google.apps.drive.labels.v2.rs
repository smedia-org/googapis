...
pub mod label_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Manage metadata taxonomies based on Labels and Fields that may be used within"]
    #[doc = " Google Drive to organize and find files using custom metadata."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Get a label by its resource name."]
        #[doc = " Resource name may be any of:"]
        #[doc = ""]
        #[doc = " * `labels/{id}` - See `labels/{id}@latest`"]
        #[doc = " * `labels/{id}@latest` - Gets the latest revision of the label."]
        #[doc = " * `labels/{id}@published` - Gets the current published revision of the"]
        #[doc = "   label."]
        #[doc = " * `labels/{id}@{revision_id}` - Gets the label at the specified revision"]
        #[doc = "   ID."]
        ...
        #[doc = " Get the constraints on the structure of a Label; such as, the maximum"]
        #[doc = " number of Fields allowed and maximum length of the label title."]
        ...
        #[doc = " Updates a single Label by applying a set of update requests resulting in a"]
        #[doc = " new draft revision. The batch update is all-or-nothing: If any of the"]
        #[doc = " update requests are invalid, no changes are applied. The resulting draft"]
        #[doc = " revision must be published before the changes may be used with Drive Items."]
        ...
        #[doc = " Updates a Label's `CopyMode`. Changes to this policy are not revisioned, do"]
        #[doc = " not require publishing, and take effect immediately."]
        ...
        #[doc = " Publish all draft changes to the Label. Once published, the Label may not"]
        #[doc = " return to its draft state. See"]
        #[doc = " `google.apps.drive.labels.v2.Lifecycle` for more information."]
        #[doc = ""]
        #[doc = " Publishing a Label will result in a new published revision. All previous"]
        #[doc = " draft revisions will be deleted. Previous published revisions will be kept"]
        #[doc = " but are subject to automated deletion as needed."]
        #[doc = ""]
        #[doc = " Once published, some changes are no longer permitted. Generally, any change"]
        #[doc = " that would invalidate or cause new restrictions on existing metadata"]
        #[doc = " related to the Label will be rejected. For example, the following changes"]
        #[doc = " to a Label will be rejected after the Label is published:"]
        #[doc = " * The label cannot be directly deleted. It must be disabled first, then"]
        #[doc = "   deleted."]
        #[doc = " * Field.FieldType cannot be changed."]
        #[doc = " * Changes to Field validation options cannot reject something that was"]
        #[doc = "   previously accepted."]
        #[doc = " * Reducing the max entries."]
        ...
        #[doc = " Disable a published Label."]
        #[doc = " Disabling a Label will result in a new disabled published revision based on"]
        #[doc = " the current published revision. If there is a draft revision, a new"]
        #[doc = " disabled draft revision will be created based on the latest draft revision."]
        #[doc = " Older draft revisions will be deleted."]
        #[doc = ""]
        #[doc = " Once disabled, a label may be deleted with `DeleteLabel`."]
        ...
        #[doc = " Enable a disabled Label and restore it to its published state."]
        #[doc = " This will result in a new published revision based on the current disabled"]
        #[doc = " published revision. If there is an existing disabled draft revision, a new"]
        #[doc = " revision will be created based on that draft and will be enabled."]
        ...
        #[doc = " Permanently deletes a Label and related metadata on Drive Items."]
        #[doc = ""]
        #[doc = " Once deleted, the Label and related Drive item metadata will be deleted."]
        #[doc = " Only draft Labels, and disabled Labels may be deleted."]
        ...
        ) -> Result<tonic::Response<super::ListLabelPermissionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates a Label's permissions. If a permission for the indicated principal"]
        #[doc = " doesn't exist, a new Label Permission is created, otherwise the existing"]
        #[doc = " permission is updated. Permissions affect the Label resource as a whole,"]
        #[doc = " are not revisioned, and do not require publishing."]
        ...
        #[doc = " Deletes a Label's permission. Permissions affect the Label resource as a"]
        #[doc = " whole, are not revisioned, and do not require publishing."]
        ...
        #[doc = " Updates Label permissions. If a permission for the"]
        #[doc = " indicated principal doesn't exist, a new Label Permission is created,"]
        #[doc = " otherwise the existing permission is updated. Permissions affect the Label"]
        #[doc = " resource as a whole, are not revisioned, and do not require publishing."]
        pub async fn batch_update_label_permissions(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchUpdateLabelPermissionsRequest>,
        ) -> Result<tonic::Response<super::BatchUpdateLabelPermissionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Deletes Label permissions. Permissions affect the Label resource as a"]
        #[doc = " whole, are not revisioned, and do not require publishing."]
