...
pub mod alert_policy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " Design your application to single-thread API calls that modify the state of"]
        #[doc = " alerting policies in a single project. This includes calls to"]
        #[doc = " CreateAlertPolicy, DeleteAlertPolicy and UpdateAlertPolicy."]
...
pub mod metric_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " The creation is executed asynchronously."]
        #[doc = " User-created metric descriptors define"]
        #[doc = " [custom metrics](https://cloud.google.com/monitoring/custom-metrics)."]
        #[doc = " The metric descriptor is updated if it already exists,"]
        #[doc = " except that metric labels are never removed."]
        ...
        #[doc = " This method does not support"]
        #[doc = " [resource locations constraint of an organization"]
        #[doc = " policy](https://cloud.google.com/resource-manager/docs/organization-policy/defining-locations#setting_the_organization_policy)."]
...
pub mod notification_channel_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " To list the types of notification channels that are supported, use"]
        #[doc = " the `ListNotificationChannelDescriptors` method."]
        ...
        #[doc = ""]
        #[doc = " Design your application to single-thread API calls that modify the state of"]
        #[doc = " notification channels in a single project. This includes calls to"]
        #[doc = " CreateNotificationChannel, DeleteNotificationChannel and"]
        #[doc = " UpdateNotificationChannel."]
...
pub mod query_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " The QueryService API is used to manage time series data in Cloud"]
...
pub mod service_monitoring_service_client {
    ...
    #[doc = " managing and querying aspects of a Metrics Scope's services. These include"]
    #[doc = " the `Service`'s monitored resources, its Service-Level Objectives, and a"]
    #[doc = " taxonomy of categorized Health Metrics."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " List `Service`s for this Metrics Scope."]
...
pub mod snooze_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " The SnoozeService API is used to temporarily prevent an alert policy from"]
    #[doc = " generating alerts. A Snooze is a description of the criteria under which one"]
    #[doc = " or more alert policies should not fire alerts for the specified duration."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a `Snooze` that will prevent alerts, which match the provided"]
        #[doc = " criteria, from being opened. The `Snooze` applies for a specific time"]
        #[doc = " interval."]
        pub async fn create_snooze(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateSnoozeRequest>,
        ) -> Result<tonic::Response<super::Snooze>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the `Snooze`s associated with a project. Can optionally pass in"]
        #[doc = " `filter`, which specifies predicates to match `Snooze`s."]
        pub async fn list_snoozes(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSnoozesRequest>,
        ) -> Result<tonic::Response<super::ListSnoozesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates a `Snooze`, identified by its `name`, with the parameters in the"]
        #[doc = " given `Snooze` object."]
...
pub mod uptime_check_service_client {
    ...
    #[doc = " Uptime check configurations in the Cloud Monitoring product. An Uptime"]
    ...
    #[doc = " (https://console.cloud.google.com), selecting the appropriate project,"]
    #[doc = " clicking on \"Monitoring\" on the left-hand side to navigate to Cloud"]
    #[doc = " Monitoring, and then clicking on \"Uptime\"."]
    #[derive(Debug, Clone)]
