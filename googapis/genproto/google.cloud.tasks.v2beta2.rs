...
pub mod cloud_tasks_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [ResumeQueue][google.cloud.tasks.v2beta2.CloudTasks.ResumeQueue]. Tasks can"]
        #[doc = " still be added when the queue is paused. A queue is paused if its"]
        #[doc = " [state][google.cloud.tasks.v2beta2.Queue.state] is"]
        #[doc = " [PAUSED][google.cloud.tasks.v2beta2.Queue.State.PAUSED]."]
        ...
        #[doc = " [DISABLED][google.cloud.tasks.v2beta2.Queue.State.DISABLED]. The state of a"]
        #[doc = " queue is stored in the queue's"]
        #[doc = " [state][google.cloud.tasks.v2beta2.Queue.state]; after calling this method"]
        #[doc = " it will be set to"]
        #[doc = " [RUNNING][google.cloud.tasks.v2beta2.Queue.State.RUNNING]."]
        #[doc = ""]
        ...
        #[doc = " Update queue list by uploading a queue.yaml file."]
        #[doc = ""]
        #[doc = " The queue.yaml file is supplied in the request body as a YAML encoded"]
        #[doc = " string. This method was added to support gcloud clients versions before"]
        #[doc = " 322.0.0. New clients should use CreateQueue instead of this method."]
        ...
        #[doc = " Gets the access control policy for a"]
        #[doc = " [Queue][google.cloud.tasks.v2beta2.Queue]. Returns an empty policy if the"]
        #[doc = " resource exists and does not have a policy set."]
        #[doc = ""]
        ...
        #[doc = " Sets the access control policy for a"]
        #[doc = " [Queue][google.cloud.tasks.v2beta2.Queue]. Replaces any existing policy."]
        #[doc = ""]
        ...
        #[doc = " [Queue][google.cloud.tasks.v2beta2.Queue]. If the resource does not exist,"]
        #[doc = " this will return an empty set of permissions, not a"]
        ...
        #[doc = ""]
        #[doc = " By default, only the [BASIC][google.cloud.tasks.v2beta2.Task.View.BASIC]"]
        #[doc = " view is retrieved due to performance considerations;"]
        #[doc = " [response_view][google.cloud.tasks.v2beta2.ListTasksRequest.response_view]"]
        ...
        #[doc = ""]
        #[doc = " * For [App Engine queues][google.cloud.tasks.v2beta2.AppEngineHttpTarget],"]
        #[doc = " the maximum task size is"]
        #[doc = "   100KB."]
        #[doc = " * For [pull queues][google.cloud.tasks.v2beta2.PullTarget], the maximum"]
        #[doc = " task size is 1MB."]
        ...
        #[doc = " [AcknowledgeTask][google.cloud.tasks.v2beta2.CloudTasks.AcknowledgeTask]"]
        #[doc = " after they have performed the work associated with the task."]
        #[doc = ""]
        #[doc = " The [payload][google.cloud.tasks.v2beta2.PullMessage.payload] is intended"]
        #[doc = " to store data that the worker needs to perform the work associated with the"]
        #[doc = " task. To return the payloads in the"]
        #[doc = " [response][google.cloud.tasks.v2beta2.LeaseTasksResponse], set"]
        #[doc = " [response_view][google.cloud.tasks.v2beta2.LeaseTasksRequest.response_view]"]
        #[doc = " to [FULL][google.cloud.tasks.v2beta2.Task.View.FULL]."]
        #[doc = ""]
        #[doc = " A maximum of 10 qps of"]
        #[doc = " [LeaseTasks][google.cloud.tasks.v2beta2.CloudTasks.LeaseTasks] requests are"]
        #[doc = " allowed per queue. [RESOURCE_EXHAUSTED][google.rpc.Code.RESOURCE_EXHAUSTED]"]
        ...
        #[doc = " [leased][google.cloud.tasks.v2beta2.CloudTasks.LeaseTasks] this task must"]
        #[doc = " call this method to indicate that the work associated with the task has"]
        #[doc = " finished."]
        #[doc = ""]
        #[doc = " The worker must acknowledge a task within the"]
        #[doc = " [lease_duration][google.cloud.tasks.v2beta2.LeaseTasksRequest.lease_duration]"]
        #[doc = " or the lease will expire and the task will become available to be leased"]
        ...
        #[doc = " returned in the task's"]
        #[doc = " [schedule_time][google.cloud.tasks.v2beta2.Task.schedule_time]."]
        ...
        #[doc = " setting its [schedule_time][google.cloud.tasks.v2beta2.Task.schedule_time]"]
        #[doc = " to now. This will make the task available to be leased to the next caller"]
        #[doc = " of [LeaseTasks][google.cloud.tasks.v2beta2.CloudTasks.LeaseTasks]."]
        ...
        #[doc = " [RateLimits][google.cloud.tasks.v2beta2.RateLimits] or is"]
        #[doc = " [PAUSED][google.cloud.tasks.v2beta2.Queue.State.PAUSED]."]
        #[doc = ""]
        #[doc = " This command is meant to be used for manual debugging. For"]
        #[doc = " example, [RunTask][google.cloud.tasks.v2beta2.CloudTasks.RunTask] can be"]
        #[doc = " used to retry a failed task after a fix has been made or to manually force"]
        #[doc = " a task to be dispatched now."]
        #[doc = ""]
        #[doc = " The dispatched task is returned. That is, the task that is returned"]
        #[doc = " contains the [status][google.cloud.tasks.v2beta2.Task.status] after the"]
        #[doc = " task is dispatched but before the task is received by its target."]
        #[doc = ""]
        ...
        #[doc = " [schedule_time][google.cloud.tasks.v2beta2.Task.schedule_time] will be"]
        #[doc = " reset to the time that"]
        #[doc = " [RunTask][google.cloud.tasks.v2beta2.CloudTasks.RunTask] was called plus"]
        #[doc = " the retry delay specified in the queue's"]
        #[doc = " [RetryConfig][google.cloud.tasks.v2beta2.RetryConfig]."]
        #[doc = ""]
        ...
        #[doc = ""]
        #[doc = " [RunTask][google.cloud.tasks.v2beta2.CloudTasks.RunTask] cannot be called"]
        #[doc = " on a [pull task][google.cloud.tasks.v2beta2.PullMessage]."]
