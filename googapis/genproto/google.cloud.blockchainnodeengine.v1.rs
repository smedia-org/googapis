...
pub mod blockchain_node_engine_client {
    ...
    use tonic::codegen::*;
    #[doc = " This service is the control plane API for Blockchain Node Engine,"]
    #[doc = " and can be used to create, read, and delete blockchain nodes."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists blockchain nodes in a given project and location."]
        pub async fn list_blockchain_nodes(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBlockchainNodesRequest>,
        ) -> Result<tonic::Response<super::ListBlockchainNodesResponse>, tonic::Status> {
        ...
        #[doc = " Gets details of a single blockchain node."]
        pub async fn get_blockchain_node(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBlockchainNodeRequest>,
        ) -> Result<tonic::Response<super::BlockchainNode>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new blockchain node in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single blockchain node."]
        ...
        #[doc = " Deletes a single blockchain node."]
