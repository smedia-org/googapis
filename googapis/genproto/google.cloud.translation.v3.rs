...
pub mod translation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Deletes an Adaptive MT dataset, including all its entries and associated"]
        #[doc = " metadata."]
        ...
        #[doc = " Gets the Adaptive MT dataset."]
        ...
        #[doc = " Lists all Adaptive MT datasets for which the caller has read permission."]
        pub async fn list_adaptive_mt_datasets(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAdaptiveMtDatasetsRequest>,
        ) -> Result<tonic::Response<super::ListAdaptiveMtDatasetsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Translate text using Adaptive MT."]
        pub async fn adaptive_mt_translate(
            &mut self,
            request: impl tonic::IntoRequest<super::AdaptiveMtTranslateRequest>,
        ) -> Result<tonic::Response<super::AdaptiveMtTranslateResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes an AdaptiveMtFile along with its sentences."]
        ...
        #[doc = " Imports an AdaptiveMtFile and adds all of its sentences into the"]
        #[doc = " AdaptiveMtDataset."]
        pub async fn import_adaptive_mt_file(
            &mut self,
            request: impl tonic::IntoRequest<super::ImportAdaptiveMtFileRequest>,
        ) -> Result<tonic::Response<super::ImportAdaptiveMtFileResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists all AdaptiveMtFiles associated to an AdaptiveMtDataset."]
        pub async fn list_adaptive_mt_files(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAdaptiveMtFilesRequest>,
        ) -> Result<tonic::Response<super::ListAdaptiveMtFilesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists all AdaptiveMtSentences under a given file/dataset."]
        pub async fn list_adaptive_mt_sentences(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAdaptiveMtSentencesRequest>,
        ) -> Result<tonic::Response<super::ListAdaptiveMtSentencesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
