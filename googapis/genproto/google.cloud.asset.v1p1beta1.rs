...
pub mod asset_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Searches all the resources within a given accessible Resource Manager scope"]
        ...
        #[doc = " Searches all the IAM policies within a given accessible Resource Manager"]
