...
pub mod data_sources_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service to manage primary, supplemental, inventory and other data sources."]
    #[doc = " See more in the [Merchant"]
    #[doc = " Center](https://support.google.com/merchants/answer/7439058) help article."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the data source configuration for the given account."]
        ...
        #[doc = " Lists the configurations for data sources for the given account."]
        ...
        #[doc = " Creates the new data source configuration for the given account."]
        ...
        #[doc = " Updates the existing data source configuration. The fields that are"]
        #[doc = " set in the update mask but not provided in the resource will be deleted."]
        ...
        #[doc = " Deletes a data source from your Merchant Center account."]
        ...
        #[doc = " Performs the data fetch immediately (even outside fetch schedule) on a"]
        #[doc = " data source from your Merchant Center Account. If you need to call"]
        #[doc = " this method more than once per day, you should use the Products service to"]
        #[doc = " update your product data instead."]
        #[doc = " This method only works on data sources with a file input set."]
