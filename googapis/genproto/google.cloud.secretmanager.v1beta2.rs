...
pub mod secret_manager_service_client {
    ...
    #[doc = ""]
    #[doc = " * [Secret][google.cloud.secretmanager.v1beta2.Secret]"]
    #[doc = " * [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists [Secrets][google.cloud.secretmanager.v1beta2.Secret]."]
        ...
        #[doc = " Creates a new [Secret][google.cloud.secretmanager.v1beta2.Secret]"]
        #[doc = " containing no"]
        #[doc = " [SecretVersions][google.cloud.secretmanager.v1beta2.SecretVersion]."]
        ...
        #[doc = " Creates a new"]
        #[doc = " [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]"]
        #[doc = " containing secret data and attaches it to an existing"]
        #[doc = " [Secret][google.cloud.secretmanager.v1beta2.Secret]."]
        ...
        #[doc = " Updates metadata of an existing"]
        #[doc = " [Secret][google.cloud.secretmanager.v1beta2.Secret]."]
        ...
        #[doc = " Deletes a [Secret][google.cloud.secretmanager.v1beta2.Secret]."]
        ...
        #[doc = " Lists [SecretVersions][google.cloud.secretmanager.v1beta2.SecretVersion]."]
        #[doc = " This call does not return secret data."]
        ...
        #[doc = " Gets metadata for a"]
        #[doc = " [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]."]
        #[doc = ""]
        #[doc = " `projects/*/secrets/*/versions/latest` is an alias to the most recently"]
        #[doc = " created [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]."]
        ...
        #[doc = " Accesses a"]
        #[doc = " [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]. This"]
        #[doc = " call returns the secret data."]
        #[doc = ""]
        #[doc = " `projects/*/secrets/*/versions/latest` is an alias to the most recently"]
        #[doc = " created [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]."]
        ...
        #[doc = " [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]."]
        #[doc = ""]
        #[doc = " Sets the [state][google.cloud.secretmanager.v1beta2.SecretVersion.state] of"]
        #[doc = " the [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion] to"]
        #[doc = " [DISABLED][google.cloud.secretmanager.v1beta2.SecretVersion.State.DISABLED]."]
        ...
        #[doc = " Sets the [state][google.cloud.secretmanager.v1beta2.SecretVersion.state] of"]
        #[doc = " the [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion] to"]
        #[doc = " [ENABLED][google.cloud.secretmanager.v1beta2.SecretVersion.State.ENABLED]."]
        ...
        #[doc = " Sets the [state][google.cloud.secretmanager.v1beta2.SecretVersion.state] of"]
        #[doc = " the [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion] to"]
        #[doc = " [DESTROYED][google.cloud.secretmanager.v1beta2.SecretVersion.State.DESTROYED]"]
        #[doc = " and irrevocably destroys the secret data."]
        ...
        #[doc = ""]
        #[doc = " Permissions on"]
        #[doc = " [SecretVersions][google.cloud.secretmanager.v1beta2.SecretVersion] are"]
        #[doc = " enforced according to the policy set on the associated"]
        #[doc = " [Secret][google.cloud.secretmanager.v1beta2.Secret]."]
