...
pub mod promotions_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service to manage promotions for products."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Inserts a promotion for your Merchant Center account. If the promotion"]
        #[doc = " already exists, then it updates the promotion instead."]
        pub async fn insert_promotion(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertPromotionRequest>,
        ) -> Result<tonic::Response<super::Promotion>, tonic::Status> {
        ...
        #[doc = " Retrieves the promotion from your Merchant Center account."]
        #[doc = ""]
        #[doc = " After inserting or updating a promotion input, it may take several"]
        #[doc = " minutes before the updated promotion can be retrieved."]
        ...
        #[doc = " Lists the promotions in your Merchant Center account. The"]
        #[doc = " response might contain fewer items than specified by `pageSize`. Rely on"]
        #[doc = " `pageToken` to determine if there are more items to be requested."]
        #[doc = ""]
        #[doc = " After inserting or updating a promotion, it may take several minutes before"]
        #[doc = " the updated processed promotion can be retrieved."]
        pub async fn list_promotions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPromotionsRequest>,
        ) -> Result<tonic::Response<super::ListPromotionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
