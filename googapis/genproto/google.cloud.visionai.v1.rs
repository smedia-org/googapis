...
pub mod health_check_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " HealthCheckService provides an interface for Vertex AI Vision Cluster Health"]
    #[doc = " Check."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " HealthCheck method checks the health status of the cluster."]
...
pub mod live_video_analytics_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service describing handlers for resources. The service enables clients to run"]
    #[doc = " Live Video Analytics (LVA) on the streaming inputs."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " ListPublicOperators returns all the operators in public registry."]
        pub async fn list_public_operators(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPublicOperatorsRequest>,
        ) -> Result<tonic::Response<super::ListPublicOperatorsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " ResolveOperatorInfo returns the operator information based on the request."]
        pub async fn resolve_operator_info(
            &mut self,
            request: impl tonic::IntoRequest<super::ResolveOperatorInfoRequest>,
        ) -> Result<tonic::Response<super::ResolveOperatorInfoResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists Operators in a given project and location."]
        pub async fn list_operators(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOperatorsRequest>,
        ) -> Result<tonic::Response<super::ListOperatorsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single Operator."]
        pub async fn get_operator(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOperatorRequest>,
        ) -> Result<tonic::Response<super::Operator>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new Operator in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Operator."]
        ...
        #[doc = " Lists Analyses in a given project and location."]
        ...
        #[doc = " Gets details of a single Analysis."]
        ...
        #[doc = " Creates a new Analysis in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Analysis."]
        ...
        #[doc = " Lists Processes in a given project and location."]
        ...
        #[doc = " Gets details of a single Process."]
        ...
        #[doc = " Creates a new Process in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Process."]
        ...
        #[doc = " Run all of the processes to \"completion\". Max time for each process is"]
        #[doc = " the LRO time limit."]
...
pub mod app_platform_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists Applications in a given project and location."]
        ...
        #[doc = " Gets details of a single Application."]
        ...
        #[doc = " Creates a new Application in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Application."]
        ...
        #[doc = " Deletes a single Application."]
        ...
        #[doc = " Deploys a single Application."]
        ...
        #[doc = " Undeploys a single Application."]
        ...
        #[doc = " Adds target stream input to the Application."]
        #[doc = " If the Application is deployed, the corresponding new Application instance"]
        #[doc = " will be created. If the stream has already been in the Application, the RPC"]
        #[doc = " will fail."]
        ...
        #[doc = " Remove target stream input to the Application, if the Application is"]
        #[doc = " deployed, the corresponding instance based will be deleted. If the stream"]
        #[doc = " is not in the Application, the RPC will fail."]
        ...
        #[doc = " Update target stream input to the Application, if the Application is"]
        #[doc = " deployed, the corresponding instance based will be deployed. For"]
        #[doc = " CreateOrUpdate behavior, set allow_missing to true."]
        ...
        #[doc = " Lists Drafts in a given project and location."]
        ...
        #[doc = " Gets details of a single Draft."]
        ...
        #[doc = " Creates a new Draft in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Draft."]
        ...
        #[doc = " Lists Processors in a given project and location."]
        ...
        #[doc = " ListPrebuiltProcessors is a custom pass-through verb that Lists Prebuilt"]
        #[doc = " Processors."]
        pub async fn list_prebuilt_processors(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPrebuiltProcessorsRequest>,
        ) -> Result<tonic::Response<super::ListPrebuiltProcessorsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single Processor."]
        ...
        #[doc = " Creates a new Processor in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Processor."]
        ...
        #[doc = " Deletes a single Processor."]
...
pub mod prediction_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " A service for online prediction."]
    #[derive(Debug, Clone)]
...
pub mod streaming_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Streaming service for receiving and sending packets."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Send packets to the series."]
        ...
        #[doc = " Receive packets from the series."]
        ...
        #[doc = " Receive events given the stream name."]
        ...
        #[doc = " AcquireLease acquires a lease."]
        ...
        #[doc = " RleaseLease releases a lease."]
...
pub mod streams_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service describing handlers for resources."]
    #[doc = " Vision API and Vision AI API are two independent APIs developed by the same"]
    #[doc = " team. Vision API is for people to annotate their image while Vision AI is an"]
    #[doc = " e2e solution for customer to build their own computer vision application."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists Streams in a given project and location."]
        ...
        #[doc = " Gets the thumbnail (image snapshot) of a single Stream."]
        ...
        #[doc = " Generate the JWT auth token required to get the stream HLS contents."]
        pub async fn generate_stream_hls_token(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateStreamHlsTokenRequest>,
        ) -> Result<tonic::Response<super::GenerateStreamHlsTokenResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists Events in a given project and location."]
        ...
        #[doc = " Gets details of a single Event."]
        ...
        #[doc = " Creates a new Event in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Event."]
        ...
        #[doc = " Lists Series in a given project and location."]
        ...
        #[doc = " Gets details of a single Series."]
        ...
        #[doc = " Creates a new Series in a given project and location."]
...
pub mod warehouse_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service that manages media content + metadata for streaming."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates an asset inside corpus."]
        ...
        #[doc = " Updates an asset inside corpus."]
        ...
        #[doc = " Reads an asset inside corpus."]
        ...
        #[doc = " Lists an list of assets inside corpus."]
        ...
        #[doc = " Deletes asset inside corpus."]
        ...
        #[doc = " Upload asset by specifing the asset Cloud Storage uri."]
        #[doc = " For video warehouse, it requires users who call this API have read access"]
        #[doc = " to the cloud storage file. Once it is uploaded, it can be retrieved by"]
        #[doc = " GenerateRetrievalUrl API which by default, only can retrieve cloud storage"]
        #[doc = " files from the same project of the warehouse. To allow retrieval cloud"]
        #[doc = " storage files that are in a separate project, it requires to find the"]
        #[doc = " vision ai service account (Go to IAM, check checkbox to show \"Include"]
        #[doc = " Google-provided role grants\", search for \"Cloud Vision AI Service Agent\")"]
        #[doc = " and grant the read access of the cloud storage files to that service"]
        #[doc = " account."]
        ...
        #[doc = " Generates a signed url for downloading the asset."]
        #[doc = " For video warehouse, please see comment of UploadAsset about how to allow"]
        #[doc = " retrieval of cloud storage files in a different project."]
        pub async fn generate_retrieval_url(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateRetrievalUrlRequest>,
        ) -> Result<tonic::Response<super::GenerateRetrievalUrlResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Analyze asset to power search capability."]
        ...
        #[doc = " Index one asset for search."]
        #[doc = " Supported corpus type: Corpus.Type.VIDEO_ON_DEMAND"]
        ...
        #[doc = " Remove one asset's index data for search."]
        #[doc = " Supported corpus type: Corpus.Type.VIDEO_ON_DEMAND"]
        ...
        #[doc = " Lists assets inside an index."]
        pub async fn view_indexed_assets(
            &mut self,
            request: impl tonic::IntoRequest<super::ViewIndexedAssetsRequest>,
        ) -> Result<tonic::Response<super::ViewIndexedAssetsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates an Index under the corpus."]
        ...
        #[doc = " Updates an Index under the corpus."]
        #[doc = " Users can perform a metadata-only update or trigger a full index rebuild"]
        #[doc = " with different update_mask values."]
        ...
        #[doc = " Gets the details of a single Index under a Corpus."]
        ...
        #[doc = " List all Indexes in a given Corpus."]
        ...
        #[doc = " Delete a single Index. In order to delete an index, the caller must"]
        #[doc = " make sure that it is not deployed to any index endpoint."]
        ...
        #[doc = " Creates a corpus inside a project."]
        ...
        #[doc = " Gets corpus details inside a project."]
        ...
        #[doc = " Updates a corpus in a project."]
        ...
        #[doc = " Lists all corpora in a project."]
        ...
        #[doc = " Deletes a corpus only if its empty."]
        ...
        #[doc = " Creates data schema inside corpus."]
        ...
        #[doc = " Updates data schema inside corpus."]
        ...
        #[doc = " Gets data schema inside corpus."]
        ...
        #[doc = " Deletes data schema inside corpus."]
        ...
        #[doc = " Lists a list of data schemas inside corpus."]
        ...
        #[doc = " Creates annotation inside asset."]
        ...
        #[doc = " Reads annotation inside asset."]
        ...
        #[doc = " Lists a list of annotations inside asset."]
        ...
        #[doc = " Updates annotation inside asset."]
        ...
        #[doc = " Deletes annotation inside asset."]
        ...
        #[doc = " Ingests data for the asset. It is not allowed to ingest a data chunk which"]
        #[doc = " is already expired according to TTL."]
        #[doc = " This method is only available via the gRPC API (not HTTP since"]
        #[doc = " bi-directional streaming is not supported via HTTP)."]
        ...
        #[doc = " Generates clips for downloading. The api takes in a time range, and"]
        #[doc = " generates a clip of the first content available after start_time and"]
        #[doc = " before end_time, which may overflow beyond these bounds."]
        #[doc = " Returned clips are truncated if the total size of the clips are larger"]
        #[doc = " than 100MB."]
        ...
        #[doc = " Generates a uri for an HLS manifest. The api takes in a collection of time"]
        #[doc = " ranges, and generates a URI for an HLS manifest that covers all the"]
        #[doc = " requested time ranges."]
        ...
        #[doc = " Imports assets (images plus annotations) from a meta file on cloud storage."]
        #[doc = " Each row in the meta file is corresponding to an image (specified by a"]
        #[doc = " cloud storage uri) and its annotations."]
        ...
        #[doc = " Creates a search configuration inside a corpus."]
        #[doc = ""]
        #[doc = " Please follow the rules below to create a valid CreateSearchConfigRequest."]
        #[doc = " --- General Rules ---"]
        #[doc = " 1. Request.search_config_id must not be associated with an existing"]
        #[doc = "    SearchConfig."]
        #[doc = " 2. Request must contain at least one non-empty search_criteria_property or"]
        #[doc = "    facet_property."]
        #[doc = " 3. mapped_fields must not be empty, and must map to existing UGA keys."]
        #[doc = " 4. All mapped_fields must be of the same type."]
        #[doc = " 5. All mapped_fields must share the same granularity."]
        #[doc = " 6. All mapped_fields must share the same semantic SearchConfig match"]
        #[doc = "    options."]
        #[doc = " For property-specific rules, please reference the comments for"]
        #[doc = " FacetProperty and SearchCriteriaProperty."]
        ...
        #[doc = " Updates a search configuration inside a corpus."]
        #[doc = ""]
        #[doc = " Please follow the rules below to create a valid UpdateSearchConfigRequest."]
        #[doc = " --- General Rules ---"]
        #[doc = " 1. Request.search_configuration.name must already exist."]
        #[doc = " 2. Request must contain at least one non-empty search_criteria_property or"]
        #[doc = " facet_property."]
        #[doc = " 3. mapped_fields must not be empty, and must map to existing UGA keys."]
        #[doc = " 4. All mapped_fields must be of the same type."]
        ...
        #[doc = " Gets a search configuration inside a corpus."]
        ...
        #[doc = " Deletes a search configuration inside a corpus."]
        #[doc = ""]
        #[doc = " For a DeleteSearchConfigRequest to be valid,"]
        #[doc = " Request.search_configuration.name must already exist."]
        ...
        #[doc = " Lists all search configurations inside a corpus."]
        ...
        #[doc = " Creates a SearchHypernym inside a corpus."]
        pub async fn create_search_hypernym(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateSearchHypernymRequest>,
        ) -> Result<tonic::Response<super::SearchHypernym>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates a SearchHypernym inside a corpus."]
        ...
        #[doc = " Gets a SearchHypernym inside a corpus."]
        ...
        #[doc = " Deletes a SearchHypernym inside a corpus."]
        ...
        #[doc = " Lists SearchHypernyms inside a corpus."]
        pub async fn list_search_hypernyms(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSearchHypernymsRequest>,
        ) -> Result<tonic::Response<super::ListSearchHypernymsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Search a deployed index endpoint (IMAGE corpus type only)."]
        pub async fn search_index_endpoint(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchIndexEndpointRequest>,
        ) -> Result<tonic::Response<super::SearchIndexEndpointResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists all IndexEndpoints in a project."]
        ...
        #[doc = " Deploys an Index to IndexEndpoint."]
        ...
        #[doc = " Undeploys an Index from IndexEndpoint."]
        ...
        ) -> Result<tonic::Response<super::Collection>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists collections inside a corpus."]
        ...
        #[doc = " Adds an item into a Collection."]
        pub async fn add_collection_item(
            &mut self,
            request: impl tonic::IntoRequest<super::AddCollectionItemRequest>,
        ) -> Result<tonic::Response<super::AddCollectionItemResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Removes an item from a collection."]
        pub async fn remove_collection_item(
            &mut self,
            request: impl tonic::IntoRequest<super::RemoveCollectionItemRequest>,
        ) -> Result<tonic::Response<super::RemoveCollectionItemResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " View items inside a collection."]
        pub async fn view_collection_items(
            &mut self,
            request: impl tonic::IntoRequest<super::ViewCollectionItemsRequest>,
        ) -> Result<tonic::Response<super::ViewCollectionItemsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
