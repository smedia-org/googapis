...
pub mod storage_transfer_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Starts a new operation for the specified transfer job."]
        #[doc = " A `TransferJob` has a maximum of one active `TransferOperation`. If this"]
        #[doc = " method is called while a `TransferOperation` is active, an error is"]
        #[doc = " returned."]
