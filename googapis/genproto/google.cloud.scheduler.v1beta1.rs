...
pub mod cloud_scheduler_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates a job."]
        #[doc = ""]
        #[doc = " If successful, the updated [Job][google.cloud.scheduler.v1beta1.Job] is"]
        #[doc = " returned. If the job does not exist, `NOT_FOUND` is returned."]
        #[doc = ""]
        #[doc = " If UpdateJob does not successfully return, it is possible for the"]
        #[doc = " job to be in an"]
        #[doc = " [Job.State.UPDATE_FAILED][google.cloud.scheduler.v1beta1.Job.State.UPDATE_FAILED]"]
        #[doc = " state. A job in this state may not be executed. If this happens, retry the"]
        #[doc = " UpdateJob request until a successful response is received."]
        ...
        #[doc = " until it is re-enabled via"]
        #[doc = " [ResumeJob][google.cloud.scheduler.v1beta1.CloudScheduler.ResumeJob]. The"]
        #[doc = " state of the job is stored in"]
        #[doc = " [state][google.cloud.scheduler.v1beta1.Job.state]; if paused it will be set"]
        #[doc = " to [Job.State.PAUSED][google.cloud.scheduler.v1beta1.Job.State.PAUSED]. A"]
        #[doc = " job must be in"]
        #[doc = " [Job.State.ENABLED][google.cloud.scheduler.v1beta1.Job.State.ENABLED] to be"]
        #[doc = " paused."]
        ...
        #[doc = " Resume a job."]
        #[doc = ""]
        #[doc = " This method reenables a job after it has been"]
        #[doc = " [Job.State.PAUSED][google.cloud.scheduler.v1beta1.Job.State.PAUSED]. The"]
        #[doc = " state of a job is stored in"]
        #[doc = " [Job.state][google.cloud.scheduler.v1beta1.Job.state]; after calling this"]
        #[doc = " method it will be set to"]
        #[doc = " [Job.State.ENABLED][google.cloud.scheduler.v1beta1.Job.State.ENABLED]. A"]
        #[doc = " job must be in"]
        #[doc = " [Job.State.PAUSED][google.cloud.scheduler.v1beta1.Job.State.PAUSED] to be"]
        #[doc = " resumed."]
