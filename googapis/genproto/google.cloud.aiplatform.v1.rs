...
pub mod dataset_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Searches DataItems in a Dataset."]
        ...
        #[doc = " Lists SavedQueries in a Dataset."]
...
pub mod endpoint_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates an existing deployed model. Updatable fields include"]
        #[doc = " `min_replica_count`, `max_replica_count`, `autoscaling_metric_specs`,"]
        #[doc = " `disable_container_logging` (v1 only), and `enable_container_logging`"]
        #[doc = " (v1beta1 only)."]
...
pub mod featurestore_online_serving_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Writes Feature values of one or more entities of an EntityType."]
        #[doc = ""]
        #[doc = " The Feature values are merged into existing entities if any. The Feature"]
        #[doc = " values to be written must have timestamp within the online storage"]
        #[doc = " retention."]
...
pub mod featurestore_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Delete Feature values from Featurestore."]
        #[doc = ""]
        #[doc = " The progress of the deletion is tracked by the returned operation. The"]
        #[doc = " deleted feature values are guaranteed to be invisible to subsequent read"]
        #[doc = " operations after the operation is marked as successfully done."]
        #[doc = ""]
        #[doc = " If a delete feature values operation fails, the feature values"]
        #[doc = " returned from reads and exports may be inconsistent. If consistency is"]
        #[doc = " required, the caller must retry the same delete request again and wait till"]
        #[doc = " the new operation returned is marked as successfully done."]
...
pub mod index_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [DeployedIndexes][google.cloud.aiplatform.v1.Index.deployed_indexes] had"]
        #[doc = " been undeployed."]
        ...
        #[doc = " Add/update Datapoints into an Index."]
        ...
        #[doc = " Remove Datapoints from an Index."]
...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " guaranteed. Clients can use"]
        #[doc = " [JobService.GetCustomJob][google.cloud.aiplatform.v1.JobService.GetCustomJob]"]
        #[doc = " or other methods to check whether the cancellation succeeded or whether the"]
        ...
        #[doc = " a [CustomJob.error][google.cloud.aiplatform.v1.CustomJob.error] value with"]
        #[doc = " a [google.rpc.Status.code][google.rpc.Status.code] of 1, corresponding to"]
        #[doc = " `Code.CANCELLED`, and"]
        #[doc = " [CustomJob.state][google.cloud.aiplatform.v1.CustomJob.state] is set to"]
        #[doc = " `CANCELLED`."]
        ...
        #[doc = " makes a best effort to cancel the job, but success is not"]
        #[doc = " guaranteed. Clients can use"]
        #[doc = " [JobService.GetHyperparameterTuningJob][google.cloud.aiplatform.v1.JobService.GetHyperparameterTuningJob]"]
        #[doc = " or other methods to check whether the cancellation succeeded or whether the"]
        #[doc = " job completed despite cancellation. On successful cancellation,"]
        #[doc = " the HyperparameterTuningJob is not deleted; instead it becomes a job with"]
        #[doc = " a"]
        #[doc = " [HyperparameterTuningJob.error][google.cloud.aiplatform.v1.HyperparameterTuningJob.error]"]
        #[doc = " value with a [google.rpc.Status.code][google.rpc.Status.code] of 1,"]
        #[doc = " corresponding to `Code.CANCELLED`, and"]
        #[doc = " [HyperparameterTuningJob.state][google.cloud.aiplatform.v1.HyperparameterTuningJob.state]"]
        #[doc = " is set to `CANCELLED`."]
        ...
        #[doc = " Lists NasJobs in a Location."]
        ...
        #[doc = " Cancels a NasJob."]
        #[doc = " Starts asynchronous cancellation on the NasJob. The server"]
        #[doc = " makes a best effort to cancel the job, but success is not"]
        #[doc = " guaranteed. Clients can use"]
        #[doc = " [JobService.GetNasJob][google.cloud.aiplatform.v1.JobService.GetNasJob] or"]
        #[doc = " other methods to check whether the cancellation succeeded or whether the"]
        #[doc = " job completed despite cancellation. On successful cancellation,"]
        #[doc = " the NasJob is not deleted; instead it becomes a job with"]
        #[doc = " a [NasJob.error][google.cloud.aiplatform.v1.NasJob.error] value with a"]
        #[doc = " [google.rpc.Status.code][google.rpc.Status.code] of 1, corresponding to"]
        #[doc = " `Code.CANCELLED`, and"]
        #[doc = " [NasJob.state][google.cloud.aiplatform.v1.NasJob.state] is set to"]
        #[doc = " `CANCELLED`."]
        ...
        #[doc = " List top NasTrialDetails of a NasJob."]
        ...
        #[doc = " guaranteed. Clients can use"]
        #[doc = " [JobService.GetBatchPredictionJob][google.cloud.aiplatform.v1.JobService.GetBatchPredictionJob]"]
        #[doc = " or other methods to check whether the cancellation succeeded or whether the"]
        #[doc = " job completed despite cancellation. On a successful cancellation,"]
        #[doc = " the BatchPredictionJob is not deleted;instead its"]
        #[doc = " [BatchPredictionJob.state][google.cloud.aiplatform.v1.BatchPredictionJob.state]"]
        #[doc = " is set to `CANCELLED`. Any files already outputted by the job are not"]
        #[doc = " deleted."]
        ...
        #[doc = " [ModelDeploymentMonitoringJob.state][google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob.state]"]
        #[doc = " to 'PAUSED'."]
...
pub mod match_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " MatchService is a Google managed service for efficient vector similarity"]
    #[doc = " search at scale."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Finds the nearest neighbors of each vector within the request."]
        ...
        #[doc = " Reads the datapoints/vectors of the given IDs."]
        #[doc = " A maximum of 1000 datapoints can be retrieved in a batch."]
...
pub mod metadata_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Remove a set of children contexts from a parent Context. If any of the"]
        #[doc = " child Contexts were NOT added to the parent Context, they are"]
        #[doc = " simply skipped."]
        pub async fn remove_context_children(
            &mut self,
            request: impl tonic::IntoRequest<super::RemoveContextChildrenRequest>,
        ) -> Result<tonic::Response<super::RemoveContextChildrenResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod model_garden_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " The interface of Model Garden Service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a Model Garden publisher model."]
...
pub mod model_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Incrementally update the dataset used for an examples model."]
        ...
        #[doc = " Deletes a Model."]
        #[doc = ""]
        #[doc = " A model cannot be deleted if any"]
        #[doc = " [Endpoint][google.cloud.aiplatform.v1.Endpoint] resource has a"]
        #[doc = " [DeployedModel][google.cloud.aiplatform.v1.DeployedModel] based on the"]
        #[doc = " model in its"]
        #[doc = " [deployed_models][google.cloud.aiplatform.v1.Endpoint.deployed_models]"]
        #[doc = " field."]
        ...
        #[doc = ""]
        #[doc = " Model version can only be deleted if there are no"]
        #[doc = " [DeployedModels][google.cloud.aiplatform.v1.DeployedModel] created from it."]
        #[doc = " Deleting the only version in the Model is not allowed. Use"]
        #[doc = " [DeleteModel][google.cloud.aiplatform.v1.ModelService.DeleteModel] for"]
        #[doc = " deleting the Model instead."]
        ...
        #[doc = " [supported export"]
        #[doc = " format][google.cloud.aiplatform.v1.Model.supported_export_formats]."]
        ...
        #[doc = " Copies an already existing Vertex AI Model into the specified Location."]
        #[doc = " The source Model must exist in the same Project."]
        #[doc = " When copying custom Models, the users themselves are responsible for"]
        #[doc = " [Model.metadata][google.cloud.aiplatform.v1.Model.metadata] content to be"]
        #[doc = " region-agnostic, as well as making sure that any resources (e.g. files) it"]
        #[doc = " depends on remain accessible."]
        ...
        #[doc = " Imports a list of externally generated ModelEvaluationSlice."]
        ...
        ) -> Result<tonic::Response<super::BatchImportModelEvaluationSlicesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Imports a list of externally generated EvaluatedAnnotations."]
        ...
        ) -> Result<tonic::Response<super::BatchImportEvaluatedAnnotationsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod pipeline_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " guaranteed. Clients can use"]
        #[doc = " [PipelineService.GetTrainingPipeline][google.cloud.aiplatform.v1.PipelineService.GetTrainingPipeline]"]
        #[doc = " or other methods to check whether the cancellation succeeded or whether the"]
        ...
        #[doc = " a"]
        #[doc = " [TrainingPipeline.error][google.cloud.aiplatform.v1.TrainingPipeline.error]"]
        #[doc = " value with a [google.rpc.Status.code][google.rpc.Status.code] of 1,"]
        #[doc = " corresponding to `Code.CANCELLED`, and"]
        #[doc = " [TrainingPipeline.state][google.cloud.aiplatform.v1.TrainingPipeline.state]"]
        #[doc = " is set to `CANCELLED`."]
        ...
        #[doc = " makes a best effort to cancel the pipeline, but success is not"]
        #[doc = " guaranteed. Clients can use"]
        #[doc = " [PipelineService.GetPipelineJob][google.cloud.aiplatform.v1.PipelineService.GetPipelineJob]"]
        #[doc = " or other methods to check whether the cancellation succeeded or whether the"]
        #[doc = " pipeline completed despite cancellation. On successful cancellation,"]
        #[doc = " the PipelineJob is not deleted; instead it becomes a pipeline with"]
        #[doc = " a [PipelineJob.error][google.cloud.aiplatform.v1.PipelineJob.error] value"]
        #[doc = " with a [google.rpc.Status.code][google.rpc.Status.code] of 1, corresponding"]
        #[doc = " to `Code.CANCELLED`, and"]
        #[doc = " [PipelineJob.state][google.cloud.aiplatform.v1.PipelineJob.state] is set to"]
        #[doc = " `CANCELLED`."]
...
pub mod prediction_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " * `X-Vertex-AI-Endpoint-Id`: ID of the"]
        #[doc = " [Endpoint][google.cloud.aiplatform.v1.Endpoint] that served this"]
        #[doc = " prediction."]
        #[doc = ""]
        #[doc = " * `X-Vertex-AI-Deployed-Model-Id`: ID of the Endpoint's"]
        #[doc = " [DeployedModel][google.cloud.aiplatform.v1.DeployedModel] that served this"]
        #[doc = " prediction."]
        ...
        #[doc = ""]
        #[doc = " If"]
        #[doc = " [deployed_model_id][google.cloud.aiplatform.v1.ExplainRequest.deployed_model_id]"]
        #[doc = " is specified, the corresponding DeployModel must have"]
...
pub mod tensorboard_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns a list of monthly active users for a given TensorBoard instance."]
        pub async fn read_tensorboard_usage(
            &mut self,
            request: impl tonic::IntoRequest<super::ReadTensorboardUsageRequest>,
        ) -> Result<tonic::Response<super::ReadTensorboardUsageResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " data points stored is less than the limit, all data is returned."]
        #[doc = " Otherwise, the number limit of data points is randomly selected from"]
        ...
        #[doc = " points stored is less than 1000, all data is returned. Otherwise, 1000"]
        #[doc = " data points is randomly selected from this time series and returned."]
        ...
        #[doc = " TensorboardRun's. If any data fail to be ingested, an error is returned."]
        ...
        #[doc = " a TensorboardRun. If any data fail to be ingested, an error is returned."]
...
pub mod vizier_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " a"]
        #[doc = " [SuggestTrialsResponse][google.cloud.aiplatform.v1.SuggestTrialsResponse]."]
        ...
        #[doc = " [CheckTrialEarlyStoppingStateResponse][google.cloud.aiplatform.v1.CheckTrialEarlyStoppingStateResponse]."]
