...
pub mod gdc_hardware_management_client {
    ...
    use tonic::codegen::*;
    #[doc = " The GDC Hardware Management service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists orders in a given project and location."]
        ...
        #[doc = " Creates a new order in a given project and location."]
        ...
        #[doc = " Updates the parameters of an order."]
        ...
        #[doc = " Lists sites in a given project and location."]
        pub async fn list_sites(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSitesRequest>,
        ) -> Result<tonic::Response<super::ListSitesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a site."]
        pub async fn get_site(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSiteRequest>,
        ) -> Result<tonic::Response<super::Site>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new site in a given project and location."]
        ...
        #[doc = " Updates the parameters of a site."]
        ...
        #[doc = " Lists hardware groups in a given order."]
        pub async fn list_hardware_groups(
            &mut self,
            request: impl tonic::IntoRequest<super::ListHardwareGroupsRequest>,
        ) -> Result<tonic::Response<super::ListHardwareGroupsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new hardware group in a given order."]
        ...
        #[doc = " Updates the parameters of a hardware group."]
        ...
        #[doc = " Lists hardware in a given project and location."]
        pub async fn list_hardware(
            &mut self,
            request: impl tonic::IntoRequest<super::ListHardwareRequest>,
        ) -> Result<tonic::Response<super::ListHardwareResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates new hardware in a given project and location."]
        ...
        #[doc = " Updates hardware parameters."]
        ...
        #[doc = " Lists the comments on an order."]
        ...
        #[doc = " Gets the content of a comment."]
        ...
        #[doc = " Creates a new comment on an order."]
        ...
        #[doc = " Lists the changes made to an order."]
        pub async fn list_change_log_entries(
            &mut self,
            request: impl tonic::IntoRequest<super::ListChangeLogEntriesRequest>,
        ) -> Result<tonic::Response<super::ListChangeLogEntriesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a change to an order."]
        pub async fn get_change_log_entry(
            &mut self,
            request: impl tonic::IntoRequest<super::GetChangeLogEntryRequest>,
        ) -> Result<tonic::Response<super::ChangeLogEntry>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists SKUs for a given project and location."]
        ...
        #[doc = " Gets details of an SKU."]
        pub async fn get_sku(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSkuRequest>,
        ) -> Result<tonic::Response<super::Sku>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new zone in a given project and location."]
        ...
        #[doc = " Updates the parameters of a zone."]
        ...
        #[doc = " Signals the state of a zone."]
