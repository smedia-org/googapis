...
pub mod certificate_manager_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists CertificateIssuanceConfigs in a given project and location."]
        pub async fn list_certificate_issuance_configs(
            &mut self,
            request: impl tonic::IntoRequest<super::ListCertificateIssuanceConfigsRequest>,
        ) -> Result<tonic::Response<super::ListCertificateIssuanceConfigsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Gets details of a single CertificateIssuanceConfig."]
        ...
        #[doc = " Creates a new CertificateIssuanceConfig in a given project and location."]
        ...
        #[doc = " Deletes a single CertificateIssuanceConfig."]
