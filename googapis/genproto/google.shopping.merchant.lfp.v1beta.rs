...
pub mod lfp_inventory_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for a [LFP"]
    #[doc = " partner](https://support.google.com/merchants/answer/7676652) to submit local"]
    #[doc = " inventories for a merchant."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Inserts a `LfpInventory` resource for the given target merchant account. If"]
        #[doc = " the resource already exists, it will be replaced. The inventory"]
        #[doc = " automatically expires after 30 days."]
        pub async fn insert_lfp_inventory(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertLfpInventoryRequest>,
        ) -> Result<tonic::Response<super::LfpInventory>, tonic::Status> {
...
pub mod lfp_sale_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for a [LFP"]
    #[doc = " partner](https://support.google.com/merchants/answer/7676652) to submit sales"]
    #[doc = " data for a merchant."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Inserts a `LfpSale` for the given merchant."]
        pub async fn insert_lfp_sale(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertLfpSaleRequest>,
        ) -> Result<tonic::Response<super::LfpSale>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod lfp_store_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves information about a store."]
        pub async fn get_lfp_store(
            &mut self,
            request: impl tonic::IntoRequest<super::GetLfpStoreRequest>,
        ) -> Result<tonic::Response<super::LfpStore>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Inserts a store for the target merchant. If the store with the same store"]
        #[doc = " code already exists, it will be replaced."]
        ...
        #[doc = " Deletes a store for a target merchant."]
        ...
        #[doc = " Lists the stores of the target merchant, specified by the filter in"]
        #[doc = " `ListLfpStoresRequest`."]
        pub async fn list_lfp_stores(
            &mut self,
            request: impl tonic::IntoRequest<super::ListLfpStoresRequest>,
        ) -> Result<tonic::Response<super::ListLfpStoresResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
