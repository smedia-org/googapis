...
pub mod trace_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for collecting and viewing traces and spans within a trace."]
    #[doc = ""]
    #[doc = " A trace is a collection of spans corresponding to a single"]
    #[doc = " operation or a set of operations in an application."]
    #[doc = ""]
    #[doc = " A span is an individual timed event which forms a node of the trace tree."]
    #[doc = " A single trace can contain spans from multiple services."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Batch writes new spans to new or existing traces. You cannot update"]
        #[doc = " existing spans."]
