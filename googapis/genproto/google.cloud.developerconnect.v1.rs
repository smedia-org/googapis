...
pub mod developer_connect_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a GitRepositoryLink. Upon linking a Git Repository, Developer"]
        #[doc = " Connect will configure the Git Repository to send webhook events to"]
        #[doc = " Developer Connect. Connections that use Firebase GitHub Application will"]
        #[doc = " have events forwarded to the Firebase service. All other Connections will"]
        #[doc = " have events forwarded to Cloud Build."]
        ...
        #[doc = " Deletes a single GitRepositoryLink."]
        ...
        #[doc = " Lists GitRepositoryLinks in a given project, location, and connection."]
        pub async fn list_git_repository_links(
            &mut self,
            request: impl tonic::IntoRequest<super::ListGitRepositoryLinksRequest>,
        ) -> Result<tonic::Response<super::ListGitRepositoryLinksResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single GitRepositoryLink."]
        pub async fn get_git_repository_link(
            &mut self,
            request: impl tonic::IntoRequest<super::GetGitRepositoryLinkRequest>,
        ) -> Result<tonic::Response<super::GitRepositoryLink>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Fetches read/write token of a given gitRepositoryLink."]
        ...
        #[doc = " Fetches read token of a given gitRepositoryLink."]
        ...
        #[doc = " FetchLinkableGitRepositories returns a list of git repositories from an SCM"]
        #[doc = " that are available to be added to a Connection."]
        pub async fn fetch_linkable_git_repositories(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchLinkableGitRepositoriesRequest>,
        ) -> Result<tonic::Response<super::FetchLinkableGitRepositoriesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " FetchGitHubInstallations returns the list of GitHub Installations that"]
        #[doc = " are available to be added to a Connection."]
        #[doc = " For github.com, only installations accessible to the authorizer token"]
        #[doc = " are returned. For GitHub Enterprise, all installations are returned."]
        pub async fn fetch_git_hub_installations(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchGitHubInstallationsRequest>,
        ) -> Result<tonic::Response<super::FetchGitHubInstallationsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
