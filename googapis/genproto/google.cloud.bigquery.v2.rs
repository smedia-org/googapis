...
pub mod dataset_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " This is an experimental RPC service definition for the BigQuery"]
    #[doc = " Dataset Service."]
    #[doc = ""]
    #[doc = " It should not be relied on for production use cases at this time."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates information in an existing dataset. The update method replaces the"]
        #[doc = " entire dataset resource, whereas the patch method only replaces fields that"]
        #[doc = " are provided in the submitted dataset resource."]
        #[doc = " This method supports RFC5789 patch semantics."]
        ...
        #[doc = " Deletes the dataset specified by the datasetId value. Before you can delete"]
        #[doc = " a dataset, you must delete all its tables, either manually or by specifying"]
        #[doc = " deleteContents. Immediately after deletion, you can create another dataset"]
        ...
        #[doc = " Lists all datasets in the specified project to which the user has been"]
        #[doc = " granted the READER dataset role."]
        ...
        #[doc = " Undeletes a dataset which is within time travel window based on datasetId."]
        #[doc = " If a time is specified, the dataset version deleted at that time is"]
        #[doc = " undeleted, else the last live version is undeleted."]
...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Requests that a job be cancelled. This call will return immediately, and"]
        #[doc = " the client will need to poll for the job status to see if the cancel"]
        #[doc = " completed successfully. Cancelled jobs may still incur costs."]
        pub async fn cancel_job(
            &mut self,
            request: impl tonic::IntoRequest<super::CancelJobRequest>,
        ) -> Result<tonic::Response<super::JobCancelResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns information about a specific job. Job information is available for"]
        #[doc = " a six month period after creation. Requires that you're the person who ran"]
        #[doc = " the job, or have the Is Owner project role."]
        ...
        #[doc = " Starts a new asynchronous job."]
        #[doc = ""]
        #[doc = " This API has two different kinds of endpoint URIs, as this method supports"]
        #[doc = " a variety of use cases."]
        #[doc = ""]
        #[doc = " * The *Metadata* URI is used for most interactions, as it accepts the job"]
        #[doc = "   configuration directly."]
        #[doc = " * The *Upload* URI is ONLY for the case when you're sending both a load job"]
        #[doc = "   configuration and a data stream together.  In this case, the Upload URI"]
        #[doc = "   accepts the job configuration and the data as two distinct multipart MIME"]
        #[doc = "   parts."]
        ...
        #[doc = " Requests the deletion of the metadata of a job. This call returns when the"]
        #[doc = " job's metadata is deleted."]
        ...
        #[doc = " Lists all jobs that you started in the specified project. Job information"]
        #[doc = " is available for a six month period after creation. The job list is sorted"]
        #[doc = " in reverse chronological order, by job creation time. Requires the Can View"]
        #[doc = " project role, or the Is Owner project role if you set the allUsers"]
        #[doc = " property."]
        pub async fn list_jobs(
            &mut self,
            request: impl tonic::IntoRequest<super::ListJobsRequest>,
        ) -> Result<tonic::Response<super::JobList>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " RPC to get the results of a query job."]
        pub async fn get_query_results(
            &mut self,
            request: impl tonic::IntoRequest<super::GetQueryResultsRequest>,
        ) -> Result<tonic::Response<super::GetQueryResultsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Runs a BigQuery SQL query synchronously and returns query results if the"]
        #[doc = " query completes within a specified timeout."]
        pub async fn query(
            &mut self,
...
pub mod project_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " RPC to get the service account for a project used for interactions with"]
        #[doc = " Google Cloud KMS"]
        pub async fn get_service_account(
            &mut self,
            request: impl tonic::IntoRequest<super::GetServiceAccountRequest>,
        ) -> Result<tonic::Response<super::GetServiceAccountResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod routine_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> Result<tonic::Response<super::Routine>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Patches information in an existing routine. The patch method does a partial"]
        #[doc = " update to an existing Routine resource."]
        ...
        ) -> Result<tonic::Response<super::ListRoutinesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod row_access_policy_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for interacting with row access policies."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> Result<tonic::Response<super::ListRowAccessPoliciesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod table_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets the specified table resource by table ID."]
        #[doc = " This method does not return the data in the table, it only returns the"]
        #[doc = " table resource, which describes the structure of this table."]
        ...
        #[doc = " Updates information in an existing table. The update method replaces the"]
        #[doc = " entire table resource, whereas the patch method only replaces fields that"]
        #[doc = " are provided in the submitted table resource."]
        #[doc = " This method supports RFC5789 patch semantics."]
        ...
        #[doc = " Deletes the table specified by tableId from the dataset."]
        #[doc = " If the table contains data, all the data will be deleted."]
        ...
        #[doc = " Lists all tables in the specified dataset. Requires the READER dataset"]
        #[doc = " role."]
        pub async fn list_tables(
            &mut self,
            request: impl tonic::IntoRequest<super::ListTablesRequest>,
        ) -> Result<tonic::Response<super::TableList>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
