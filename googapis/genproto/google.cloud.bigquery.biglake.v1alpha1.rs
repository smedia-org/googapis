...
pub mod metastore_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " BigLake Metastore is a serverless, highly available, multi-tenant runtime"]
    #[doc = " metastore for Google Cloud Data Analytics products."]
    #[doc = ""]
    #[doc = " The BigLake Metastore API defines the following resource model:"]
    #[doc = ""]
    #[doc = " * A collection of Google Cloud projects: `/projects/*`"]
    #[doc = " * Each project has a collection of available locations: `/locations/*`"]
    #[doc = " * Each location has a collection of catalogs: `/catalogs/*`"]
    #[doc = " * Each catalog has a collection of databases: `/databases/*`"]
    #[doc = " * Each database has a collection of tables: `/tables/*`"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Deletes an existing catalog specified by the catalog ID."]
        ...
        #[doc = " Gets the catalog specified by the resource name."]
        ...
        #[doc = " List all catalogs in a specified project."]
        ...
        #[doc = " Deletes an existing database specified by the database ID."]
        ...
        #[doc = " Updates an existing database specified by the database ID."]
        ...
        #[doc = " Gets the database specified by the resource name."]
        ...
        #[doc = " List all databases in a specified catalog."]
        ...
        #[doc = " Deletes an existing table specified by the table ID."]
        ...
        #[doc = " Updates an existing table specified by the table ID."]
        ...
        #[doc = " Renames an existing table specified by the table ID."]
        ...
        #[doc = " Gets the table specified by the resource name."]
        ...
        #[doc = " List all tables in a specified database."]
        ...
        #[doc = " Deletes an existing lock specified by the lock ID."]
        ...
        #[doc = " Checks the state of a lock specified by the lock ID."]
        ...
        #[doc = " List all locks in a specified database."]
