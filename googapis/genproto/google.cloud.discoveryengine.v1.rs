...
pub mod completion_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Imports all"]
        #[doc = " [SuggestionDenyListEntry][google.cloud.discoveryengine.v1.SuggestionDenyListEntry]"]
        #[doc = " for a DataStore."]
        ...
        #[doc = " Imports"]
        #[doc = " [CompletionSuggestion][google.cloud.discoveryengine.v1.CompletionSuggestion]s"]
        #[doc = " for a DataStore."]
...
pub mod control_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " If the [Control][google.cloud.discoveryengine.v1.Control] to create already"]
        ...
        #[doc = ""]
        #[doc = " If the [Control][google.cloud.discoveryengine.v1.Control] to delete does"]
        #[doc = " not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " [Control][google.cloud.discoveryengine.v1.Control] action type cannot be"]
        #[doc = " changed. If the [Control][google.cloud.discoveryengine.v1.Control] to"]
        #[doc = " update does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = " [DataStore][google.cloud.discoveryengine.v1.DataStore]."]
...
pub mod conversational_search_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " If the [Conversation][google.cloud.discoveryengine.v1.Conversation] to"]
        ...
        #[doc = ""]
        #[doc = " [Conversation][google.cloud.discoveryengine.v1.Conversation] action type"]
        #[doc = " cannot be changed. If the"]
        #[doc = " [Conversation][google.cloud.discoveryengine.v1.Conversation] to update does"]
        #[doc = " not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " If the [Session][google.cloud.discoveryengine.v1.Session] to create already"]
        #[doc = " exists, an ALREADY_EXISTS error is returned."]
        ...
        #[doc = ""]
        #[doc = " If the [Session][google.cloud.discoveryengine.v1.Session] to delete does"]
        #[doc = " not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " [Session][google.cloud.discoveryengine.v1.Session] action type cannot be"]
        #[doc = " changed. If the [Session][google.cloud.discoveryengine.v1.Session] to"]
        #[doc = " update does not exist, a NOT_FOUND error is returned."]
...
pub mod data_store_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing [DataStore][google.cloud.discoveryengine.v1.DataStore]"]
    #[doc = " configuration."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a [DataStore][google.cloud.discoveryengine.v1.DataStore]."]
        #[doc = ""]
        #[doc = " DataStore is for storing"]
        #[doc = " [Documents][google.cloud.discoveryengine.v1.Document]. To serve these"]
        #[doc = " documents for Search, or Recommendation use case, an"]
        #[doc = " [Engine][google.cloud.discoveryengine.v1.Engine] needs to be created"]
        #[doc = " separately."]
        ...
        #[doc = " Gets a [DataStore][google.cloud.discoveryengine.v1.DataStore]."]
        ...
        #[doc = " Lists all the [DataStore][google.cloud.discoveryengine.v1.DataStore]s"]
        ...
        #[doc = " Deletes a [DataStore][google.cloud.discoveryengine.v1.DataStore]."]
        ...
        #[doc = " Updates a [DataStore][google.cloud.discoveryengine.v1.DataStore]"]
...
pub mod document_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for ingesting [Document][google.cloud.discoveryengine.v1.Document]"]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a [Document][google.cloud.discoveryengine.v1.Document]."]
        ...
        #[doc = " Gets a list of [Document][google.cloud.discoveryengine.v1.Document]s."]
        ...
        #[doc = " Creates a [Document][google.cloud.discoveryengine.v1.Document]."]
        ...
        #[doc = " Updates a [Document][google.cloud.discoveryengine.v1.Document]."]
        ...
        #[doc = " Deletes a [Document][google.cloud.discoveryengine.v1.Document]."]
        ...
        #[doc = " [Document][google.cloud.discoveryengine.v1.Document]s. Request processing"]
        #[doc = " may be synchronous. Non-existing items are created."]
        #[doc = ""]
        #[doc = " Note: It is possible for a subset of the"]
        #[doc = " [Document][google.cloud.discoveryengine.v1.Document]s to be successfully"]
        #[doc = " updated."]
        ...
        #[doc = " [Document][google.cloud.discoveryengine.v1.Document]s in a branch."]
        #[doc = ""]
        #[doc = " This process is asynchronous. Depending on the number of"]
        #[doc = " [Document][google.cloud.discoveryengine.v1.Document]s to be deleted, this"]
        #[doc = " operation can take hours to complete. Before the delete operation"]
        #[doc = " completes, some [Document][google.cloud.discoveryengine.v1.Document]s might"]
        #[doc = " still be returned by"]
        #[doc = " [DocumentService.GetDocument][google.cloud.discoveryengine.v1.DocumentService.GetDocument]"]
        #[doc = " or"]
        #[doc = " [DocumentService.ListDocuments][google.cloud.discoveryengine.v1.DocumentService.ListDocuments]."]
        #[doc = ""]
        #[doc = " To get a list of the [Document][google.cloud.discoveryengine.v1.Document]s"]
        #[doc = " to be deleted, set"]
        #[doc = " [PurgeDocumentsRequest.force][google.cloud.discoveryengine.v1.PurgeDocumentsRequest.force]"]
        #[doc = " to false."]
...
pub mod engine_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing [Engine][google.cloud.discoveryengine.v1.Engine]"]
    #[doc = " configuration."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a [Engine][google.cloud.discoveryengine.v1.Engine]."]
        ...
        #[doc = " Deletes a [Engine][google.cloud.discoveryengine.v1.Engine]."]
        ...
        #[doc = " Updates an [Engine][google.cloud.discoveryengine.v1.Engine]"]
        ...
        #[doc = " Gets a [Engine][google.cloud.discoveryengine.v1.Engine]."]
        ...
        #[doc = " Lists all the [Engine][google.cloud.discoveryengine.v1.Engine]s associated"]
...
pub mod project_service_client {
    ...
    #[doc = " [Project][google.cloud.discoveryengine.v1.Project]."]
    #[derive(Debug, Clone)]
...
pub mod schema_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing [Schema][google.cloud.discoveryengine.v1.Schema]s."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a [Schema][google.cloud.discoveryengine.v1.Schema]."]
        ...
        #[doc = " Gets a list of [Schema][google.cloud.discoveryengine.v1.Schema]s."]
        ...
        #[doc = " Creates a [Schema][google.cloud.discoveryengine.v1.Schema]."]
        ...
        #[doc = " Updates a [Schema][google.cloud.discoveryengine.v1.Schema]."]
        ...
        #[doc = " Deletes a [Schema][google.cloud.discoveryengine.v1.Schema]."]
...
pub mod site_search_engine_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets the"]
        #[doc = " [SiteSearchEngine][google.cloud.discoveryengine.v1.SiteSearchEngine]."]
        ...
        #[doc = " Creates a [TargetSite][google.cloud.discoveryengine.v1.TargetSite]."]
        ...
        #[doc = " Creates [TargetSite][google.cloud.discoveryengine.v1.TargetSite] in a"]
        #[doc = " batch."]
        ...
        #[doc = " Gets a [TargetSite][google.cloud.discoveryengine.v1.TargetSite]."]
        ...
        #[doc = " Updates a [TargetSite][google.cloud.discoveryengine.v1.TargetSite]."]
        ...
        #[doc = " Deletes a [TargetSite][google.cloud.discoveryengine.v1.TargetSite]."]
        ...
        #[doc = " Gets a list of [TargetSite][google.cloud.discoveryengine.v1.TargetSite]s."]
