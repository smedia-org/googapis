...
pub mod key_dashboard_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Provides a cross-region view of all Cloud KMS keys in a given Cloud project."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns cryptographic keys managed by Cloud KMS in a given Cloud project."]
        #[doc = " Note that this data is sourced from snapshots, meaning it may not"]
        #[doc = " completely reflect the actual state of key metadata at call time."]
...
pub mod key_tracking_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Returns information about the resources in an org that are protected by a"]
    #[doc = " given Cloud KMS key via CMEK."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns aggregate information about the resources protected by the given"]
        #[doc = " Cloud KMS [CryptoKey][google.cloud.kms.v1.CryptoKey]. Only resources within"]
        #[doc = " the same Cloud organization as the key will be returned. The project that"]
        #[doc = " holds the key must be part of an organization in order for this call to"]
        #[doc = " succeed."]
        ...
        #[doc = " Returns metadata about the resources protected by the given Cloud KMS"]
        #[doc = " [CryptoKey][google.cloud.kms.v1.CryptoKey] in the given Cloud organization."]
        pub async fn search_protected_resources(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchProtectedResourcesRequest>,
        ) -> Result<tonic::Response<super::SearchProtectedResourcesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
