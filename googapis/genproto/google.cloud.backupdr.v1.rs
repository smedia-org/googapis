...
pub mod backup_dr_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists ManagementServers in a given project and location."]
        pub async fn list_management_servers(
            &mut self,
            request: impl tonic::IntoRequest<super::ListManagementServersRequest>,
        ) -> Result<tonic::Response<super::ListManagementServersResponse>, tonic::Status> {
        ...
        #[doc = " Gets details of a single ManagementServer."]
        pub async fn get_management_server(
            &mut self,
            request: impl tonic::IntoRequest<super::GetManagementServerRequest>,
        ) -> Result<tonic::Response<super::ManagementServer>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new ManagementServer in a given project and location."]
        ...
        #[doc = " Deletes a single ManagementServer."]
