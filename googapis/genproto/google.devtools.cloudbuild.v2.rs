...
pub mod repository_manager_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates a single connection."]
        ...
        #[doc = " Creates multiple repositories inside a connection."]
        ...
        #[doc = " Gets details of a single repository."]
        ...
        #[doc = " Lists Repositories in a given connection."]
        ...
        #[doc = " Fetches read/write token of a given repository."]
        ...
        #[doc = " Fetches read token of a given repository."]
        ...
        #[doc = " FetchLinkableRepositories get repositories from SCM that are"]
        #[doc = " accessible and could be added to the connection."]
        pub async fn fetch_linkable_repositories(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchLinkableRepositoriesRequest>,
        ) -> Result<tonic::Response<super::FetchLinkableRepositoriesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
