...
pub mod delivery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " but it must contain all of the `VehicleJourneySegment`s to be persisted on"]
        ...
        #[doc = " Creates and returns a batch of new `Task` objects."]
        ...
        #[doc = " Returns the specified `TaskTrackingInfo` instance."]
