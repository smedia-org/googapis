...
pub mod hub_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists the Network Connectivity Center hubs associated with a given project."]
        ...
        #[doc = " Gets details about a Network Connectivity Center hub."]
        ...
        #[doc = " Creates a new Network Connectivity Center hub in the specified project."]
        ...
        #[doc = " Updates the description and/or labels of a Network Connectivity Center"]
        #[doc = " hub."]
        ...
        #[doc = " Deletes a Network Connectivity Center hub."]
        ...
        #[doc = " Lists the Network Connectivity Center spokes associated with a"]
        #[doc = " specified hub and location. The list includes both spokes that are attached"]
        #[doc = " to the hub and spokes that have been proposed but not yet accepted."]
        pub async fn list_hub_spokes(
            &mut self,
            request: impl tonic::IntoRequest<super::ListHubSpokesRequest>,
        ) -> Result<tonic::Response<super::ListHubSpokesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the Network Connectivity Center spokes in a specified project and"]
        #[doc = " location."]
        ...
        #[doc = " Gets details about a Network Connectivity Center spoke."]
        ...
        #[doc = " Creates a Network Connectivity Center spoke."]
        ...
        #[doc = " Updates the parameters of a Network Connectivity Center spoke."]
        ...
        #[doc = " Rejects a Network Connectivity Center spoke from being attached to a hub."]
        #[doc = " If the spoke was previously in the `ACTIVE` state, it"]
        #[doc = " transitions to the `INACTIVE` state and is no longer able to"]
        #[doc = " connect to other spokes that are attached to the hub."]
        ...
        #[doc = " Accepts a proposal to attach a Network Connectivity Center spoke"]
        #[doc = " to a hub."]
        ...
        #[doc = " Deletes a Network Connectivity Center spoke."]
        ...
        #[doc = " Gets details about a Network Connectivity Center route table."]
        ...
        #[doc = " Gets details about the specified route."]
        ...
        #[doc = " Lists routes in a given project."]
        ...
        #[doc = " Lists route tables in a given project."]
        pub async fn list_route_tables(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRouteTablesRequest>,
        ) -> Result<tonic::Response<super::ListRouteTablesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details about a Network Connectivity Center group."]
        ...
        #[doc = " Lists groups in a given hub."]
...
pub mod policy_based_routing_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Policy-Based Routing allows GCP customers to specify flexibile routing"]
    #[doc = " policies for Layer 4 traffic traversing through the connected service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists PolicyBasedRoutes in a given project and location."]
        pub async fn list_policy_based_routes(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPolicyBasedRoutesRequest>,
        ) -> Result<tonic::Response<super::ListPolicyBasedRoutesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single PolicyBasedRoute."]
        ...
        #[doc = " Creates a new PolicyBasedRoute in a given project and location."]
        ...
        #[doc = " Deletes a single PolicyBasedRoute."]
