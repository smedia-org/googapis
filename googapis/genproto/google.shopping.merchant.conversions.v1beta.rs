...
pub mod conversion_sources_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for managing conversion sources for a merchant account."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates information of an existing conversion source. Available only for"]
        #[doc = " Merchant Center Destination conversion sources."]
        ...
        #[doc = " Archives an existing conversion source. If the conversion source is a"]
        #[doc = " Merchant Center Destination, it will be recoverable for 30 days. If the"]
        #[doc = " conversion source is a Google Analytics Link, it will be deleted"]
        #[doc = " immediately and can be restored by creating a new one."]
        ...
        #[doc = " Re-enables an archived conversion source. Only Available for Merchant"]
        #[doc = " Center Destination conversion sources."]
        ...
        #[doc = " Fetches a conversion source."]
        ...
        #[doc = " Retrieves the list of conversion sources the caller has access to."]
        pub async fn list_conversion_sources(
            &mut self,
            request: impl tonic::IntoRequest<super::ListConversionSourcesRequest>,
        ) -> Result<tonic::Response<super::ListConversionSourcesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
