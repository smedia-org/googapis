...
pub mod r#type {
    ...
    pub mod string {
        ...
        pub struct Encoding {
            /// Which encoding to use.
            #[prost(oneof = "encoding::Encoding", tags = "2")]
            pub encoding: ::core::option::Option<encoding::Encoding>,
        }
        /// Nested message and enum types in `Encoding`.
        pub mod encoding {
...
pub mod bigtable_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " NOTE: This API is intended to be used by Apache Beam BigtableIO."]
        #[doc = " Returns the current list of partitions that make up the table's"]
        #[doc = " change stream. The union of partitions will cover the entire keyspace."]
        #[doc = " Partitions can be read with `ReadChangeStream`."]
        ...
        #[doc = " NOTE: This API is intended to be used by Apache Beam BigtableIO."]
        #[doc = " Reads changes from a table's change stream. Changes will"]
        #[doc = " reflect both user-initiated mutations and mutations that are caused by"]
        ...
        #[doc = " Executes a BTQL query against a particular Cloud Bigtable instance."]
