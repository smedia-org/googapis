...
pub mod lineage_client {
    ...
    use tonic::codegen::*;
    #[doc = " Lineage is used to track data flows between assets over time. You can"]
    #[doc = " create [LineageEvents][google.cloud.datacatalog.lineage.v1.LineageEvent]"]
    #[doc = " to record lineage between multiple sources and a single target, for"]
    #[doc = " example, when table data is based on data from multiple tables."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates new lineage events together with their parents: process and run."]
        #[doc = " Updates the process and run if they already exist."]
        #[doc = " Mapped from Open Lineage specification:"]
        #[doc = " https://github.com/OpenLineage/OpenLineage/blob/main/spec/OpenLineage.json."]
        pub async fn process_open_lineage_run_event(
            &mut self,
            request: impl tonic::IntoRequest<super::ProcessOpenLineageRunEventRequest>,
        ) -> Result<tonic::Response<super::ProcessOpenLineageRunEventResponse>, tonic::Status>
        {
        ...
        #[doc = " Gets the details of the specified process."]
        ...
        #[doc = " List processes in the given project and location. List order is descending"]
        #[doc = " by insertion time."]
        ...
        #[doc = " Deletes the process with the specified name."]
        ...
        #[doc = " Gets the details of the specified run."]
        ...
        #[doc = " Lists runs in the given project and location. List order is descending by"]
        #[doc = " `start_time`."]
        ...
        #[doc = " Deletes the run with the specified name."]
        ...
        #[doc = " Creates a new lineage event."]
        ...
        #[doc = " Gets details of a specified lineage event."]
        ...
        #[doc = " Lists lineage events in the given project and location. The list order is"]
        #[doc = " not defined."]
        ...
        #[doc = " Deletes the lineage event with the specified name."]
        ...
        #[doc = " Retrieve a list of links connected to a specific asset."]
        #[doc = " Links represent the data flow between **source** (upstream)"]
        #[doc = " and **target** (downstream) assets in transformation pipelines."]
        #[doc = " Links are stored in the same project as the Lineage Events that create"]
        #[doc = " them."]
        #[doc = ""]
        #[doc = " You can retrieve links in every project where you have the"]
        #[doc = " `datalineage.events.get` permission. The project provided in the URL"]
        #[doc = " is used for Billing and Quota."]
        ...
        #[doc = " Retrieve information about LineageProcesses associated with specific"]
        #[doc = " links. LineageProcesses are transformation pipelines that result in data"]
        #[doc = " flowing from **source** to **target** assets. Links between assets"]
        #[doc = " represent this operation."]
        #[doc = ""]
        #[doc = " If you have specific link names, you can use this method to"]
        #[doc = " verify which LineageProcesses contribute to creating those links."]
        #[doc = " See the"]
        #[doc = " [SearchLinks][google.cloud.datacatalog.lineage.v1.Lineage.SearchLinks]"]
        #[doc = " method for more information on how to retrieve link name."]
        #[doc = ""]
        #[doc = " You can retrieve the LineageProcess information in every project where you"]
        #[doc = " have the `datalineage.events.get` permission. The project provided in the"]
        #[doc = " URL is used for Billing and Quota."]
        pub async fn batch_search_link_processes(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchSearchLinkProcessesRequest>,
        ) -> Result<tonic::Response<super::BatchSearchLinkProcessesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
