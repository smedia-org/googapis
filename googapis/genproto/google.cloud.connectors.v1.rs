...
pub mod connectors_client {
    ...
    use tonic::codegen::*;
    #[doc = " Connectors is the interface for managing Connectors."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets details of a provider."]
        ...
        ) -> Result<tonic::Response<super::ListConnectorVersionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets schema metadata of a connection."]
        #[doc = " SchemaMetadata is a singleton resource for each connection."]
        ...
        #[doc = " Refresh runtime schema of a connection."]
        ...
        ) -> Result<tonic::Response<super::ListRuntimeEntitySchemasResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> Result<tonic::Response<super::ListRuntimeActionSchemasResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Gets the runtimeConfig of a location."]
        #[doc = " RuntimeConfig is a singleton resource for each location."]
        ...
        #[doc = " GetGlobalSettings gets settings of a project."]
        #[doc = " GlobalSettings is a singleton resource."]
