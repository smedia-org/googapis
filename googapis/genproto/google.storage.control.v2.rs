...
pub mod storage_control_client {
    ...
    use tonic::codegen::*;
    #[doc = " StorageControl service includes selected control plane operations."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a new folder. This operation is only applicable to a hierarchical"]
        #[doc = " namespace enabled bucket."]
        ...
        #[doc = " Permanently deletes an empty folder. This operation is only applicable to a"]
        #[doc = " hierarchical namespace enabled bucket."]
        ...
        #[doc = " Returns metadata for the specified folder. This operation is only"]
        #[doc = " applicable to a hierarchical namespace enabled bucket."]
        ...
        #[doc = " Retrieves a list of folders. This operation is only applicable to a"]
        #[doc = " hierarchical namespace enabled bucket."]
        ...
        #[doc = " Renames a source folder to a destination folder. This operation is only"]
        #[doc = " applicable to a hierarchical namespace enabled bucket. During a rename, the"]
        #[doc = " source and destination folders are locked until the long running operation"]
        #[doc = " completes."]
        ...
        #[doc = " Returns the storage layout configuration for a given bucket."]
        pub async fn get_storage_layout(
            &mut self,
            request: impl tonic::IntoRequest<super::GetStorageLayoutRequest>,
        ) -> Result<tonic::Response<super::StorageLayout>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Permanently deletes an empty managed folder."]
        ...
        #[doc = " Returns metadata for the specified managed folder."]
        ...
        #[doc = " Retrieves a list of managed folders for a given bucket."]
        pub async fn list_managed_folders(
            &mut self,
            request: impl tonic::IntoRequest<super::ListManagedFoldersRequest>,
        ) -> Result<tonic::Response<super::ListManagedFoldersResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
