...
pub mod data_catalog_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " within one enum field. Thus, an enum value cannot be renamed with a name"]
        #[doc = " used in any other enum value within the same enum field."]
        ...
        #[doc = " Lists tags assigned to an [Entry][google.cloud.datacatalog.v1beta1.Entry]."]
        #[doc = " The [columns][google.cloud.datacatalog.v1beta1.Tag.column] in the response"]
        #[doc = " are lowercased."]
