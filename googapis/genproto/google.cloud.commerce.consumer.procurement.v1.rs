...
pub mod consumer_procurement_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " ConsumerProcurementService allows customers to make purchases of products"]
    #[doc = " served by the Cloud Commerce platform."]
    #[doc = ""]
    #[doc = ""]
    #[doc = " When purchases are made, the"]
    #[doc = " [ConsumerProcurementService][google.cloud.commerce.consumer.procurement.v1.ConsumerProcurementService]"]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        {
            ConsumerProcurementServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        #[doc = " Creates a new [Order][google.cloud.commerce.consumer.procurement.v1.Order]."]
        #[doc = ""]
        ...
        #[doc = " in"]
        #[doc = " [OrderState.ORDER_STATE_ACTIVE][google.cloud.commerce.consumer.procurement.v1.OrderState.ORDER_STATE_ACTIVE]."]
        ...
        > {
            ...
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.commerce.consumer.procurement.v1.ConsumerProcurementService/PlaceOrder") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Returns the requested"]
        #[doc = " [Order][google.cloud.commerce.consumer.procurement.v1.Order] resource."]
        pub async fn get_order(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.commerce.consumer.procurement.v1.ConsumerProcurementService/GetOrder") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Lists [Order][google.cloud.commerce.consumer.procurement.v1.Order]"]
        ...
        pub async fn list_orders(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.commerce.consumer.procurement.v1.ConsumerProcurementService/ListOrders") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
