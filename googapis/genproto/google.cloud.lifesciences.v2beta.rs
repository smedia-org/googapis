...
pub mod workflows_service_v2_beta_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [google.cloud.lifesciences.v2beta.Metadata][google.cloud.lifesciences.v2beta.Metadata]"]
        #[doc = " object describing the status of the pipeline execution. The"]
        #[doc = " [response][google.longrunning.Operation.response] field will contain a"]
        #[doc = " [google.cloud.lifesciences.v2beta.RunPipelineResponse][google.cloud.lifesciences.v2beta.RunPipelineResponse]"]
        #[doc = " object if the pipeline completes successfully."]
        #[doc = ""]
