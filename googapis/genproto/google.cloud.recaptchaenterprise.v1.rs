...
pub mod recaptcha_enterprise_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " authenticated as one of the current owners of the reCAPTCHA Key, and"]
        ...
        #[doc = " Creates a new FirewallPolicy, specifying conditions at which reCAPTCHA"]
        #[doc = " Enterprise actions can be executed."]
        #[doc = " A project may have a maximum of 1000 policies."]
        ...
        #[doc = " Returns the list of all firewall policies that belong to a project."]
        pub async fn list_firewall_policies(
            &mut self,
            request: impl tonic::IntoRequest<super::ListFirewallPoliciesRequest>,
        ) -> Result<tonic::Response<super::ListFirewallPoliciesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the specified firewall policy."]
        ...
        #[doc = " Reorders all firewall policies."]
        pub async fn reorder_firewall_policies(
            &mut self,
            request: impl tonic::IntoRequest<super::ReorderFirewallPoliciesRequest>,
        ) -> Result<tonic::Response<super::ReorderFirewallPoliciesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
