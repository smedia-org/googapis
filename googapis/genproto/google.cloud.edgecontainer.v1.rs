...
pub mod edge_container_client {
    ...
    use tonic::codegen::*;
    #[doc = " EdgeContainer API provides management of Kubernetes Clusters on Google Edge"]
    #[doc = " Cloud deployments."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Generates an access token for a Cluster."]
        ...
        #[doc = " Generates an offline credential for a Cluster."]
        pub async fn generate_offline_credential(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateOfflineCredentialRequest>,
        ) -> Result<tonic::Response<super::GenerateOfflineCredentialResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists NodePools in a given project and location."]
        ...
        #[doc = " Gets details of a single NodePool."]
        ...
        #[doc = " Creates a new NodePool in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single NodePool."]
        ...
        #[doc = " Lists Machines in a given project and location."]
        ...
        #[doc = " Gets details of a single Machine."]
        ...
        #[doc = " Lists VPN connections in a given project and location."]
        ...
        #[doc = " Gets details of a single VPN connection."]
        ...
        #[doc = " Creates a new VPN connection in a given project and location."]
        ...
        #[doc = " Deletes a single VPN connection."]
