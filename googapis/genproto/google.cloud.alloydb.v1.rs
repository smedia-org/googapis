...
pub mod alloy_db_admin_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Promotes a SECONDARY cluster. This turns down replication"]
        #[doc = " from the PRIMARY cluster and promotes a secondary cluster"]
        #[doc = " into its own standalone cluster."]
        #[doc = " Imperative only."]
        ...
        #[doc = " Creates a new Cluster in a given project and location, with a volume"]
        #[doc = " restored from the provided source, either a backup ID or a point-in-time"]
        #[doc = " and a source cluster."]
        ...
        #[doc = " Creates a cluster of type SECONDARY in the given location using"]
        #[doc = " the primary cluster as the source."]
        ...
        #[doc = " Creates a new SECONDARY Instance in a given project and location."]
        ...
        #[doc = " Creates new instances under the given project, location and cluster."]
        #[doc = " There can be only one primary instance in a cluster. If the primary"]
        #[doc = " instance exists in the cluster as well as this request, then API will"]
        #[doc = " throw an error."]
        #[doc = " The primary instance should exist before any read pool instance is"]
        #[doc = " created. If the primary instance is a part of the request payload, then"]
        #[doc = " the API will take care of creating instances in the correct order."]
        #[doc = " This method is here to support Google-internal use cases, and is not meant"]
        #[doc = " for external customers to consume. Please do not start relying on it; its"]
        #[doc = " behavior is subject to change without notice."]
        ...
        #[doc = " Updates the parameters of a single Instance."]
        ...
        #[doc = " Forces a Failover for a highly available instance."]
        #[doc = " Failover promotes the HA standby instance as the new primary."]
        #[doc = " Imperative only."]
        ...
        #[doc = " Injects fault in an instance."]
        #[doc = " Imperative only."]
        ...
        #[doc = " Restart an Instance in a cluster."]
        #[doc = " Imperative only."]
        ...
        #[doc = " Lists Backups in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Backup."]
        ...
        #[doc = " Lists SupportedDatabaseFlags for a given project and location."]
        pub async fn list_supported_database_flags(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSupportedDatabaseFlagsRequest>,
        ) -> Result<tonic::Response<super::ListSupportedDatabaseFlagsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists Users in a given project and location."]
        ...
        #[doc = " Gets details of a single User."]
        ...
        #[doc = " Creates a new User in a given project, location, and cluster."]
        ...
        #[doc = " Updates the parameters of a single User."]
