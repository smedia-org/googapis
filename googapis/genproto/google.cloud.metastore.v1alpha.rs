...
pub mod dataproc_metastore_federation_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Configures and manages metastore federation services."]
    #[doc = " Dataproc Metastore Federation Service allows federating a collection of"]
    #[doc = " backend metastores like BigQuery, Dataplex Lakes, and other Dataproc"]
    #[doc = " Metastores. The Federation Service exposes a gRPC URL through which metadata"]
    #[doc = " from the backend metastores are served at query time."]
    #[doc = ""]
    #[doc = " The Dataproc Metastore Federation API defines the following resource model:"]
    #[doc = " * The service works with a collection of Google Cloud projects."]
    #[doc = " * Each project has a collection of available locations."]
    #[doc = " * Each location has a collection of federations."]
    #[doc = " * Dataproc Metastore Federations are resources with names of the"]
    #[doc = " form:"]
    #[doc = " `projects/{project_number}/locations/{location_id}/federations/{federation_id}`."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists federations in a project and location."]
        ...
        #[doc = " Gets the details of a single federation."]
        ...
        #[doc = " Creates a metastore federation in a project and location."]
        ...
        #[doc = " Updates the fields of a federation."]
        ...
        #[doc = " Deletes a single federation."]
