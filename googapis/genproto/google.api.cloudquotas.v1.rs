...
pub mod cloud_quotas_client {
    ...
    use tonic::codegen::*;
    #[doc = " The Cloud Quotas API is an infrastructure service for Google Cloud that lets"]
    #[doc = " service consumers list and manage their resource usage limits."]
    #[doc = ""]
    #[doc = " - List/Get the metadata and current status of the quotas for a service."]
    #[doc = " - Create/Update quota preferencess that declare the preferred quota values."]
    #[doc = " - Check the status of a quota preference request."]
    #[doc = " - List/Get pending and historical quota preference."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists QuotaInfos of all quotas for a given project, folder or organization."]
        pub async fn list_quota_infos(
            &mut self,
            request: impl tonic::IntoRequest<super::ListQuotaInfosRequest>,
        ) -> Result<tonic::Response<super::ListQuotaInfosResponse>, tonic::Status> {
        ...
        #[doc = " Retrieve the QuotaInfo of a quota for a project, folder or organization."]
        pub async fn get_quota_info(
            &mut self,
            request: impl tonic::IntoRequest<super::GetQuotaInfoRequest>,
        ) -> Result<tonic::Response<super::QuotaInfo>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists QuotaPreferences in a given project, folder or organization."]
        pub async fn list_quota_preferences(
            &mut self,
            request: impl tonic::IntoRequest<super::ListQuotaPreferencesRequest>,
        ) -> Result<tonic::Response<super::ListQuotaPreferencesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single QuotaPreference."]
        pub async fn get_quota_preference(
            &mut self,
            request: impl tonic::IntoRequest<super::GetQuotaPreferenceRequest>,
        ) -> Result<tonic::Response<super::QuotaPreference>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new QuotaPreference that declares the desired value for a quota."]
        ...
        #[doc = " Updates the parameters of a single QuotaPreference. It can updates the"]
        #[doc = " config in any states, not just the ones pending approval."]
