...
pub mod data_policy_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Data Policy Service provides APIs for managing the label-policy bindings."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a new data policy under a project with the given `dataPolicyId`"]
        #[doc = " (used as the display name), policy tag, and data policy type."]
        ...
        #[doc = " Updates the metadata for an existing data policy. The target data policy"]
        #[doc = " can be specified by the resource name."]
        ...
        #[doc = " Renames the id (display name) of the specified data policy."]
        ...
        #[doc = " Deletes the data policy specified by its resource name."]
        ...
        #[doc = " Gets the data policy specified by its resource name."]
        ...
        #[doc = " List all of the data policies in the specified parent project."]
        ...
        #[doc = " Gets the IAM policy for the specified data policy."]
        ...
        #[doc = " Sets the IAM policy for the specified data policy."]
        ...
        #[doc = " Returns the caller's permission on the specified data policy resource."]
