...
pub mod resource_settings_service_client {
    ...
    #[doc = " (== deprecation_description Resource Settings is deprecated. As of November"]
    #[doc = " 7, 2023, no organizations will be onboarded for any of the enabled settings,"]
    #[doc = " and the service will be shut down on October 1, 2024. ==)"]
    #[derive(Debug, Clone)]
