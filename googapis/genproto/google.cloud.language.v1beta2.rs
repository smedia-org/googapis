...
pub mod language_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Finds entities, similar to"]
        #[doc = " [AnalyzeEntities][google.cloud.language.v1beta2.LanguageService.AnalyzeEntities]"]
        #[doc = " in the text and analyzes sentiment associated with each entity and its"]
        #[doc = " mentions."]
