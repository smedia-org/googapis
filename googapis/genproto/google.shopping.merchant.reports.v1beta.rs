...
pub mod report_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for retrieving reports and insights about your products, their"]
    #[doc = " performance, and their competitive environment on Google."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves a report defined by a search query. The response might contain"]
        #[doc = " fewer rows than specified by `page_size`. Rely on `next_page_token` to"]
        #[doc = " determine if there are more rows to be requested."]
        pub async fn search(
            &mut self,
