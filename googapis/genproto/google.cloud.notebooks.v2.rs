...
pub mod notebook_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " API v2 service for Workbench Notebooks Instances."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " UpdateInstance updates an Instance."]
        ...
        #[doc = " Checks whether a notebook instance is upgradable."]
        pub async fn check_instance_upgradability(
            &mut self,
            request: impl tonic::IntoRequest<super::CheckInstanceUpgradabilityRequest>,
        ) -> Result<tonic::Response<super::CheckInstanceUpgradabilityResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Creates a Diagnostic File and runs Diagnostic Tool given an Instance."]
