...
pub mod spanner_executor_proxy_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service that executes SpannerActions asynchronously."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " ExecuteActionAsync is a streaming call that starts executing a new Spanner"]
        #[doc = " action."]
        #[doc = ""]
        #[doc = " For each request, the server will reply with one or more responses, but"]
        #[doc = " only the last response will contain status in the outcome."]
        #[doc = ""]
        #[doc = " Responses can be matched to requests by action_id. It is allowed to have"]
        #[doc = " multiple actions in flight--in that case, actions are be executed in"]
        #[doc = " parallel."]
