...
pub mod speech_client {
    ...
    use tonic::codegen::*;
    #[doc = " Enables speech transcription and resource management."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a [Recognizer][google.cloud.speech.v2.Recognizer]."]
        ...
        #[doc = " [Recognizer][google.cloud.speech.v2.Recognizer]. Fails with"]
        #[doc = " [NOT_FOUND][google.rpc.Code.NOT_FOUND] if the requested recognizer doesn't"]
        #[doc = " exist."]
        ...
        #[doc = " Updates the [Recognizer][google.cloud.speech.v2.Recognizer]."]
        ...
        #[doc = " Deletes the [Recognizer][google.cloud.speech.v2.Recognizer]."]
        ...
        #[doc = " Undeletes the [Recognizer][google.cloud.speech.v2.Recognizer]."]
        ...
        #[doc = " Performs batch asynchronous speech recognition: send a request with N"]
        #[doc = " audio files and receive a long running operation that can be polled to see"]
        #[doc = " when the transcriptions are finished."]
        ...
        #[doc = " Returns the requested [Config][google.cloud.speech.v2.Config]."]
        ...
        #[doc = " Updates the [Config][google.cloud.speech.v2.Config]."]
        ...
        #[doc = " Creates a [CustomClass][google.cloud.speech.v2.CustomClass]."]
        ...
        #[doc = " Returns the requested"]
        #[doc = " [CustomClass][google.cloud.speech.v2.CustomClass]."]
        ...
        #[doc = " Updates the [CustomClass][google.cloud.speech.v2.CustomClass]."]
        ...
        #[doc = " Deletes the [CustomClass][google.cloud.speech.v2.CustomClass]."]
        ...
        #[doc = " Undeletes the [CustomClass][google.cloud.speech.v2.CustomClass]."]
        ...
        #[doc = " Creates a [PhraseSet][google.cloud.speech.v2.PhraseSet]."]
        ...
        #[doc = " Returns the requested"]
        #[doc = " [PhraseSet][google.cloud.speech.v2.PhraseSet]."]
        ...
        #[doc = " Updates the [PhraseSet][google.cloud.speech.v2.PhraseSet]."]
        ...
        #[doc = " Deletes the [PhraseSet][google.cloud.speech.v2.PhraseSet]."]
        ...
        #[doc = " Undeletes the [PhraseSet][google.cloud.speech.v2.PhraseSet]."]
