...
pub mod analytics_hub_service_client {
    ...
    #[doc = " organizations. It allows data providers to publish listings that reference"]
    #[doc = " shared datasets. With Analytics Hub, users can discover and search for"]
    #[doc = " listings that they have access to. Subscribers can view and subscribe to"]
    #[doc = " listings. When you subscribe to a listing, Analytics Hub creates a linked"]
    #[doc = " dataset in your project."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all data exchanges in a given project and location."]
        ...
        #[doc = " Lists all data exchanges from projects in a given organization and"]
        #[doc = " location."]
        ...
        #[doc = " Gets the details of a data exchange."]
        ...
        #[doc = " Creates a new data exchange."]
        ...
        #[doc = " Updates an existing data exchange."]
        ...
        #[doc = " Deletes an existing data exchange."]
        ...
        #[doc = " Lists all listings in a given project and location."]
        ...
        #[doc = " Gets the details of a listing."]
        ...
        #[doc = " Updates an existing listing."]
        ...
        #[doc = " Subscribes to a listing."]
        #[doc = ""]
        #[doc = " Currently, with Analytics Hub, you can create listings that"]
        #[doc = " reference only BigQuery datasets."]
        #[doc = " Upon subscription to a listing for a BigQuery dataset, Analytics Hub"]
        ...
        #[doc = " Creates a Subscription to a Data Exchange. This is a long-running operation"]
        #[doc = " as it will create one or more linked datasets."]
        ...
        #[doc = " Refreshes a Subscription to a Data Exchange. A Data Exchange can become"]
        #[doc = " stale when a publisher adds or removes data. This is a long-running"]
        #[doc = " operation as it may create many linked datasets."]
        ...
        #[doc = " Gets the details of a Subscription."]
        ...
        #[doc = " Lists all subscriptions in a given project and location."]
        ...
        #[doc = " Lists all subscriptions on a given Data Exchange or Listing."]
        ...
        ) -> Result<tonic::Response<super::ListSharedResourceSubscriptionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Revokes a given subscription."]
        pub async fn revoke_subscription(
            &mut self,
            request: impl tonic::IntoRequest<super::RevokeSubscriptionRequest>,
        ) -> Result<tonic::Response<super::RevokeSubscriptionResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the permissions that a caller has."]
