...
pub mod discuss_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " An API for using Generative Language Models (GLMs) in dialog applications."]
    #[doc = ""]
    #[doc = " Also known as large language models (LLMs), this API provides models that"]
    #[doc = " are trained for multi-turn dialog."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Generates a response from the model given an input `MessagePrompt`."]
        pub async fn generate_message(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateMessageRequest>,
        ) -> Result<tonic::Response<super::GenerateMessageResponse>, tonic::Status> {
        ...
        #[doc = " Runs a model's tokenizer on a string and returns the token count."]
        pub async fn count_message_tokens(
            &mut self,
            request: impl tonic::IntoRequest<super::CountMessageTokensRequest>,
        ) -> Result<tonic::Response<super::CountMessageTokensResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod model_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets information about a specific TunedModel."]
        pub async fn get_tuned_model(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTunedModelRequest>,
        ) -> Result<tonic::Response<super::TunedModel>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists tuned models owned by the user."]
        pub async fn list_tuned_models(
            &mut self,
            request: impl tonic::IntoRequest<super::ListTunedModelsRequest>,
        ) -> Result<tonic::Response<super::ListTunedModelsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a tuned model."]
        #[doc = " Intermediate tuning progress (if any) is accessed through the"]
        #[doc = " [google.longrunning.Operations] service."]
        #[doc = ""]
        #[doc = " Status and results can be accessed through the Operations service."]
        #[doc = " Example:"]
        #[doc = "   GET /v1/tunedModels/az2mb0bpw6i/operations/000-111-222"]
...
pub mod permission_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Provides methods for managing permissions to PaLM API resources."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Create a permission to a specific resource."]
        pub async fn create_permission(
            &mut self,
            request: impl tonic::IntoRequest<super::CreatePermissionRequest>,
        ) -> Result<tonic::Response<super::Permission>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets information about a specific Permission."]
        ...
        #[doc = " Lists permissions for the specific resource."]
        ...
        #[doc = " Transfers ownership of the tuned model."]
        #[doc = " This is the only way to change ownership of the tuned model."]
        #[doc = " The current owner will be downgraded to writer role."]
        pub async fn transfer_ownership(
            &mut self,
            request: impl tonic::IntoRequest<super::TransferOwnershipRequest>,
        ) -> Result<tonic::Response<super::TransferOwnershipResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod text_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " API for using Generative Language Models (GLMs) trained to generate text."]
    #[doc = ""]
    #[doc = " Also known as Large Language Models (LLM)s, these generate text given an"]
    #[doc = " input prompt from the user."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Generates a response from the model given an input message."]
        pub async fn generate_text(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateTextRequest>,
        ) -> Result<tonic::Response<super::GenerateTextResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Generates an embedding from the model given an input message."]
        pub async fn embed_text(
            &mut self,
            request: impl tonic::IntoRequest<super::EmbedTextRequest>,
        ) -> Result<tonic::Response<super::EmbedTextResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> Result<tonic::Response<super::BatchEmbedTextResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Runs a model's tokenizer on a text and returns the token count."]
        pub async fn count_text_tokens(
            &mut self,
            request: impl tonic::IntoRequest<super::CountTextTokensRequest>,
        ) -> Result<tonic::Response<super::CountTextTokensResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
