...
pub mod edge_network_client {
    ...
    use tonic::codegen::*;
    #[doc = " EdgeNetwork API provides managed, highly available cloud dynamic network"]
    #[doc = " configuration service to the GEC customer to enable edge application and"]
    #[doc = " network function solutions. This allows the customers to easily define and"]
    #[doc = " configure the network setup and property to meet the workload requirement."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " InitializeZone will initialize resources for a zone in a project."]
        pub async fn initialize_zone(
            &mut self,
            request: impl tonic::IntoRequest<super::InitializeZoneRequest>,
        ) -> Result<tonic::Response<super::InitializeZoneResponse>, tonic::Status> {
        ...
        #[doc = " Lists Zones in a given project and location."]
        ...
        #[doc = " Deprecated: not implemented."]
        #[doc = " Gets details of a single Zone."]
        ...
        #[doc = " Lists Networks in a given project and location."]
        ...
        #[doc = " Gets details of a single Network."]
        ...
        #[doc = " Get the diagnostics of a single network resource."]
        pub async fn diagnose_network(
            &mut self,
            request: impl tonic::IntoRequest<super::DiagnoseNetworkRequest>,
        ) -> Result<tonic::Response<super::DiagnoseNetworkResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new Network in a given project and location."]
        ...
        #[doc = " Lists Subnets in a given project and location."]
        ...
        #[doc = " Creates a new Subnet in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Subnet."]
        ...
        #[doc = " Lists Interconnects in a given project and location."]
        pub async fn list_interconnects(
            &mut self,
            request: impl tonic::IntoRequest<super::ListInterconnectsRequest>,
        ) -> Result<tonic::Response<super::ListInterconnectsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single Interconnect."]
        ...
        #[doc = " Get the diagnostics of a single interconnect resource."]
        pub async fn diagnose_interconnect(
            &mut self,
            request: impl tonic::IntoRequest<super::DiagnoseInterconnectRequest>,
        ) -> Result<tonic::Response<super::DiagnoseInterconnectResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists InterconnectAttachments in a given project and location."]
        pub async fn list_interconnect_attachments(
            &mut self,
            request: impl tonic::IntoRequest<super::ListInterconnectAttachmentsRequest>,
        ) -> Result<tonic::Response<super::ListInterconnectAttachmentsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Gets details of a single InterconnectAttachment."]
        ...
        #[doc = " Creates a new InterconnectAttachment in a given project and location."]
        ...
        #[doc = " Deletes a single InterconnectAttachment."]
        ...
        #[doc = " Lists Routers in a given project and location."]
        pub async fn list_routers(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRoutersRequest>,
        ) -> Result<tonic::Response<super::ListRoutersResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single Router."]
        ...
        #[doc = " Get the diagnostics of a single router resource."]
        pub async fn diagnose_router(
            &mut self,
            request: impl tonic::IntoRequest<super::DiagnoseRouterRequest>,
        ) -> Result<tonic::Response<super::DiagnoseRouterResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new Router in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Router."]
