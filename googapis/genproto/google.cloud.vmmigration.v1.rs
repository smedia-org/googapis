...
pub mod vm_migration_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Upgrades the appliance relate to this DatacenterConnector to the in-place"]
        #[doc = " updateable version."]
        ...
        #[doc = " Lists ReplicationCycles in a given MigratingVM."]
        pub async fn list_replication_cycles(
            &mut self,
            request: impl tonic::IntoRequest<super::ListReplicationCyclesRequest>,
        ) -> Result<tonic::Response<super::ListReplicationCyclesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single ReplicationCycle."]
