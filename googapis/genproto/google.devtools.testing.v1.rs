...
pub mod test_execution_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " The returned matrix will not yet contain the executions that will be"]
        #[doc = " created for this matrix. Execution creation happens later on and will"]
        #[doc = " require a call to GetTestMatrix."]
        #[doc = ""]
        ...
        #[doc = " Checks the status of a test matrix and the executions once they"]
        #[doc = " are created."]
        #[doc = ""]
        #[doc = " The test matrix will contain the list of test executions to run if and only"]
        #[doc = " if the resultStorage.toolResultsExecution fields have been populated."]
        #[doc = ""]
        #[doc = " Note: Flaky test executions may be added to the matrix at a later stage."]
        #[doc = ""]
        #[doc = " May return any of the following canonical error codes:"]
        #[doc = ""]
