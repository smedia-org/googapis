...
pub mod product_inputs_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service to use ProductInput resource."]
    #[doc = " This service works for products with online channel only."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Uploads a product input to your Merchant Center account. If an input"]
        #[doc = " with the same contentLanguage, offerId, and dataSource already exists,"]
        #[doc = " this method replaces that entry."]
        #[doc = ""]
        #[doc = " After inserting, updating, or deleting a product input, it may take several"]
        #[doc = " minutes before the processed product can be retrieved."]
        pub async fn insert_product_input(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertProductInputRequest>,
        ) -> Result<tonic::Response<super::ProductInput>, tonic::Status> {
        ...
        #[doc = " Deletes a product input from your Merchant Center account."]
        #[doc = ""]
        #[doc = " After inserting, updating, or deleting a product input, it may take several"]
        #[doc = " minutes before the processed product can be retrieved."]
...
pub mod products_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to use Product resource."]
    #[doc = " This service works for products with online channel only."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the processed product from your Merchant Center account."]
        #[doc = ""]
        #[doc = " After inserting, updating, or deleting a product input, it may take several"]
        ...
        #[doc = " Lists the processed products in your Merchant Center account. The response"]
        ...
        #[doc = ""]
        #[doc = " After inserting, updating, or deleting a product input, it may take several"]
        #[doc = " minutes before the updated processed product can be retrieved."]
