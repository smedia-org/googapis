...
pub mod bare_metal_solution_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " RenameInstance sets a new name for an instance."]
        #[doc = " Use with caution, previous names become immediately invalidated."]
        ...
        #[doc = " Enable the interactive serial console feature on an instance."]
        ...
        #[doc = " Disable the interactive serial console feature on an instance."]
        ...
        #[doc = " Lists the public SSH keys registered for the specified project."]
        #[doc = " These SSH keys are used only for the interactive serial console feature."]
        pub async fn list_ssh_keys(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSshKeysRequest>,
        ) -> Result<tonic::Response<super::ListSshKeysResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Register a public SSH key in the specified project for use with the"]
        #[doc = " interactive serial console feature."]
        pub async fn create_ssh_key(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateSshKeyRequest>,
        ) -> Result<tonic::Response<super::SshKey>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes a public SSH key registered in the specified project."]
        ...
        #[doc = " RenameVolume sets a new name for a volume."]
        #[doc = " Use with caution, previous names become immediately invalidated."]
        ...
        #[doc = " Skips volume's cooloff and deletes it now."]
        #[doc = " Volume must be in cooloff state."]
        ...
        #[doc = " Takes a snapshot of a boot volume."]
        #[doc = " Returns INVALID_ARGUMENT if called for a non-boot volume."]
        ...
        #[doc = " Uses the specified snapshot to restore its parent volume."]
        #[doc = " Returns INVALID_ARGUMENT if called for a non-boot volume."]
        ...
        #[doc = " Returns the specified snapshot resource."]
        #[doc = " Returns INVALID_ARGUMENT if called for a non-boot volume."]
        ...
        #[doc = " Retrieves the list of snapshots for the specified volume."]
        #[doc = " Returns a response with an empty list of snapshots if called"]
        #[doc = " for a non-boot volume."]
        ...
        #[doc = " Skips lun's cooloff and deletes it now."]
        #[doc = " Lun must be in cooloff state."]
        ...
        #[doc = " RenameNfsShare sets a new name for an nfsshare."]
        #[doc = " Use with caution, previous names become immediately invalidated."]
        ...
        #[doc = " Delete an NFS share. The underlying volume is automatically deleted."]
        ...
        ) -> Result<tonic::Response<super::ListProvisioningQuotasResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> Result<tonic::Response<super::SubmitProvisioningConfigResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Create new ProvisioningConfig."]
        ...
        #[doc = " Update existing ProvisioningConfig."]
        ...
        #[doc = " RenameNetwork sets a new name for a network."]
        #[doc = " Use with caution, previous names become immediately invalidated."]
        ...
        #[doc = " Retrieves the list of OS images which are currently approved."]
        pub async fn list_os_images(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOsImagesRequest>,
        ) -> Result<tonic::Response<super::ListOsImagesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
