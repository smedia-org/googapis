...
pub mod telco_automation_client {
    ...
    use tonic::codegen::*;
    #[doc = " TelcoAutomation Service manages the control plane cluster a.k.a."]
    #[doc = " Orchestration Cluster (GKE cluster with config controller) of TNA. It also"]
    #[doc = " exposes blueprint APIs which manages the lifecycle of blueprints that control"]
    #[doc = " the infrastructure setup (e.g GDCE clusters) and deployment of network"]
    #[doc = " functions."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists OrchestrationClusters in a given project and location."]
        pub async fn list_orchestration_clusters(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOrchestrationClustersRequest>,
        ) -> Result<tonic::Response<super::ListOrchestrationClustersResponse>, tonic::Status>
        {
        ...
        #[doc = " Gets details of a single OrchestrationCluster."]
        pub async fn get_orchestration_cluster(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOrchestrationClusterRequest>,
        ) -> Result<tonic::Response<super::OrchestrationCluster>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new OrchestrationCluster in a given project and location."]
        ...
        #[doc = " Deletes a single OrchestrationCluster."]
        ...
        #[doc = " Lists EdgeSlms in a given project and location."]
        pub async fn list_edge_slms(
            &mut self,
            request: impl tonic::IntoRequest<super::ListEdgeSlmsRequest>,
        ) -> Result<tonic::Response<super::ListEdgeSlmsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets details of a single EdgeSlm."]
        pub async fn get_edge_slm(
            &mut self,
            request: impl tonic::IntoRequest<super::GetEdgeSlmRequest>,
        ) -> Result<tonic::Response<super::EdgeSlm>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new EdgeSlm in a given project and location."]
        ...
        #[doc = " Creates a blueprint."]
        pub async fn create_blueprint(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateBlueprintRequest>,
        ) -> Result<tonic::Response<super::Blueprint>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the requested blueprint."]
        ...
        #[doc = " Deletes a blueprint and all its revisions."]
        ...
        #[doc = " List all blueprints."]
        pub async fn list_blueprints(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBlueprintsRequest>,
        ) -> Result<tonic::Response<super::ListBlueprintsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Approves a blueprint and commits a new revision."]
        ...
        #[doc = " Proposes a blueprint for approval of changes."]
        ...
        #[doc = " Rejects a blueprint revision proposal and flips it back to Draft state."]
        ...
        #[doc = " List blueprint revisions of a given blueprint."]
        pub async fn list_blueprint_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBlueprintRevisionsRequest>,
        ) -> Result<tonic::Response<super::ListBlueprintRevisionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Searches across blueprint revisions."]
        pub async fn search_blueprint_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchBlueprintRevisionsRequest>,
        ) -> Result<tonic::Response<super::SearchBlueprintRevisionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Searches across deployment revisions."]
        pub async fn search_deployment_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchDeploymentRevisionsRequest>,
        ) -> Result<tonic::Response<super::SearchDeploymentRevisionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Discards the changes in a blueprint and reverts the blueprint to the last"]
        #[doc = " approved blueprint revision. No changes take place if a blueprint does not"]
        #[doc = " have revisions."]
        pub async fn discard_blueprint_changes(
            &mut self,
            request: impl tonic::IntoRequest<super::DiscardBlueprintChangesRequest>,
        ) -> Result<tonic::Response<super::DiscardBlueprintChangesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists the blueprints in TNA's public catalog. Default page size = 20,"]
        #[doc = " Max Page Size = 100."]
        pub async fn list_public_blueprints(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPublicBlueprintsRequest>,
        ) -> Result<tonic::Response<super::ListPublicBlueprintsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the requested public blueprint."]
        pub async fn get_public_blueprint(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPublicBlueprintRequest>,
        ) -> Result<tonic::Response<super::PublicBlueprint>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the requested deployment."]
        ...
        #[doc = " Removes the deployment by marking it as DELETING. Post which deployment and"]
        #[doc = " it's revisions gets deleted."]
        ...
        #[doc = " List deployment revisions of a given deployment."]
        pub async fn list_deployment_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListDeploymentRevisionsRequest>,
        ) -> Result<tonic::Response<super::ListDeploymentRevisionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Discards the changes in a deployment and reverts the deployment to the last"]
        #[doc = " approved deployment revision. No changes take place if a deployment does"]
        #[doc = " not have revisions."]
        pub async fn discard_deployment_changes(
            &mut self,
            request: impl tonic::IntoRequest<super::DiscardDeploymentChangesRequest>,
        ) -> Result<tonic::Response<super::DiscardDeploymentChangesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Applies the deployment's YAML files to the parent orchestration cluster."]
        ...
        #[doc = " Returns the requested deployment status."]
        pub async fn compute_deployment_status(
            &mut self,
            request: impl tonic::IntoRequest<super::ComputeDeploymentStatusRequest>,
        ) -> Result<tonic::Response<super::ComputeDeploymentStatusResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Rollback the active deployment to the given past approved deployment"]
        #[doc = " revision."]
        ...
        #[doc = " Returns the requested hydrated deployment."]
        pub async fn get_hydrated_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::GetHydratedDeploymentRequest>,
        ) -> Result<tonic::Response<super::HydratedDeployment>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " List all hydrated deployments present under a deployment."]
        pub async fn list_hydrated_deployments(
            &mut self,
            request: impl tonic::IntoRequest<super::ListHydratedDeploymentsRequest>,
        ) -> Result<tonic::Response<super::ListHydratedDeploymentsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Updates a hydrated deployment."]
        ...
        #[doc = " Applies a hydrated deployment to a workload cluster."]
