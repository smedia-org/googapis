...
pub mod gke_hub_membership_service_client {
    ...
    #[doc = " clusters to Google Cloud, represented with the"]
    #[doc = " [Membership][google.cloud.gkehub.v1beta1.Membership] resource."]
    #[doc = ""]
    #[doc = " GKE Hub is currently available in the global region and all regions in"]
    #[doc = " https://cloud.google.com/compute/docs/regions-zones."]
    #[doc = ""]
