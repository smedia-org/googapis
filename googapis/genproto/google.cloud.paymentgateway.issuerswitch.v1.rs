...
pub mod issuer_switch_transactions_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = "     * **Description** - Timestamp (in UTC) indicating when the issuer"]
        #[doc = "     switch created the transaction resource for processing the transaction."]
        #[doc = "     The format will be as per RFC-3339. Example : 2022-11-22T23:00:05Z"]
        #[doc = " 1. `State`"]
        #[doc = "     * **Min Length** - 6 characters"]
        #[doc = "     * **Max Length** - 9 characters"]
        #[doc = "     * **Description** - State of the transaction. This will be one of"]
        #[doc = "     `FAILED`, `SUCCEEDED`, or `TIMED_OUT`."]
        #[doc = " 1. `RRN`"]
        ...
        #[doc = " 1. `PayeeMobileNumber`"]
        #[doc = "     * **Min Length** - 12 characters"]
        #[doc = "     * **Max Length** - 12 characters"]
        #[doc = "     * **Description** - Payee's mobile number."]
        #[doc = " 1. `PayeeIFSC`"]
        #[doc = "     * **Min Length** - 11 characters"]
        #[doc = "     * **Max Length** - 11 characters"]
        ...
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Error code of a failed transaction."]
        #[doc = " 1. `ErrorMessage`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 10,000 characters"]
        #[doc = "     * **Description** - Error description for a failed transaction."]
        #[doc = " 1. `UPIErrorCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 3 characters"]
        ...
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Error code of the failed transaction."]
        #[doc = " 1. `ErrorMessage`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 10,000 characters"]
        #[doc = "     * **Description** - Error description for the failed transaction."]
        #[doc = " 1. `UPIErrorCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 3 characters"]
        #[doc = "     * **Description** - Error code as per the UPI specification. The issuer"]
        ...
        #[doc = "     * **Max Length** - 35 characters"]
        #[doc = "     * **Description** - UPI transaction ID."]
        #[doc = " 1. `UniqueMandateNumber`"]
        #[doc = "     * **Min Length** - 3 characters"]
        #[doc = "     * **Max Length** - 70 characters"]
        #[doc = "     * **Description** - UPI Unique Mandate Number."]
        #[doc = " 1. `TransactionType`"]
        ...
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 2 characters"]
        #[doc = "     * **Description** - Recurrence rule value of the mandate. This will be"]
        #[doc = "     an integer between 1 and 31."]
        #[doc = " 1. `Revokeable`"]
        #[doc = "     * **Min Length** - 4 characters"]
        #[doc = "     * **Max Length** - 5 characters"]
        #[doc = "     * **Description** - Boolean value specifying if the mandate is"]
        #[doc = "     revokable."]
        #[doc = " 1. `StartDate`"]
        ...
        #[doc = "     * **Min Length** - 6 characters"]
        #[doc = "     * **Max Length** - 9 characters"]
        #[doc = "     * **Description** - The block funds reference generated by the bank, if"]
        #[doc = "     funds have been blocked for the mandate. This column will have a value"]
        #[doc = "     only when the RecurrencePattern is ONETIME."]
        #[doc = " 1. `BlockFunds`"]
        #[doc = "     * **Min Length** - 4 characters"]
        #[doc = "     * **Max Length** - 5 characters"]
        #[doc = "     * **Description** - Boolean value specifying if the mandate transaction"]
        #[doc = "     requested to block funds."]
        #[doc = " 1. `LastUpdateTime`"]
        #[doc = "     * **Min Length** - 20 characters"]
        #[doc = "     * **Max Length** - 20 characters"]
        ...
        #[doc = "     * **Min Length** - 1 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - The mandate's name."]
        ...
        #[doc = "     * **Min Length** - 12 characters"]
        #[doc = "     * **Max Length** - 12 characters"]
        #[doc = "     * **Description** - Retrieval reference number of the original payment"]
        #[doc = "     transaction."]
        #[doc = " 1. `BankType`"]
        #[doc = "     * **Min Length** - 8 characters"]
        #[doc = "     * **Max Length** - 11 characters"]
        #[doc = "     * **Description** - The subtype of the transaction based on the bank"]
        #[doc = "     involved. This will be one of `BENEFICIARY`, or `REMITTER`."]
        #[doc = " 1. `OriginalTransactionID`"]
        #[doc = "     * **Min Length** - 35 characters"]
        #[doc = "     * **Max Length** - 35 characters"]
        #[doc = "     * **Description** - Transaction ID of the original unresolved"]
        #[doc = "     transaction."]
        #[doc = " 1. `RaiseComplaintAdjFlag`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the type of action to raise the"]
        #[doc = "     complaint."]
        #[doc = " 1. `RaiseComplaintAdjCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the reason of action to raise the"]
        #[doc = "     complaint."]
        #[doc = " 1. `ResolveComplaintAdjFlag`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the type of action to resolve the"]
        #[doc = "     complaint."]
        #[doc = " 1. `ResolveComplaintAdjCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the reason of action to resolve the"]
        #[doc = "     complaint."]
        #[doc = " 1. `RaiseDisputeAdjFlag`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the type of action to raise the dispute."]
        #[doc = " 1. `RaiseDisputeAdjCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the reason of action to raise the"]
        #[doc = "     dispute."]
        #[doc = " 1. `ResolveDisputeAdjFlag`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the type of action to resolve the"]
        #[doc = "     dispute."]
        #[doc = " 1. `ResolveDisputeAdjCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the reason of action to resolve the"]
        #[doc = "     dispute."]
        #[doc = " 1. `Amount`"]
        #[doc = "     * **Description** - Amount to be resolved."]
        #[doc = " 1. `CurrentCycle`"]
        #[doc = "     * **Min Length** - 4 characters"]
        #[doc = "     * **Max Length** - 5 characters"]
        #[doc = "     * **Description** - Boolean value specifying if the complaint / dispute"]
        #[doc = "     belongs to current settlement cycle or not."]
        #[doc = " 1. `CRN`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Defines the Complaint Reference number."]
        #[doc = " 1. `AdjTime`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the time when the resolution was done."]
        #[doc = " 1. `RespAdjFlag`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the response category type."]
        #[doc = " 1. `RespAdjCode`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
        #[doc = "     * **Description** - Indicates the response reason used."]
        #[doc = " 1. `AdjRemarks`"]
        #[doc = "     * **Min Length** - 0 characters"]
        #[doc = "     * **Max Length** - 255 characters"]
...
pub mod issuer_switch_participants_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " In UPI, the participant is identified by their account's IFSC and their"]
        #[doc = " account number."]
        ...
        #[doc = ""]
        #[doc = " The `number` of key-value pairs in the `metadata` field, the length of each"]
        #[doc = " `key` and the length of each `value` should be within the thresholds"]
        #[doc = " defined for them in the issuer switch configuration. Any violation of these"]
        #[doc = " thresholds will cause this API to return an error. The default values for"]
        #[doc = " these thresholds are:"]
        #[doc = ""]
        #[doc = " * `Maximum number` of key-value pairs - `5`"]
        #[doc = " * `Maximum length` of a key - `100`"]
        #[doc = " * `Maximum length` of a value - `500`"]
        #[doc = ""]
        ...
        #[doc = " If key-value pairs are to be added/removed from the metadata, then"]
        #[doc = " callers must follow the following steps:"]
        #[doc = ""]
        #[doc = " 1. Invoke the"]
        #[doc = "   [FetchParticipant][google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchParticipants.FetchParticipant]"]
        #[doc = "    API to get the current value of the `metadata` field."]
        #[doc = " 1. Update the `metadata` map to add/remove key-value pairs from it."]
        #[doc = " 1. Update the `metadata` in the issuer switch using this method."]
        ...
        #[doc = " Activate the issuer switch participant for UPI transactions. This API"]
        #[doc = " sets the state of the participant to"]
        #[doc = " [ACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.ACTIVE]."]
        #[doc = " A participant in the `ACTIVE` state can perform all UPI operations"]
        #[doc = " normally."]
        #[doc = ""]
        #[doc = " The behavior of this API varies based on the current state of the"]
        #[doc = " participant."]
        #[doc = ""]
        #[doc = " *   Current state is"]
        #[doc = "     [ACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.ACTIVE]"]
        #[doc = "     : This API will make no change to the participant's state and returns a"]
        #[doc = "     successful response."]
        #[doc = " *    Current state is"]
        #[doc = "     [INACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.INACTIVE]"]
        #[doc = "     : If an _MPIN_ has already been provisioned for the participant, then"]
        #[doc = "     this API will change the state of the participant to `ACTIVE`. Else,"]
        #[doc = "     this API will return an error."]
        #[doc = " *   Current state is"]
        #[doc = "     [MOBILE_NUMBER_CHANGED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.MOBILE_NUMBER_CHANGED]"]
        #[doc = "     : The state cannot be changed to `ACTIVE`. This API will return an"]
        #[doc = "     error."]
        #[doc = " *   Current state is"]
        #[doc = "     [NEW_REGISTRATION_INITIATED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.NEW_REGISTRATION_INITIATED]"]
        #[doc = "     : The state cannot be changed to `ACTIVE`. This API will return an"]
        #[doc = "     error."]
        #[doc = " *   Current state is"]
        #[doc = "     [RE_REGISTRATION_INITIATED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.RE_REGISTRATION_INITIATED]"]
        #[doc = "     : The state cannot be changed to `ACTIVE`. This API will return an"]
        #[doc = "     error."]
        pub async fn activate_participant(
            &mut self,
            request: impl tonic::IntoRequest<super::ParticipantStateChangeRequest>,
        ) -> Result<tonic::Response<super::IssuerParticipants>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deactivate the issuer switch participant for UPI transactions. This API"]
        #[doc = " sets the state of the participant to"]
        #[doc = " [INACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.INACTIVE]."]
        #[doc = " An `INACTIVE` participant cannot perform any UPI operation which involves"]
        ...
        #[doc = " *   Current state is"]
        #[doc = "     [ACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.ACTIVE]"]
        #[doc = "     : The state will change to `INACTIVE`. The user will be forced to"]
        #[doc = "     re-register with UPI and reset their MPIN  to perform any UPI"]
        #[doc = "     operations."]
        #[doc = " *   Current state is"]
        #[doc = "     [INACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.INACTIVE]"]
        #[doc = "     : This API will make no change to the participant's state and returns a"]
        ...
        #[doc = " *   Current state is"]
        #[doc = "     [MOBILE_NUMBER_CHANGED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.MOBILE_NUMBER_CHANGED]"]
        #[doc = "     : The state cannot be changed to `INACTIVE`. This API will return an"]
        #[doc = "     error."]
        #[doc = " *   Current state is"]
        #[doc = "     [NEW_REGISTRATION_INITIATED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.NEW_REGISTRATION_INITIATED]"]
        #[doc = "     : The state cannot be changed to `INACTIVE`. This API will return an"]
        ...
        #[doc = " Mark the state of the issuer switch participant as _mobile number changed_"]
        #[doc = " to prevent UPI transactions by the user. This API sets the state of the"]
        #[doc = " participant to"]
        #[doc = " [MOBILE_NUMBER_CHANGED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.MOBILE_NUMBER_CHANGED]."]
        #[doc = ""]
        ...
        #[doc = " *   Current state is"]
        #[doc = "     [ACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.ACTIVE]"]
        #[doc = "     : The state will change to `MOBILE_NUMBER_CHANGED`. Any operation"]
        #[doc = "     involving MPIN verification of the participant will return a `B1` error"]
        #[doc = "     to the UPI payments orchestrator. The user will be forced to"]
        #[doc = "     re-register with their changed mobile number."]
        #[doc = " *   Current state is"]
        #[doc = "     [INACTIVE][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.INACTIVE]"]
        #[doc = "     : The state will change to `MOBILE_NUMBER_CHANGED`. Any operation"]
        #[doc = "     involving MPIN verification of the participant will return a `B1` error"]
        ...
        #[doc = " *   Current state is"]
        #[doc = "     [NEW_REGISTRATION_INITIATED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.NEW_REGISTRATION_INITIATED]"]
        #[doc = "     : The state cannot be changed to `MOBILE_NUMBER_CHANGED`. This API will"]
        #[doc = "     return an error."]
        #[doc = " *   Current state is"]
        #[doc = "     [RE_REGISTRATION_INITIATED][google.cloud.paymentgateway.issuerswitch.v1.IssuerParticipant.State.RE_REGISTRATION_INITIATED]"]
        #[doc = "     : The state will change to `MOBILE_NUMBER_CHANGED`. Any operation"]
