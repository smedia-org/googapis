...
pub mod maps_platform_datasets_v1_alpha_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        {
            MapsPlatformDatasetsV1AlphaClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        #[doc = " Create a new dataset for the specified project."]
        pub async fn create_dataset(
            ...
            let path = http :: uri :: PathAndQuery :: from_static ("/google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1Alpha/CreateDataset") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Update the metadata for the dataset. To update the data use: UploadDataset."]
        pub async fn update_dataset_metadata(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1Alpha/UpdateDatasetMetadata") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Get the published or latest version of the dataset."]
        ...
        #[doc = " List all the versions of a dataset."]
        pub async fn list_dataset_versions(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1Alpha/ListDatasetVersions") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " List all the datasets for the specified project."]
        pub async fn list_datasets(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1Alpha/ListDatasets") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Delete the specified dataset and optionally all its corresponding"]
        #[doc = " versions."]
        pub async fn delete_dataset(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1Alpha/DeleteDataset") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Delete a specific version of the dataset."]
        pub async fn delete_dataset_version(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1Alpha/DeleteDatasetVersion") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
