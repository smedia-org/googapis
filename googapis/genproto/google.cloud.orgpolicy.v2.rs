...
pub mod org_policy_client {
    ...
    #[doc = ""]
    #[doc = " The Organization Policy Service provides a simple mechanism for"]
    #[doc = " organizations to restrict the allowed configurations across their entire"]
    #[doc = " resource hierarchy."]
    #[doc = ""]
    #[doc = " You can use a policy to configure restrictions on resources. For"]
    #[doc = " example, you can enforce a policy that restricts which Google"]
    #[doc = " Cloud APIs can be activated in a certain part of your resource"]
    #[doc = " hierarchy, or prevents serial port access to VM instances in a"]
    #[doc = " particular folder."]
    #[doc = ""]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " an evaluated policy across multiple resources."]
        ...
        #[doc = " policy already exists on the given Google Cloud resource."]
        ...
        #[doc = ""]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the"]
        #[doc = " constraint or organization policy does not exist."]
        ...
        #[doc = " Creates a custom constraint."]
        #[doc = ""]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the"]
        #[doc = " organization does not exist."]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.ALREADY_EXISTS` if the"]
        #[doc = " constraint already exists on the given organization."]
        pub async fn create_custom_constraint(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateCustomConstraintRequest>,
        ) -> Result<tonic::Response<super::CustomConstraint>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates a custom constraint."]
        #[doc = ""]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the"]
        #[doc = " constraint does not exist."]
        #[doc = ""]
        ...
        #[doc = " Gets a custom constraint."]
        #[doc = ""]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the"]
        #[doc = " custom constraint does not exist."]
        ...
        #[doc = " Retrieves all of the custom constraints that exist on a particular"]
        ...
        ) -> Result<tonic::Response<super::ListCustomConstraintsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes a custom constraint."]
        #[doc = ""]
        #[doc = " Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the"]
        #[doc = " constraint does not exist."]
