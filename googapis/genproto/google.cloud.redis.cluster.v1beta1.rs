...
pub mod cloud_redis_cluster_client {
    ...
    use tonic::codegen::*;
    #[doc = " Configures and manages Cloud Memorystore for Redis clusters"]
    #[doc = ""]
    #[doc = " Google Cloud Memorystore for Redis Cluster"]
    #[doc = ""]
    ...
    #[doc = " * Each location has a collection of Redis clusters, named: `/clusters/*`"]
    #[doc = " * As such, Redis clusters are resources of the form:"]
    #[doc = "   `/projects/{project_id}/locations/{location_id}/clusters/{instance_id}`"]
    #[doc = ""]
    #[doc = " Note that location_id must be a GCP `region`; for example:"]
    #[doc = " * `projects/redpepper-1290/locations/us-central1/clusters/my-redis`"]
    #[doc = ""]
    #[doc = " We use API version selector for Flex APIs"]
    #[doc = " * The versioning strategy is release-based versioning"]
    #[doc = " * Our backend CLH only deals with the superset version (called v1main)"]
    #[doc = " * Existing backend for Redis Gen1 and MRR is not touched."]
    #[doc = " * More details in go/redis-flex-api-versioning"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all Redis clusters owned by a project in either the specified"]
        ...
        #[doc = " Gets the details of a specific Redis cluster."]
        ...
        #[doc = " Updates the metadata and configuration of a specific Redis cluster."]
        #[doc = ""]
        #[doc = " Completed longrunning.Operation will contain the new cluster object"]
        ...
        #[doc = " Deletes a specific Redis cluster. Cluster stops serving and data is"]
        #[doc = " deleted."]
        ...
        #[doc = " Creates a Redis cluster based on the specified properties."]
        ...
        #[doc = " cluster will be fully functional. The completed longrunning.Operation will"]
        #[doc = " contain the new cluster object in the response field."]
        #[doc = ""]
        ...
        #[doc = " Gets the details of certificate authority information for Redis cluster."]
