...
pub mod net_app_client {
    ...
    use tonic::codegen::*;
    #[doc = " NetApp Files Google Cloud Service"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns descriptions of all storage pools owned by the caller."]
        pub async fn list_storage_pools(
            &mut self,
            request: impl tonic::IntoRequest<super::ListStoragePoolsRequest>,
        ) -> Result<tonic::Response<super::ListStoragePoolsResponse>, tonic::Status> {
        ...
        #[doc = " Creates a new storage pool."]
        ...
        #[doc = " Returns the description of the specified storage pool by poolId."]
        pub async fn get_storage_pool(
            &mut self,
            request: impl tonic::IntoRequest<super::GetStoragePoolRequest>,
        ) -> Result<tonic::Response<super::StoragePool>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the storage pool properties with the full spec"]
        ...
        #[doc = " Warning! This operation will permanently delete the storage pool."]
        ...
        #[doc = " Lists Volumes in a given project."]
        ...
        #[doc = " Gets details of a single Volume."]
        ...
        #[doc = " Creates a new Volume in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Volume."]
        ...
        #[doc = " Revert an existing volume to a specified snapshot."]
        #[doc = " Warning! This operation will permanently revert all changes made after the"]
        #[doc = " snapshot was created."]
        ...
        #[doc = " Returns descriptions of all snapshots for a volume."]
        ...
        #[doc = " Describe a snapshot for a volume."]
        ...
        #[doc = " Create a new snapshot for a volume."]
        ...
        #[doc = " Describes a specified active directory."]
        pub async fn get_active_directory(
            &mut self,
            request: impl tonic::IntoRequest<super::GetActiveDirectoryRequest>,
        ) -> Result<tonic::Response<super::ActiveDirectory>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " CreateActiveDirectory"]
        #[doc = " Creates the active directory specified in the request."]
        ...
        #[doc = " Update the parameters of an active directories."]
        ...
        #[doc = " Delete the active directory specified in the request."]
        ...
        #[doc = " Returns descriptions of all KMS configs owned by the caller."]
        pub async fn list_kms_configs(
            &mut self,
            request: impl tonic::IntoRequest<super::ListKmsConfigsRequest>,
        ) -> Result<tonic::Response<super::ListKmsConfigsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the description of the specified KMS config by kms_config_id."]
        pub async fn get_kms_config(
            &mut self,
            request: impl tonic::IntoRequest<super::GetKmsConfigRequest>,
        ) -> Result<tonic::Response<super::KmsConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the Kms config properties with the full spec"]
        ...
        #[doc = " Encrypt the existing volumes without CMEK encryption with the desired the"]
        #[doc = " KMS config for the whole region."]
        ...
        #[doc = " Verifies KMS config reachability."]
        pub async fn verify_kms_config(
            &mut self,
            request: impl tonic::IntoRequest<super::VerifyKmsConfigRequest>,
        ) -> Result<tonic::Response<super::VerifyKmsConfigResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Warning! This operation will permanently delete the Kms config."]
        ...
        #[doc = " Returns descriptions of all replications for a volume."]
        pub async fn list_replications(
            &mut self,
            request: impl tonic::IntoRequest<super::ListReplicationsRequest>,
        ) -> Result<tonic::Response<super::ListReplicationsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Describe a replication for a volume."]
        pub async fn get_replication(
            &mut self,
            request: impl tonic::IntoRequest<super::GetReplicationRequest>,
        ) -> Result<tonic::Response<super::Replication>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Create a new replication for a volume."]
        ...
        #[doc = " Updates the settings of a specific replication."]
        ...
        #[doc = " Stop Cross Region Replication."]
        ...
        #[doc = " Resume Cross Region Replication."]
        ...
        #[doc = " Reverses direction of replication. Source becomes destination and"]
        #[doc = " destination becomes source."]
        ...
        #[doc = " Returns the description of the specified backup vault"]
        pub async fn get_backup_vault(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBackupVaultRequest>,
        ) -> Result<tonic::Response<super::BackupVault>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns list of all available backup vaults."]
        pub async fn list_backup_vaults(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBackupVaultsRequest>,
        ) -> Result<tonic::Response<super::ListBackupVaultsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the settings of a specific backup vault."]
        ...
        #[doc = " Warning! This operation will permanently delete the backup vault."]
        ...
        #[doc = " Creates a backup from the volume specified in the request"]
        #[doc = " The backup can be created from the given snapshot if specified in the"]
        #[doc = " request. If no snapshot specified, there'll be a new snapshot taken to"]
        #[doc = " initiate the backup creation."]
        ...
        #[doc = " Returns the description of the specified backup"]
        ...
        #[doc = " Returns descriptions of all backups for a backupVault."]
        ...
        #[doc = " Warning! This operation will permanently delete the backup."]
        ...
        #[doc = " Update backup with full spec."]
        ...
        #[doc = " Returns the description of the specified backup policy by backup_policy_id."]
        pub async fn get_backup_policy(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBackupPolicyRequest>,
        ) -> Result<tonic::Response<super::BackupPolicy>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns list of all available backup policies."]
        pub async fn list_backup_policies(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBackupPoliciesRequest>,
        ) -> Result<tonic::Response<super::ListBackupPoliciesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates settings of a specific backup policy."]
        ...
        #[doc = " Warning! This operation will permanently delete the backup policy."]
