...
pub mod video_stitcher_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Updates the specified LiveConfig. Only update fields specified"]
        #[doc = " in the call method body."]
        ...
        #[doc = " Registers the VOD config with the provided unique ID in"]
        #[doc = " the specified region."]
        ...
        #[doc = " Lists all VOD configs managed by the Video Stitcher API that"]
        #[doc = " belong to the specified project and region."]
        pub async fn list_vod_configs(
            &mut self,
            request: impl tonic::IntoRequest<super::ListVodConfigsRequest>,
        ) -> Result<tonic::Response<super::ListVodConfigsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns the specified VOD config managed by the Video"]
        #[doc = " Stitcher API service."]
        pub async fn get_vod_config(
            &mut self,
            request: impl tonic::IntoRequest<super::GetVodConfigRequest>,
        ) -> Result<tonic::Response<super::VodConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes the specified VOD config."]
        ...
        #[doc = " Updates the specified VOD config. Only update fields specified"]
        #[doc = " in the call method body."]
