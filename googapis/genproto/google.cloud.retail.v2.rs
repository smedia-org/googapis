...
pub mod catalog_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a [CompletionConfig][google.cloud.retail.v2.CompletionConfig]."]
        ...
        #[doc = " Updates the [CompletionConfig][google.cloud.retail.v2.CompletionConfig]s."]
        ...
        #[doc = " Gets an [AttributesConfig][google.cloud.retail.v2.AttributesConfig]."]
        ...
        #[doc = " Updates the [AttributesConfig][google.cloud.retail.v2.AttributesConfig]."]
        #[doc = ""]
        ...
        #[doc = " [CatalogAttribute][google.cloud.retail.v2.CatalogAttribute] to the"]
        #[doc = " [AttributesConfig][google.cloud.retail.v2.AttributesConfig]."]
        #[doc = ""]
        #[doc = " If the [CatalogAttribute][google.cloud.retail.v2.CatalogAttribute] to add"]
        ...
        #[doc = " [CatalogAttribute][google.cloud.retail.v2.CatalogAttribute] from the"]
        #[doc = " [AttributesConfig][google.cloud.retail.v2.AttributesConfig]."]
        #[doc = ""]
        #[doc = " If the [CatalogAttribute][google.cloud.retail.v2.CatalogAttribute] to"]
        ...
        #[doc = " [CatalogAttribute][google.cloud.retail.v2.CatalogAttribute] in the"]
        #[doc = " [AttributesConfig][google.cloud.retail.v2.AttributesConfig] by updating the"]
        #[doc = " catalog attribute with the same"]
        #[doc = " [CatalogAttribute.key][google.cloud.retail.v2.CatalogAttribute.key]."]
        #[doc = ""]
        #[doc = " If the [CatalogAttribute][google.cloud.retail.v2.CatalogAttribute] to"]
...
pub mod control_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " If the [Control][google.cloud.retail.v2.Control] to create already exists,"]
        #[doc = " an ALREADY_EXISTS error is returned."]
        ...
        #[doc = ""]
        #[doc = " If the [Control][google.cloud.retail.v2.Control] to delete does not exist,"]
        #[doc = " a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " [Control][google.cloud.retail.v2.Control] cannot be set to a different"]
        #[doc = " oneof field, if so an INVALID_ARGUMENT is returned. If the"]
        #[doc = " [Control][google.cloud.retail.v2.Control] to update does not exist, a"]
        ...
        #[doc = " [Catalog][google.cloud.retail.v2.Catalog]."]
...
pub mod product_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Permanently deletes all selected [Product][google.cloud.retail.v2.Product]s"]
        #[doc = " under a branch."]
        #[doc = ""]
        ...
        #[doc = " [Product][google.cloud.retail.v2.Product]s, this operation could take hours"]
        #[doc = " to complete. Before the operation completes, some"]
        #[doc = " [Product][google.cloud.retail.v2.Product]s may still be returned by"]
        #[doc = " [ProductService.GetProduct][google.cloud.retail.v2.ProductService.GetProduct]"]
        #[doc = " or"]
        #[doc = " [ProductService.ListProducts][google.cloud.retail.v2.ProductService.ListProducts]."]
        #[doc = ""]
        ...
        #[doc = " [ProductService.CreateProduct][google.cloud.retail.v2.ProductService.CreateProduct]"]
        #[doc = " and"]
        #[doc = " [ProductService.UpdateProduct][google.cloud.retail.v2.ProductService.UpdateProduct],"]
        ...
        #[doc = " [ProductService.SetInventory][google.cloud.retail.v2.ProductService.SetInventory],"]
        #[doc = " [ProductService.AddFulfillmentPlaces][google.cloud.retail.v2.ProductService.AddFulfillmentPlaces],"]
        #[doc = " and"]
        #[doc = " [ProductService.RemoveFulfillmentPlaces][google.cloud.retail.v2.ProductService.RemoveFulfillmentPlaces]."]
        #[doc = ""]
        ...
        #[doc = " [ProductService.AddLocalInventories][google.cloud.retail.v2.ProductService.AddLocalInventories]"]
        ...
        #[doc = " We recommend that you use the"]
        #[doc = " [ProductService.RemoveLocalInventories][google.cloud.retail.v2.ProductService.RemoveLocalInventories]"]
        #[doc = " method instead of the"]
        #[doc = " [ProductService.RemoveFulfillmentPlaces][google.cloud.retail.v2.ProductService.RemoveFulfillmentPlaces]"]
        #[doc = " method."]
        #[doc = " [ProductService.RemoveLocalInventories][google.cloud.retail.v2.ProductService.RemoveLocalInventories]"]
...
pub mod serving_config_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " A maximum of 100 [ServingConfig][google.cloud.retail.v2.ServingConfig]s are"]
        #[doc = " allowed in a [Catalog][google.cloud.retail.v2.Catalog], otherwise a"]
