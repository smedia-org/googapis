...
pub mod parallelstore_client {
    ...
    #[doc = " Configures and manages parallelstore resources."]
    #[doc = ""]
    #[doc = " Parallelstore service."]
    #[doc = ""]
    #[doc = " The `parallelstore.googleapis.com` service implements the parallelstore API"]
    #[doc = " and defines the following resource model for managing instances:"]
    ...
    #[doc = " * Each location has a collection of instances named `/instances/*`."]
    #[doc = " * Parallelstore instances are resources of the form:"]
    #[doc = "   `/projects/{project_id}/locations/{location_id}/instances/{instance_id}`"]
    #[doc = ""]
    #[doc = " Note that location_id must be a Google Cloud `zone`; for example:"]
    #[doc = " * `projects/12345/locations/us-central1-c/instances/my-parallelstore-share`"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a Parallelstore instance in a given project and location."]
        ...
        #[doc = " ImportData copies data from Cloud Storage to Parallelstore."]
        ...
        #[doc = " ExportData copies data from Parallelstore to Cloud Storage"]
