...
pub mod client_connector_services_service_client {
    ...
    #[doc = " Data Model:"]
    #[doc = ""]
    #[doc = " The ClientConnectorServicesService exposes the following resources:"]
    #[doc = ""]
    #[doc = " * Client Connector Services, named as follows:"]
    #[doc = "   `projects/{project_id}/locations/{location_id}/client_connector_services/{client_connector_service_id}`."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists ClientConnectorServices in a given project and location."]
        pub async fn list_client_connector_services(
            &mut self,
            request: impl tonic::IntoRequest<super::ListClientConnectorServicesRequest>,
        ) -> Result<tonic::Response<super::ListClientConnectorServicesResponse>, tonic::Status>
        {
        ...
        #[doc = " Gets details of a single ClientConnectorService."]
        ...
        #[doc = " Creates a new ClientConnectorService in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single ClientConnectorService."]
        ...
        #[doc = " Deletes a single ClientConnectorService."]
