...
pub mod cache_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " API for managing cache of content (CachedContent resources) that can be used"]
    #[doc = " in GenerativeService requests. This way generate content requests can benefit"]
    #[doc = " from preprocessing work being done earlier, possibly lowering their"]
    #[doc = " computational cost. It is intended to be used with large contexts."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Reads CachedContent resource."]
        ...
        #[doc = " Updates CachedContent resource (only expiration is updatable)."]
        ...
        #[doc = " Deletes CachedContent resource."]
...
pub mod file_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " An API for uploading and managing files."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists the metadata for `File`s owned by the requesting project."]
        ...
        #[doc = " Gets the metadata for the given `File`."]
...
pub mod generative_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Generates a grounded answer from the model given an input"]
        #[doc = " `GenerateAnswerRequest`."]
        pub async fn generate_answer(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateAnswerRequest>,
        ) -> Result<tonic::Response<super::GenerateAnswerResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod retriever_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " An API for semantic search over a corpus of user uploaded content."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets information about a specific `Corpus`."]
        ...
        #[doc = " Lists all `Corpora` owned by the user."]
        ...
        #[doc = " Performs semantic search over a `Corpus`."]
        pub async fn query_corpus(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryCorpusRequest>,
        ) -> Result<tonic::Response<super::QueryCorpusResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets information about a specific `Document`."]
        ...
        #[doc = " Lists all `Document`s in a `Corpus`."]
        ...
        #[doc = " Performs semantic search over a `Document`."]
        pub async fn query_document(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryDocumentRequest>,
        ) -> Result<tonic::Response<super::QueryDocumentResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets information about a specific `Chunk`."]
        ...
        #[doc = " Lists all `Chunk`s in a `Document`."]
