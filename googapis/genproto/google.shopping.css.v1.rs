...
pub mod accounts_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for managing CSS/MC account information."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all the accounts under the specified CSS account ID, and"]
        #[doc = " optionally filters by label ID and account name."]
        pub async fn list_child_accounts(
            &mut self,
            request: impl tonic::IntoRequest<super::ListChildAccountsRequest>,
        ) -> Result<tonic::Response<super::ListChildAccountsResponse>, tonic::Status> {
        ...
        #[doc = " Retrieves a single CSS/MC account by ID."]
        ...
        #[doc = " Updates labels assigned to CSS/MC accounts by a CSS domain."]
...
pub mod account_labels_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Manages Merchant Center and CSS accounts labels."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists the labels assigned to an account."]
        pub async fn list_account_labels(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAccountLabelsRequest>,
        ) -> Result<tonic::Response<super::ListAccountLabelsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a new label, not assigned to any account."]
        pub async fn create_account_label(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateAccountLabelRequest>,
        ) -> Result<tonic::Response<super::AccountLabel>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes a label and removes it from all accounts to which it was assigned."]
...
pub mod css_product_inputs_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to use CssProductInput resource."]
    #[doc = " This service helps to insert/update/delete CSS Products."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Uploads a CssProductInput to your CSS Center account. If an"]
        #[doc = " input with the same contentLanguage, identity, feedLabel and feedId already"]
        #[doc = " exists, this method replaces that entry."]
        #[doc = ""]
        #[doc = " After inserting, updating, or deleting a CSS Product input, it may"]
        #[doc = " take several minutes before the processed CSS Product can be retrieved."]
        pub async fn insert_css_product_input(
            &mut self,
            request: impl tonic::IntoRequest<super::InsertCssProductInputRequest>,
        ) -> Result<tonic::Response<super::CssProductInput>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes a CSS Product input from your CSS Center account."]
        #[doc = ""]
        #[doc = " After a delete it may take several minutes until the input is no longer"]
        #[doc = " available."]
...
pub mod css_products_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for doing get and list on Css Products(a.k.a Aggregate Offers"]
    #[doc = " internally)."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the processed CSS Product from your CSS Center account. After"]
        #[doc = " inserting, updating, or deleting a product input, it may take several"]
        #[doc = " minutes before the updated final product can be retrieved."]
        pub async fn get_css_product(
            &mut self,
            request: impl tonic::IntoRequest<super::GetCssProductRequest>,
        ) -> Result<tonic::Response<super::CssProduct>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the processed CSS Products in your CSS Center account. The response"]
        #[doc = " might contain fewer items than specified by pageSize. Rely on pageToken to"]
        #[doc = " determine if there are more items to be requested."]
        #[doc = ""]
        #[doc = " After inserting, updating, or deleting a CSS product input, it may"]
        #[doc = " take several minutes before the updated processed CSS product can be"]
        #[doc = " retrieved."]
        pub async fn list_css_products(
            &mut self,
            request: impl tonic::IntoRequest<super::ListCssProductsRequest>,
        ) -> Result<tonic::Response<super::ListCssProductsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
