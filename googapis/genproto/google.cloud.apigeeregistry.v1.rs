...
pub mod provisioning_client {
    ...
    use tonic::codegen::*;
    #[doc = " The service that is used for managing the data plane provisioning of the"]
    #[doc = " Registry."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Provisions instance resources for the Registry."]
        ...
        #[doc = " Deletes the Registry instance."]
...
pub mod registry_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " The Registry service allows teams to manage descriptions of APIs."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Used to modify a specified API."]
        ...
        #[doc = " Removes a specified API and all of the resources that it"]
        #[doc = " owns."]
        ...
        #[doc = " Returns a specified version."]
        ...
        #[doc = " Creates a specified version."]
        ...
        #[doc = " Used to modify a specified version."]
        ...
        #[doc = " Removes a specified version and all of the resources that"]
        #[doc = " it owns."]
        ...
        #[doc = " Returns the contents of a specified spec."]
        #[doc = " If specs are stored with GZip compression, the default behavior"]
        #[doc = " is to return the spec uncompressed (the mime_type response field"]
        #[doc = " indicates the exact format returned)."]
        ...
        #[doc = " Used to modify a specified spec."]
        ...
        #[doc = " Removes a specified spec, all revisions, and all child"]
        #[doc = " resources (e.g., artifacts)."]
        ...
        #[doc = " Adds a tag to a specified revision of a spec."]
        ...
        #[doc = " Lists all revisions of a spec."]
        #[doc = " Revisions are returned in descending order of revision creation time."]
        pub async fn list_api_spec_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListApiSpecRevisionsRequest>,
        ) -> Result<tonic::Response<super::ListApiSpecRevisionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Sets the current revision to a specified prior revision."]
        #[doc = " Note that this creates a new revision with a new revision ID."]
        ...
        #[doc = " Deletes a revision of a spec."]
        ...
        #[doc = " Returns matching deployments."]
        ...
        #[doc = " Returns a specified deployment."]
        ...
        #[doc = " Creates a specified deployment."]
        ...
        #[doc = " Used to modify a specified deployment."]
        ...
        #[doc = " Removes a specified deployment, all revisions, and all"]
        #[doc = " child resources (e.g., artifacts)."]
        ...
        #[doc = " Adds a tag to a specified revision of a"]
        #[doc = " deployment."]
        ...
        #[doc = " Lists all revisions of a deployment."]
        #[doc = " Revisions are returned in descending order of revision creation time."]
        pub async fn list_api_deployment_revisions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListApiDeploymentRevisionsRequest>,
        ) -> Result<tonic::Response<super::ListApiDeploymentRevisionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Sets the current revision to a specified prior"]
        #[doc = " revision. Note that this creates a new revision with a new revision ID."]
        ...
        #[doc = " Deletes a revision of a deployment."]
        ...
        #[doc = " Returns matching artifacts."]
        ...
        #[doc = " Returns a specified artifact."]
        ...
        #[doc = " Returns the contents of a specified artifact."]
        #[doc = " If artifacts are stored with GZip compression, the default behavior"]
        #[doc = " is to return the artifact uncompressed (the mime_type response field"]
        #[doc = " indicates the exact format returned)."]
        ...
        #[doc = " Creates a specified artifact."]
        ...
        #[doc = " Used to replace a specified artifact."]
        ...
        #[doc = " Removes a specified artifact."]
