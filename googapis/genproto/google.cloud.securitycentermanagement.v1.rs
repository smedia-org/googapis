...
pub mod security_center_management_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns a list of all EffectiveSecurityHealthAnalyticsCustomModules for the"]
        #[doc = " given parent. This includes resident modules defined at the scope of the"]
        #[doc = " parent, and inherited modules, inherited from CRM ancestors (no"]
        #[doc = " descendants)."]
        ...
        #[doc = " Gets details of a single EffectiveSecurityHealthAnalyticsCustomModule."]
        ...
        #[doc = " Returns a list of all SecurityHealthAnalyticsCustomModules for the given"]
        #[doc = " parent. This includes resident modules defined at the scope of the parent,"]
        #[doc = " and inherited modules, inherited from CRM ancestors (no descendants)."]
        ...
        #[doc = " Returns a list of all resident SecurityHealthAnalyticsCustomModules under"]
        #[doc = " the given CRM parent and all of the parent's CRM descendants."]
        ...
        #[doc = " Retrieves a SecurityHealthAnalyticsCustomModule."]
        ...
        ) -> Result<tonic::Response<super::SecurityHealthAnalyticsCustomModule>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Creates a resident SecurityHealthAnalyticsCustomModule at the scope of the"]
        #[doc = " given CRM parent, and also creates inherited"]
        #[doc = " SecurityHealthAnalyticsCustomModules for all CRM descendants of the given"]
        #[doc = " parent. These modules are enabled by default."]
        ...
        #[doc = " Updates the SecurityHealthAnalyticsCustomModule under the given name based"]
        #[doc = " on the given update mask. Updating the enablement state is supported on"]
        #[doc = " both resident and inherited modules (though resident modules cannot have an"]
        #[doc = " enablement state of \"inherited\"). Updating the display name and custom"]
        #[doc = " config of a module is supported on resident modules only."]
        ...
        #[doc = " Deletes the specified SecurityHealthAnalyticsCustomModule and all of its"]
        #[doc = " descendants in the CRM hierarchy. This method is only supported for"]
        #[doc = " resident custom modules."]
        ...
        #[doc = " Gets an effective ETD custom module. Retrieves the effective module at the"]
        #[doc = " given level. The difference between an EffectiveCustomModule and a"]
        #[doc = " CustomModule is that the fields for an EffectiveCustomModule are computed"]
        #[doc = " from ancestors if needed. For example, the enablement_state for a"]
        #[doc = " CustomModule can be either ENABLED, DISABLED, or INHERITED. Where as the"]
        #[doc = " enablement_state for an EffectiveCustomModule is always computed to ENABLED"]
        #[doc = " or DISABLED (the effective enablement_state)."]
        ...
        #[doc = " Gets service settings for the specified Security Command Center service."]
        pub async fn get_security_center_service(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSecurityCenterServiceRequest>,
        ) -> Result<tonic::Response<super::SecurityCenterService>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Returns a list of all Security Command Center services for the given"]
        #[doc = " parent."]
        pub async fn list_security_center_services(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSecurityCenterServicesRequest>,
        ) -> Result<tonic::Response<super::ListSecurityCenterServicesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Updates a Security Command Center service using the given update mask."]
