...
pub mod account_tax_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Manages account level tax setting data."]
    #[doc = ""]
    #[doc = " This API defines the following resource model:"]
    #[doc = ""]
    #[doc = " - [AccountTax][google.shopping.merchant.accounts.v1main.AccountTax]"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns the tax rules that match the conditions of GetAccountTaxRequest"]
        pub async fn get_account_tax(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAccountTaxRequest>,
        ) -> Result<tonic::Response<super::AccountTax>, tonic::Status> {
        ...
        #[doc = " Lists the tax settings of the sub-accounts only in your"]
        #[doc = " Merchant Center account."]
        #[doc = " This method can only be called on a multi-client account, otherwise it'll"]
        #[doc = " return an error."]
        pub async fn list_account_tax(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAccountTaxRequest>,
        ) -> Result<tonic::Response<super::ListAccountTaxResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod account_issue_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support `AccountIssueService` API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all account issues of a Merchant Center account."]
        pub async fn list_account_issues(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAccountIssuesRequest>,
        ) -> Result<tonic::Response<super::ListAccountIssuesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod user_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support user API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves a Merchant Center account user."]
        ...
        #[doc = " Creates a Merchant Center account user. Executing this method requires"]
        #[doc = " admin access."]
        ...
        #[doc = " Deletes a Merchant Center account user. Executing this method requires"]
        #[doc = " admin access."]
        ...
        #[doc = " Updates a Merchant Center account user. Executing this method requires"]
        #[doc = " admin access."]
        ...
        #[doc = " Lists all users of a Merchant Center account."]
...
pub struct CreateAndConfigureAccountRequest {
    ...
    pub accept_terms_of_service:
        ::core::option::Option<create_and_configure_account_request::AcceptTermsOfService>,
...
pub mod accounts_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support Accounts API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves an account from your Merchant Center account."]
        #[doc = " After inserting, updating, or deleting an account, it may take several"]
        #[doc = " minutes before changes take effect."]
        ...
        #[doc = " Creates a standalone Merchant Center account with additional configuration."]
        #[doc = " Adds the user that makes the request as an admin for the new account."]
        ...
        #[doc = " Deletes the specified account regardless of its type: standalone, MCA or"]
        #[doc = " sub-account. Deleting an MCA leads to the deletion of all of its"]
        #[doc = " sub-accounts. Executing this method requires admin access."]
        ...
        #[doc = " Updates an account regardless of its type: standalone, MCA or sub-account."]
        #[doc = " Executing this method requires admin access."]
        ...
        #[doc = " Lists accounts accessible to the calling user and matching the"]
        #[doc = " constraints of the request such as page size or filters."]
        #[doc = " This is not just listing the sub-accounts of an MCA, but all accounts the"]
        #[doc = " calling user has access to including other MCAs, linked accounts,"]
        #[doc = " standalone accounts and so on."]
        ...
        #[doc = " List all sub-accounts for a given multi client account. This is a"]
        #[doc = " convenience wrapper for the more powerful `ListAccounts` method. This"]
        #[doc = " method will produce the same results as calling `ListsAccounts` with the"]
        #[doc = " following filter:"]
        #[doc = " `relationship(providerId={parent} AND service(type=\"ACCOUNT_AGGREGATION\"))`"]
        pub async fn list_sub_accounts(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSubAccountsRequest>,
        ) -> Result<tonic::Response<super::ListSubAccountsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod business_identity_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support [business"]
    #[doc = " identity](https://support.google.com/merchants/answer/12564247) API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the business identity of an account."]
        pub async fn get_business_identity(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBusinessIdentityRequest>,
        ) -> Result<tonic::Response<super::BusinessIdentity>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the business identity of an account. Executing this method requires"]
        #[doc = " admin access."]
...
pub mod business_info_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support business info API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the business info of an account."]
        pub async fn get_business_info(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBusinessInfoRequest>,
        ) -> Result<tonic::Response<super::BusinessInfo>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the business info of an account. Executing this method requires"]
        #[doc = " admin access."]
...
pub mod email_preferences_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support the `EmailPreferences` API."]
    #[doc = ""]
    #[doc = " This service only permits retrieving and updating email preferences for the"]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Returns the email preferences for a Merchant Center account user."]
        #[doc = ""]
        #[doc = " Use the name=accounts/*/users/me/emailPreferences alias to get preferences"]
        #[doc = " for the authenticated user."]
        pub async fn get_email_preferences(
            &mut self,
            request: impl tonic::IntoRequest<super::GetEmailPreferencesRequest>,
        ) -> Result<tonic::Response<super::EmailPreferences>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates the email preferences for a Merchant Center account user. MCA users"]
        #[doc = " should specify the MCA account rather than a sub-account of the MCA."]
        #[doc = ""]
        #[doc = " Preferences which are not explicitly selected in the update mask will not"]
        #[doc = " be updated."]
        #[doc = ""]
        #[doc = " It is invalid for updates to specify an UNCONFIRMED opt-in status value."]
        #[doc = ""]
        #[doc = " Use the name=accounts/*/users/me/emailPreferences alias to update"]
        #[doc = " preferences"]
        #[doc = " for the authenticated user."]
...
pub mod homepage_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support an API for a store's homepage."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves a store's homepage."]
        pub async fn get_homepage(
            &mut self,
            request: impl tonic::IntoRequest<super::GetHomepageRequest>,
        ) -> Result<tonic::Response<super::Homepage>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates a store's homepage. Executing this method requires admin access."]
        ...
        #[doc = " Claims a store's homepage. Executing this method requires admin access."]
        #[doc = ""]
        #[doc = " If the homepage is already claimed, this will recheck the"]
        #[doc = " verification (unless the merchant is exempted from claiming, which also"]
        #[doc = " exempts from verification) and return a successful response. If ownership"]
        #[doc = " can no longer be verified, it will return an error, but it won't clear the"]
        #[doc = " claim. In case of failure, a canonical error message will be returned:"]
        #[doc = "    * PERMISSION_DENIED: user doesn't have the necessary permissions on this"]
        #[doc = "    MC account;"]
        #[doc = "    * FAILED_PRECONDITION:"]
        #[doc = "      - The account is not a Merchant Center account;"]
        #[doc = "      - MC account doesn't have a homepage;"]
        #[doc = "      - claiming failed (in this case the error message will contain more"]
        #[doc = "      details)."]
        ...
        #[doc = " Unclaims a store's homepage. Executing this method requires admin access."]
...
pub mod online_return_policy_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " The service facilitates the management of a merchant's remorse return policy"]
    #[doc = " configuration, encompassing return policies for both ads and free listings"]
    #[doc = " ## programs. This API defines the following resource model:"]
    #[doc = ""]
    #[doc = " [OnlineReturnPolicy][google.shopping.merchant.accounts.v1.OnlineReturnPolicy]"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all existing return policies."]
        pub async fn list_online_return_policies(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOnlineReturnPoliciesRequest>,
        ) -> Result<tonic::Response<super::ListOnlineReturnPoliciesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod programs_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for program management."]
    #[doc = ""]
    #[doc = " Programs provide a mechanism for adding functionality to merchant accounts. A"]
    #[doc = " typical example of this is the [Free product"]
    #[doc = " listings](https://support.google.com/merchants/topic/9240261?ref_topic=7257954,7259405,&sjid=796648681813264022-EU)"]
    #[doc = " program, which enables products from a merchant's store to be shown across"]
    #[doc = " Google for free."]
    #[doc = ""]
    #[doc = " This service exposes methods to retrieve a merchant's"]
    #[doc = " participation in all available programs, in addition to methods for"]
    #[doc = " explicitly enabling or disabling participation in each program."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the specified program for the account."]
        pub async fn get_program(
            &mut self,
            request: impl tonic::IntoRequest<super::GetProgramRequest>,
        ) -> Result<tonic::Response<super::Program>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Retrieves all programs for the account."]
        pub async fn list_programs(
            &mut self,
            request: impl tonic::IntoRequest<super::ListProgramsRequest>,
        ) -> Result<tonic::Response<super::ListProgramsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Enable participation in the specified program for the account. Executing"]
        #[doc = " this method requires admin access."]
        ...
        #[doc = " Disable participation in the specified program for the account. Executing"]
        #[doc = " this method requires admin access."]
...
pub mod regions_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Manages regions configuration."]
    #[doc = ""]
    #[doc = " This API defines the following resource model:"]
    #[doc = ""]
    #[doc = " - [Region][google.shopping.merchant.accounts.v1main.Region]"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves a region defined in your Merchant Center account."]
        ...
        #[doc = " Creates a region definition in your Merchant Center account. Executing this"]
        #[doc = " method requires admin access."]
        ...
        #[doc = " Updates a region definition in your Merchant Center account. Executing this"]
        #[doc = " method requires admin access."]
        ...
        #[doc = " Deletes a region definition from your Merchant Center account. Executing"]
        #[doc = " this method requires admin access."]
        ...
        #[doc = " Lists the regions in your Merchant Center account."]
        pub async fn list_regions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRegionsRequest>,
        ) -> Result<tonic::Response<super::ListRegionsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub struct MinimumOrderValueTable {
    ...
    pub store_code_set_with_movs:
        ::prost::alloc::vec::Vec<minimum_order_value_table::StoreCodeSetWithMov>,
}
...
pub mod shipping_settings_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to get method call shipping setting information per Merchant API"]
    #[doc = " method."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieve shipping setting information."]
        pub async fn get_shipping_settings(
            &mut self,
            request: impl tonic::IntoRequest<super::GetShippingSettingsRequest>,
        ) -> Result<tonic::Response<super::ShippingSettings>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Replace the shipping setting of a merchant with the request shipping"]
        #[doc = " setting. Executing this method requires admin access."]
...
pub mod terms_of_service_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support `TermsOfService` API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Retrieves the `TermsOfService` associated with the provided version."]
        pub async fn get_terms_of_service(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTermsOfServiceRequest>,
        ) -> Result<tonic::Response<super::TermsOfService>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Retrieves the latest version of the `TermsOfService` for a given `kind` and"]
        #[doc = " `region_code`."]
        ...
        #[doc = " Accepts a `TermsOfService`. Executing this method requires admin access."]
...
pub mod terms_of_service_agreement_state_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service to support `TermsOfServiceAgreementState` API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        where
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::BoxBody>>>::Error:
                Into<StdError> + Send + Sync,
        {
            TermsOfServiceAgreementStateServiceClient::new(InterceptedService::new(
                inner,
                interceptor,
            ))
        }
        ...
        #[doc = " Returns the state of a terms of service agreement."]
        pub async fn get_terms_of_service_agreement_state(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTermsOfServiceAgreementStateRequest>,
        ) -> Result<tonic::Response<super::TermsOfServiceAgreementState>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Retrieves the state of the agreement for the application terms of service."]
