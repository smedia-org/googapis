...
pub mod api_keys_client {
    ...
    use tonic::codegen::*;
    #[doc = " Manages the API keys associated with projects."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        ...
        > {
            ...
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/CreateKey");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Lists the API keys owned by a project. The key string of the API key"]
        #[doc = " isn't included in the response."]
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        pub async fn list_keys(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/ListKeys");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Gets the metadata for an API key. The key string of the API key"]
        #[doc = " isn't included in the response."]
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        pub async fn get_key(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/GetKey");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Get the key string for an API key."]
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        pub async fn get_key_string(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/GetKeyString");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Patches the modifiable fields of an API key."]
        #[doc = " The key string of the API key isn't included in the response."]
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/UpdateKey");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Deletes an API key. Deleted key can be retrieved within 30 days of"]
        #[doc = " deletion. Afterward, key will be purged from the project."]
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/DeleteKey");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Undeletes an API key which was deleted within 30 days."]
        #[doc = ""]
        #[doc = " NOTE: Key is a global resource; hence the only supported value for"]
        #[doc = " location is `global`."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/UndeleteKey");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Find the parent project and resource name of the API"]
        #[doc = " key that matches the key string in the request. If the API key has been"]
        #[doc = " purged, resource name will not be set."]
        #[doc = " The service account must have the `apikeys.keys.lookup` permission"]
        #[doc = " on the parent project."]
        pub async fn lookup_key(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.api.apikeys.v2.ApiKeys/LookupKey");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
