...
pub mod subscriptions_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " A service that manages subscriptions to Google Workspace events."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a Google Workspace subscription. To learn how to use this"]
        #[doc = " method, see [Create a Google Workspace"]
        #[doc = " subscription](https://developers.google.com/workspace/events/guides/create-subscription)."]
        ...
        #[doc = " Deletes a Google Workspace subscription."]
        #[doc = " To learn how to use this method, see [Delete a Google Workspace"]
        #[doc = " subscription](https://developers.google.com/workspace/events/guides/delete-subscription)."]
        ...
        #[doc = " Gets details about a Google Workspace subscription. To learn how to use"]
        #[doc = " this method, see [Get details about a Google Workspace"]
        #[doc = " subscription](https://developers.google.com/workspace/events/guides/get-subscription)."]
        ...
        #[doc = " Lists Google Workspace subscriptions. To learn how to use this method, see"]
        #[doc = " [List Google Workspace"]
        #[doc = " subscriptions](https://developers.google.com/workspace/events/guides/list-subscriptions)."]
        ...
        #[doc = " Updates or renews a Google Workspace subscription. To learn how to use this"]
        #[doc = " method, see [Update or renew a Google Workspace"]
        #[doc = " subscription](https://developers.google.com/workspace/events/guides/update-subscription)."]
        ...
        #[doc = " Reactivates a suspended Google Workspace subscription."]
        #[doc = ""]
        #[doc = " This method resets your subscription's `State` field to `ACTIVE`. Before"]
        #[doc = " you use this method, you must fix the error that suspended the"]
        #[doc = " subscription. To learn how to use this method, see [Reactivate a Google"]
        #[doc = " Workspace"]
        #[doc = " subscription](https://developers.google.com/workspace/events/guides/reactivate-subscription)."]
