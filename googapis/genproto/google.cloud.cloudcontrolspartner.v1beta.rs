...
pub mod cloud_controls_partner_core_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets details of a single workload"]
        ...
        #[doc = " Lists customer workloads for a given customer org id"]
        ...
        #[doc = " Gets details of a single customer"]
        ...
        #[doc = " Lists customers of a partner identified by its Google Cloud organization ID"]
        ...
        #[doc = " Gets the EKM connections associated with a workload"]
        pub async fn get_ekm_connections(
            &mut self,
            request: impl tonic::IntoRequest<super::GetEkmConnectionsRequest>,
        ) -> Result<tonic::Response<super::EkmConnections>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets the partner permissions granted for a workload"]
        pub async fn get_partner_permissions(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPartnerPermissionsRequest>,
        ) -> Result<tonic::Response<super::PartnerPermissions>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deprecated: Only returns access approval requests directly associated with"]
        #[doc = " an assured workload folder."]
        pub async fn list_access_approval_requests(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAccessApprovalRequestsRequest>,
        ) -> Result<tonic::Response<super::ListAccessApprovalRequestsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Get details of a Partner."]
        pub async fn get_partner(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPartnerRequest>,
        ) -> Result<tonic::Response<super::Partner>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod cloud_controls_partner_monitoring_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists Violations for a workload"]
        #[doc = " Callers may also choose to read across multiple Customers or for a single"]
        #[doc = " customer as per"]
        #[doc = " [AIP-159](https://google.aip.dev/159) by using '-' (the hyphen or dash"]
        #[doc = " character) as a wildcard character instead of {customer} & {workload}."]
        #[doc = " Format:"]
        #[doc = " `organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}`"]
        ...
        #[doc = " Gets details of a single Violation."]
