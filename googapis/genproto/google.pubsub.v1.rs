...
pub mod schema_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists all schema revisions for the named schema."]
        ...
        #[doc = " Commits a new schema revision to an existing schema."]
        ...
        #[doc = " Creates a new schema revision that is a copy of the provided revision_id."]
        ...
        #[doc = " Deletes a specific schema revision."]
...
pub mod publisher_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " (https://cloud.google.com/pubsub/docs/pubsub-basics#resource_names)."]
        ...
        #[doc = " Updates an existing topic by updating the fields specified in the update"]
        #[doc = " mask. Note that certain properties of a topic are not modifiable."]
...
pub mod subscriber_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " (https://cloud.google.com/pubsub/docs/pubsub-basics#resource_names). The"]
        ...
        #[doc = " Updates an existing subscription by updating the fields specified in the"]
        #[doc = " update mask. Note that certain properties of a subscription, such as its"]
        ...
        #[doc = " Pulls messages from the server."]
        pub async fn pull(
            &mut self,
        ...
        #[doc = " Updates an existing snapshot by updating the fields specified in the update"]
        #[doc = " mask. Snapshots are used in"]
        #[doc = " [Seek](https://cloud.google.com/pubsub/docs/replay-overview) operations,"]
        #[doc = " which allow you to manage message acknowledgments in bulk. That is, you can"]
        #[doc = " set the acknowledgment state of messages in an existing subscription to the"]
        #[doc = " state captured by a snapshot."]
