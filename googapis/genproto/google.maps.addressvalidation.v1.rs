...
pub mod address_validation_client {
    ...
    use tonic::codegen::*;
    #[doc = " The service for validating addresses."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Feedback about the outcome of the sequence of validation attempts. This"]
        #[doc = " should be the last call made after a sequence of validation calls for the"]
        #[doc = " same address, and should be called once the transaction is concluded. This"]
        #[doc = " should only be sent once for the sequence of `ValidateAddress` requests"]
        #[doc = " needed to validate an address fully."]
        pub async fn provide_validation_feedback(
            &mut self,
            request: impl tonic::IntoRequest<super::ProvideValidationFeedbackRequest>,
        ) -> Result<tonic::Response<super::ProvideValidationFeedbackResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
