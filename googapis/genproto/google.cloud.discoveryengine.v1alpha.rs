...
pub mod acl_config_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service for managing Acl Configuration."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Default Acl Configuration for use in a location of a customer's project."]
        #[doc = " Updates will only reflect to new data stores. Existing data stores will"]
        #[doc = " still use the old value."]
        pub async fn update_acl_config(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateAclConfigRequest>,
        ) -> Result<tonic::Response<super::AclConfig>, tonic::Status> {
        ...
        #[doc = " Gets the [AclConfig][google.cloud.discoveryengine.v1alpha.AclConfig]."]
...
pub mod chunk_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for displaying processed"]
    #[doc = " [Chunk][google.cloud.discoveryengine.v1alpha.Chunk] information of the"]
    #[doc = " customer's unstructured data."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a [Document][google.cloud.discoveryengine.v1alpha.Document]."]
        pub async fn get_chunk(
            &mut self,
            request: impl tonic::IntoRequest<super::GetChunkRequest>,
        ) -> Result<tonic::Response<super::Chunk>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a list of [Chunk][google.cloud.discoveryengine.v1alpha.Chunk]s."]
...
pub mod completion_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for Auto-Completion."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Completes the specified user input with keyword suggestions."]
        ...
        #[doc = " Imports all"]
        #[doc = " [SuggestionDenyListEntry][google.cloud.discoveryengine.v1alpha.SuggestionDenyListEntry]"]
        #[doc = " for a DataStore."]
...
pub mod control_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for performing CRUD operations on Controls."]
    #[doc = " Controls allow for custom logic to be implemented in the serving path."]
    #[doc = " Controls need to be attached to a Serving Config to be considered during a"]
    #[doc = " request."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " By default 1000 controls are allowed for a data store."]
        #[doc = " A request can be submitted to adjust this limit."]
        #[doc = " If the [Control][google.cloud.discoveryengine.v1alpha.Control] to create"]
        #[doc = " already exists, an ALREADY_EXISTS error is returned."]
        ...
        #[doc = ""]
        #[doc = " If the [Control][google.cloud.discoveryengine.v1alpha.Control] to delete"]
        #[doc = " does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " [Control][google.cloud.discoveryengine.v1alpha.Control] action type cannot"]
        #[doc = " be changed. If the [Control][google.cloud.discoveryengine.v1alpha.Control]"]
        #[doc = " to update does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = " Lists all Controls by their parent"]
        #[doc = " [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]."]
...
pub mod conversational_search_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for conversational search."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " If the [Conversation][google.cloud.discoveryengine.v1alpha.Conversation] to"]
        #[doc = " create already exists, an ALREADY_EXISTS error is returned."]
        ...
        #[doc = ""]
        #[doc = " If the [Conversation][google.cloud.discoveryengine.v1alpha.Conversation] to"]
        #[doc = " delete does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " [Conversation][google.cloud.discoveryengine.v1alpha.Conversation] action"]
        #[doc = " type cannot be changed. If the"]
        #[doc = " [Conversation][google.cloud.discoveryengine.v1alpha.Conversation] to update"]
        #[doc = " does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = " Lists all Conversations by their parent"]
        #[doc = " [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]."]
        ...
        #[doc = " Answer query method."]
        pub async fn answer_query(
            &mut self,
            request: impl tonic::IntoRequest<super::AnswerQueryRequest>,
        ) -> Result<tonic::Response<super::AnswerQueryResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = ""]
        #[doc = " If the [Session][google.cloud.discoveryengine.v1alpha.Session] to create"]
        #[doc = " already exists, an ALREADY_EXISTS error is returned."]
        ...
        #[doc = ""]
        #[doc = " If the [Session][google.cloud.discoveryengine.v1alpha.Session] to delete"]
        #[doc = " does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = ""]
        #[doc = " [Session][google.cloud.discoveryengine.v1alpha.Session] action type cannot"]
        #[doc = " be changed. If the [Session][google.cloud.discoveryengine.v1alpha.Session]"]
        #[doc = " to update does not exist, a NOT_FOUND error is returned."]
        ...
        #[doc = " Lists all Sessions by their parent"]
        #[doc = " [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]."]
...
pub mod data_store_service_client {
    ...
    #[doc = " [DataStore][google.cloud.discoveryengine.v1alpha.DataStore] configuration."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]."]
        #[doc = ""]
        #[doc = " DataStore is for storing"]
        #[doc = " [Documents][google.cloud.discoveryengine.v1alpha.Document]. To serve these"]
        #[doc = " documents for Search, or Recommendation use case, an"]
        #[doc = " [Engine][google.cloud.discoveryengine.v1alpha.Engine] needs to be created"]
        #[doc = " separately."]
        ...
        #[doc = " Gets a [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]."]
        pub async fn get_data_store(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDataStoreRequest>,
        ) -> Result<tonic::Response<super::DataStore>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists all the [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]s"]
        #[doc = " associated with the project."]
        pub async fn list_data_stores(
            &mut self,
            request: impl tonic::IntoRequest<super::ListDataStoresRequest>,
        ) -> Result<tonic::Response<super::ListDataStoresResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Deletes a [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]."]
        ...
        #[doc = " Updates a [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]"]
        ...
        #[doc = " Gets a"]
        #[doc = " [DocumentProcessingConfig][google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig]."]
        pub async fn get_document_processing_config(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDocumentProcessingConfigRequest>,
        ) -> Result<tonic::Response<super::DocumentProcessingConfig>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " [DocumentProcessingConfig][google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig]."]
        #[doc = " [DocumentProcessingConfig][google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig]"]
        #[doc = " is a singleon resource of"]
        #[doc = " [DataStore][google.cloud.discoveryengine.v1alpha.DataStore]. It's empty"]
        #[doc = " when [DataStore][google.cloud.discoveryengine.v1alpha.DataStore] is"]
        #[doc = " created. The first call to this method will set up"]
        #[doc = " [DocumentProcessingConfig][google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig]."]
...
pub mod document_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for ingesting"]
    #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document] information of the"]
    #[doc = " customer's website."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a list of [Document][google.cloud.discoveryengine.v1alpha.Document]s."]
        ...
        #[doc = " Creates a [Document][google.cloud.discoveryengine.v1alpha.Document]."]
        ...
        #[doc = " Updates a [Document][google.cloud.discoveryengine.v1alpha.Document]."]
        ...
        #[doc = " Deletes a [Document][google.cloud.discoveryengine.v1alpha.Document]."]
        ...
        #[doc = " Bulk import of multiple"]
        #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document]s. Request"]
        #[doc = " processing may be synchronous. Non-existing items are created."]
        #[doc = ""]
        #[doc = " Note: It is possible for a subset of the"]
        #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document]s to be"]
        ...
        #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document]s in a branch."]
        #[doc = ""]
        #[doc = " This process is asynchronous. Depending on the number of"]
        #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document]s to be deleted,"]
        #[doc = " this operation can take hours to complete. Before the delete operation"]
        #[doc = " completes, some [Document][google.cloud.discoveryengine.v1alpha.Document]s"]
        #[doc = " might still be returned by"]
        #[doc = " [DocumentService.GetDocument][google.cloud.discoveryengine.v1alpha.DocumentService.GetDocument]"]
        #[doc = " or"]
        #[doc = " [DocumentService.ListDocuments][google.cloud.discoveryengine.v1alpha.DocumentService.ListDocuments]."]
        #[doc = ""]
        #[doc = " To get a list of the"]
        #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document]s to be deleted,"]
        #[doc = " set"]
        #[doc = " [PurgeDocumentsRequest.force][google.cloud.discoveryengine.v1alpha.PurgeDocumentsRequest.force]"]
        #[doc = " to false."]
        ...
        #[doc = " Gets the parsed layout information for a"]
        #[doc = " [Document][google.cloud.discoveryengine.v1alpha.Document]."]
        pub async fn get_processed_document(
            &mut self,
            request: impl tonic::IntoRequest<super::GetProcessedDocumentRequest>,
        ) -> Result<tonic::Response<super::ProcessedDocument>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod engine_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing [Engine][google.cloud.discoveryengine.v1alpha.Engine]"]
    #[doc = " configuration."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Creates a [Engine][google.cloud.discoveryengine.v1alpha.Engine]."]
        ...
        #[doc = " Deletes a [Engine][google.cloud.discoveryengine.v1alpha.Engine]."]
        ...
        #[doc = " Updates an [Engine][google.cloud.discoveryengine.v1alpha.Engine]"]
        pub async fn update_engine(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateEngineRequest>,
        ) -> Result<tonic::Response<super::Engine>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a [Engine][google.cloud.discoveryengine.v1alpha.Engine]."]
        ...
        #[doc = " Lists all the [Engine][google.cloud.discoveryengine.v1alpha.Engine]s"]
        #[doc = " associated with the project."]
        pub async fn list_engines(
            &mut self,
            request: impl tonic::IntoRequest<super::ListEnginesRequest>,
        ) -> Result<tonic::Response<super::ListEnginesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Pauses the training of an existing engine. Only applicable if"]
        #[doc = " [SolutionType][google.cloud.discoveryengine.v1alpha.SolutionType] is"]
        #[doc = " [SOLUTION_TYPE_RECOMMENDATION][google.cloud.discoveryengine.v1alpha.SolutionType.SOLUTION_TYPE_RECOMMENDATION]."]
        ...
        #[doc = " Resumes the training of an existing engine. Only applicable if"]
        #[doc = " [SolutionType][google.cloud.discoveryengine.v1alpha.SolutionType] is"]
        #[doc = " [SOLUTION_TYPE_RECOMMENDATION][google.cloud.discoveryengine.v1alpha.SolutionType.SOLUTION_TYPE_RECOMMENDATION]."]
        ...
        #[doc = " Tunes an existing engine. Only applicable if"]
        #[doc = " [SolutionType][google.cloud.discoveryengine.v1alpha.SolutionType] is"]
        #[doc = " [SOLUTION_TYPE_RECOMMENDATION][google.cloud.discoveryengine.v1alpha.SolutionType.SOLUTION_TYPE_RECOMMENDATION]."]
...
pub mod estimate_billing_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing billing estimations resources."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Estimates the data size to be used by a customer."]
...
pub mod grounded_generation_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for grounded generation."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Performs a grounding check."]
        pub async fn check_grounding(
            &mut self,
            request: impl tonic::IntoRequest<super::CheckGroundingRequest>,
        ) -> Result<tonic::Response<super::CheckGroundingResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod project_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for operations on the"]
    #[doc = " [Project][google.cloud.discoveryengine.v1alpha.Project]."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a [Project][google.cloud.discoveryengine.v1alpha.Project]."]
        #[doc = " Returns NOT_FOUND when the project is not yet created."]
        ...
        #[doc = " Provisions the project resource. During the"]
        #[doc = " process, related systems will get prepared and initialized."]
        #[doc = ""]
        #[doc = " Caller must read the [Terms for data"]
        #[doc = " use](https://cloud.google.com/retail/data-use-terms), and optionally"]
        #[doc = " specify in request to provide consent to that service terms."]
        ...
        #[doc = " Updates service terms for this project."]
        #[doc = ""]
        #[doc = " This method can be used to retroactively accept the latest terms."]
        #[doc = ""]
        #[doc = " Terms available for update:"]
        #[doc = ""]
        #[doc = " * [Terms for data use](https://cloud.google.com/retail/data-use-terms)"]
...
pub mod rank_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for ranking text records."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Ranks a list of text records based on the given input query."]
        pub async fn rank(
            &mut self,
            request: impl tonic::IntoRequest<super::RankRequest>,
        ) -> Result<tonic::Response<super::RankResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod recommendation_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for making recommendations."]
    #[derive(Debug, Clone)]
...
pub mod schema_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing [Schema][google.cloud.discoveryengine.v1alpha.Schema]s."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a [Schema][google.cloud.discoveryengine.v1alpha.Schema]."]
        ...
        #[doc = " Gets a list of [Schema][google.cloud.discoveryengine.v1alpha.Schema]s."]
        ...
        #[doc = " Creates a [Schema][google.cloud.discoveryengine.v1alpha.Schema]."]
        ...
        #[doc = " Updates a [Schema][google.cloud.discoveryengine.v1alpha.Schema]."]
        ...
        #[doc = " Deletes a [Schema][google.cloud.discoveryengine.v1alpha.Schema]."]
...
pub mod search_tuning_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a list of all the custom models."]
        pub async fn list_custom_models(
            &mut self,
            request: impl tonic::IntoRequest<super::ListCustomModelsRequest>,
        ) -> Result<tonic::Response<super::ListCustomModelsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
...
pub mod serving_config_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for operations related to"]
    #[doc = " [ServingConfig][google.cloud.discoveryengine.v1alpha.ServingConfig]."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " Returns a NOT_FOUND error if the ServingConfig does not exist."]
        ...
        #[doc = " Lists all ServingConfigs linked to this dataStore."]
...
pub mod site_search_engine_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for managing site search related resources."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets the"]
        #[doc = " [SiteSearchEngine][google.cloud.discoveryengine.v1alpha.SiteSearchEngine]."]
        pub async fn get_site_search_engine(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSiteSearchEngineRequest>,
        ) -> Result<tonic::Response<super::SiteSearchEngine>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Creates a [TargetSite][google.cloud.discoveryengine.v1alpha.TargetSite]."]
        ...
        #[doc = " Creates [TargetSite][google.cloud.discoveryengine.v1alpha.TargetSite] in a"]
        #[doc = " batch."]
        ...
        #[doc = " Gets a [TargetSite][google.cloud.discoveryengine.v1alpha.TargetSite]."]
        pub async fn get_target_site(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTargetSiteRequest>,
        ) -> Result<tonic::Response<super::TargetSite>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Updates a [TargetSite][google.cloud.discoveryengine.v1alpha.TargetSite]."]
        ...
        #[doc = " Deletes a [TargetSite][google.cloud.discoveryengine.v1alpha.TargetSite]."]
        ...
        #[doc = " Gets a list of"]
        #[doc = " [TargetSite][google.cloud.discoveryengine.v1alpha.TargetSite]s."]
        pub async fn list_target_sites(
            &mut self,
            request: impl tonic::IntoRequest<super::ListTargetSitesRequest>,
        ) -> Result<tonic::Response<super::ListTargetSitesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Upgrade from basic site search to advanced site search."]
        ...
        #[doc = " Downgrade from advanced site search to basic site search."]
        ...
        #[doc = " Request on-demand recrawl for a list of URIs."]
        ...
        #[doc = " Verify target sites' ownership and validity."]
        #[doc = " This API sends all the target sites under site search engine for"]
        #[doc = " verification."]
        ...
        #[doc = " Returns list of target sites with its domain verification status."]
        #[doc = " This method can only be called under data store with BASIC_SITE_SEARCH"]
        #[doc = " state at the moment."]
        pub async fn fetch_domain_verification_status(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchDomainVerificationStatusRequest>,
        ) -> Result<tonic::Response<super::FetchDomainVerificationStatusResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod user_event_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Service for ingesting end user actions on a website to Discovery Engine API."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " due to browser restriction of POST-ing to a third-party domain."]
        #[doc = ""]
        #[doc = " This method is used only by the Discovery Engine API JavaScript pixel and"]
