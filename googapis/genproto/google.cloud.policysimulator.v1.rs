...
pub mod simulator_client {
    ...
    use tonic::codegen::*;
    #[doc = " Policy Simulator API service."]
    #[doc = ""]
    #[doc = " Policy Simulator is a collection of endpoints for creating, running, and"]
    #[doc = " viewing a [Replay][google.cloud.policysimulator.v1.Replay]. A"]
    #[doc = " [Replay][google.cloud.policysimulator.v1.Replay] is a type of simulation that"]
    #[doc = " lets you see how your principals' access to resources might change if you"]
    #[doc = " changed your IAM policy."]
    #[doc = ""]
    #[doc = " During a [Replay][google.cloud.policysimulator.v1.Replay], Policy Simulator"]
    #[doc = " re-evaluates, or replays, past access attempts under both the current policy"]
    #[doc = " and  your proposed policy, and compares those results to determine how your"]
    #[doc = " principals' access might change under the proposed policy."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets the specified [Replay][google.cloud.policysimulator.v1.Replay]. Each"]
        #[doc = " `Replay` is available for at least 7 days."]
        pub async fn get_replay(
            &mut self,
            request: impl tonic::IntoRequest<super::GetReplayRequest>,
        ) -> Result<tonic::Response<super::Replay>, tonic::Status> {
        ...
        #[doc = " Creates and starts a [Replay][google.cloud.policysimulator.v1.Replay] using"]
        #[doc = " the given [ReplayConfig][google.cloud.policysimulator.v1.ReplayConfig]."]
        ...
        #[doc = " Lists the results of running a"]
        #[doc = " [Replay][google.cloud.policysimulator.v1.Replay]."]
        pub async fn list_replay_results(
            &mut self,
            request: impl tonic::IntoRequest<super::ListReplayResultsRequest>,
        ) -> Result<tonic::Response<super::ListReplayResultsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
