...
pub mod security_center_client {
    ...
    use tonic::codegen::*;
    #[doc = " V2 APIs for Security Center service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Kicks off an LRO to bulk mute findings for a parent based on a filter. If"]
        #[doc = " no location is specified, findings are muted in global. The parent"]
        #[doc = " can be either an organization, folder, or project. The findings matched by"]
        #[doc = " the filter will be muted after the LRO is done."]
        ...
        #[doc = " Creates a finding in a location. The corresponding source must exist for"]
        ...
        #[doc = " Deletes an existing BigQuery export."]
        ...
        #[doc = " Deletes an existing mute config. If no location is specified, default is"]
        #[doc = " global."]
        ...
        #[doc = " Gets a mute config. If no location is specified, default is"]
        #[doc = " global."]
        ...
        #[doc = " specified properties in a location. If no location is specified, findings"]
        #[doc = " are assumed to be in global"]
        #[doc = ""]
        #[doc = " To group across all sources provide a `-` as the source id."]
        #[doc = " The following list shows some examples:"]
        #[doc = ""]
        #[doc = " + `/v2/organizations/{organization_id}/sources/-/findings`"]
        #[doc = " +"]
        #[doc = " `/v2/organizations/{organization_id}/sources/-/locations/{location_id}/findings`"]
        #[doc = " + `/v2/folders/{folder_id}/sources/-/findings`"]
        #[doc = " + `/v2/folders/{folder_id}/sources/-/locations/{location_id}/findings`"]
        #[doc = " + `/v2/projects/{project_id}/sources/-/findings`"]
        #[doc = " + `/v2/projects/{project_id}/sources/-/locations/{location_id}/findings`"]
        ...
        #[doc = ""]
        #[doc = " To list across all sources for a given location provide a `-` as the source"]
        #[doc = " id. If no location is specified, finding are assumed to be in global."]
        #[doc = " The following list shows some examples:"]
        #[doc = ""]
        #[doc = " + `/v2/organizations/{organization_id}/sources/-/findings`"]
        #[doc = " +"]
        ...
        #[doc = " Lists mute configs. If no location is specified, default is"]
        #[doc = " global."]
        ...
        #[doc = " Updates the state of a finding. If no location is specified, finding is"]
        #[doc = " assumed to be in global"]
        ...
        #[doc = " Updates the mute state of a finding. If no location is specified, finding"]
        #[doc = " is assumed to be in global"]
        ...
        #[doc = " Updates external system. This is for a given finding. If no location is"]
        #[doc = " specified, finding is assumed to be in global"]
        ...
        #[doc = " Creates or updates a finding. If no location is specified, finding is"]
        #[doc = " assumed to be in global. The corresponding source must exist for a finding"]
        ...
        #[doc = " Updates a mute config. If no location is specified, default is"]
        #[doc = " global."]
        ...
        #[doc = " Updates security marks. For Finding Security marks, if no location is"]
        #[doc = " specified, finding is assumed to be in global. Assets Security Marks can"]
        #[doc = " only be accessed through global endpoint."]
