...
pub mod spaces_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " REST API for services dealing with spaces."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a space by `space_id` or `meeting_code`."]
        pub async fn get_space(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.apps.meet.v2.SpacesService/GetSpace");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Updates a space."]
        ...
        #[doc = " Ends an active conference (if there's one)."]
...
pub mod conference_records_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " REST API for services dealing with conference records."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets a conference record by conference ID."]
        pub async fn get_conference_record(
            &mut self,
            request: impl tonic::IntoRequest<super::GetConferenceRecordRequest>,
        ) -> Result<tonic::Response<super::ConferenceRecord>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the conference records. By default, ordered by start time and in"]
        ...
        ) -> Result<tonic::Response<super::ListConferenceRecordsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a participant by participant ID."]
        ...
        #[doc = " Lists the participants in a conference record. By default, ordered by join"]
        #[doc = " time and in descending order. This API supports `fields` as standard"]
        #[doc = " parameters like every other API. However, when the `fields` request"]
        #[doc = " parameter is omitted, this API defaults to `'participants/*,"]
        #[doc = " next_page_token'`."]
        ...
        #[doc = " Gets a participant session by participant session ID."]
        pub async fn get_participant_session(
            &mut self,
            request: impl tonic::IntoRequest<super::GetParticipantSessionRequest>,
        ) -> Result<tonic::Response<super::ParticipantSession>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the participant sessions of a participant in a conference record. By"]
        #[doc = " default, ordered by join time and in descending order. This API supports"]
        #[doc = " `fields` as standard parameters like every other API. However, when the"]
        #[doc = " `fields` request parameter is omitted this API defaults to"]
        #[doc = " `'participantsessions/*, next_page_token'`."]
        pub async fn list_participant_sessions(
            &mut self,
            request: impl tonic::IntoRequest<super::ListParticipantSessionsRequest>,
        ) -> Result<tonic::Response<super::ListParticipantSessionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Gets a recording by recording ID."]
        pub async fn get_recording(
            &mut self,
            request: impl tonic::IntoRequest<super::GetRecordingRequest>,
        ) -> Result<tonic::Response<super::Recording>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the recording resources from the conference record. By default,"]
        #[doc = " ordered by start time and in ascending order."]
        pub async fn list_recordings(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRecordingsRequest>,
        ) -> Result<tonic::Response<super::ListRecordingsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a transcript by transcript ID."]
        pub async fn get_transcript(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTranscriptRequest>,
        ) -> Result<tonic::Response<super::Transcript>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the set of transcripts from the conference record. By default,"]
        #[doc = " ordered by start time and in ascending order."]
        pub async fn list_transcripts(
            &mut self,
            request: impl tonic::IntoRequest<super::ListTranscriptsRequest>,
        ) -> Result<tonic::Response<super::ListTranscriptsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a `TranscriptEntry` resource by entry ID."]
        #[doc = ""]
        #[doc = " Note: The transcript entries returned by the Google Meet API might not"]
        #[doc = " match the transcription found in the Google Docs transcript file. This can"]
        #[doc = " occur when the Google Docs transcript file is modified after generation."]
        pub async fn get_transcript_entry(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTranscriptEntryRequest>,
        ) -> Result<tonic::Response<super::TranscriptEntry>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists the structured transcript entries per transcript. By default, ordered"]
        #[doc = " by start time and in ascending order."]
        #[doc = ""]
        #[doc = " Note: The transcript entries returned by the Google Meet API might not"]
        #[doc = " match the transcription found in the Google Docs transcript file. This can"]
        #[doc = " occur when the Google Docs transcript file is modified after generation."]
        ...
        ) -> Result<tonic::Response<super::ListTranscriptEntriesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
