...
pub mod home_graph_api_service_client {
    ...
    #[doc = " guide](https://developers.home.google.com/cloud-to-cloud/primer/home-graph)."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " [intent](https://developers.home.google.com/cloud-to-cloud/intents/sync)"]
        ...
        #[doc = " State](https://developers.home.google.com/cloud-to-cloud/integration/report-state)"]
        #[doc = " for more information."]
        #[doc = ""]
        #[doc = " This method updates the device state according to its declared"]
        #[doc = " [traits](https://developers.home.google.com/cloud-to-cloud/primer/device-types-and-traits)."]
        ...
        #[doc = " [fulfillment and"]
        #[doc = " authentication](https://developers.home.google.com/cloud-to-cloud/primer/fulfillment)."]
        #[doc = ""]
        #[doc = " The third-party user's identity is passed in via the `agent_user_id`"]
        #[doc = " (see"]
