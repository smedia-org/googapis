...
pub mod app_hub_client {
    ...
    use tonic::codegen::*;
    #[doc = " The App Hub API allows you to manage App Hub resources."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists a service project attachment for a given service project. You can"]
        #[doc = " call this API from any project to find if it is attached to a host project."]
        pub async fn lookup_service_project_attachment(
            &mut self,
            request: impl tonic::IntoRequest<super::LookupServiceProjectAttachmentRequest>,
        ) -> Result<tonic::Response<super::LookupServiceProjectAttachmentResponse>, tonic::Status>
        {
        ...
        #[doc = " Lists service projects attached to the host project."]
        pub async fn list_service_project_attachments(
            &mut self,
            request: impl tonic::IntoRequest<super::ListServiceProjectAttachmentsRequest>,
        ) -> Result<tonic::Response<super::ListServiceProjectAttachmentsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Attaches a service project to the host project."]
        ...
        #[doc = " Deletes a service project attachment."]
        ...
        #[doc = " Detaches a service project from a host project."]
        #[doc = " You can call this API from any service project without needing access to"]
        #[doc = " the host project that it is attached to."]
        pub async fn detach_service_project_attachment(
            &mut self,
            request: impl tonic::IntoRequest<super::DetachServiceProjectAttachmentRequest>,
        ) -> Result<tonic::Response<super::DetachServiceProjectAttachmentResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists Discovered Services that can be added to an Application in a host"]
        ...
        ) -> Result<tonic::Response<super::ListDiscoveredServicesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Gets a Discovered Service in a host project and location."]
        pub async fn get_discovered_service(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDiscoveredServiceRequest>,
        ) -> Result<tonic::Response<super::DiscoveredService>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists a Discovered Service in a host project and location, with a"]
        #[doc = " given resource URI."]
        pub async fn lookup_discovered_service(
            &mut self,
            request: impl tonic::IntoRequest<super::LookupDiscoveredServiceRequest>,
        ) -> Result<tonic::Response<super::LookupDiscoveredServiceResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists Services in an Application."]
        ...
        #[doc = " Creates a Service in an Application."]
        ...
        #[doc = " Gets a Service in an Application."]
        ...
        #[doc = " Updates a Service in an Application."]
        ...
        #[doc = " Deletes a Service from an Application."]
        ...
        #[doc = " Lists Discovered Workloads that can be added to an Application in a host"]
        #[doc = " project and location."]
        pub async fn list_discovered_workloads(
            &mut self,
            request: impl tonic::IntoRequest<super::ListDiscoveredWorkloadsRequest>,
        ) -> Result<tonic::Response<super::ListDiscoveredWorkloadsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Gets a Discovered Workload in a host project and location."]
        pub async fn get_discovered_workload(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDiscoveredWorkloadRequest>,
        ) -> Result<tonic::Response<super::DiscoveredWorkload>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        #[doc = " Lists a Discovered Workload in a host project and location, with a"]
        #[doc = " given resource URI."]
        pub async fn lookup_discovered_workload(
            &mut self,
            request: impl tonic::IntoRequest<super::LookupDiscoveredWorkloadRequest>,
        ) -> Result<tonic::Response<super::LookupDiscoveredWorkloadResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists Workloads in an Application."]
        ...
        #[doc = " Creates a Workload in an Application."]
        ...
        #[doc = " Gets a Workload in an Application."]
        ...
        #[doc = " Updates a Workload in an Application."]
        ...
        #[doc = " Deletes a Workload from an Application."]
        ...
        #[doc = " Lists Applications in a host project and location."]
        ...
        #[doc = " Creates an Application in a host project and location."]
        ...
        #[doc = " Gets an Application in a host project and location."]
        ...
        #[doc = " Updates an Application in a host project and location."]
        ...
        #[doc = " Deletes an Application in a host project and location."]
